  ...
  Procedure Widgets_CallBack(EventWidget.i, EventType.i, EventItem.i)
    ...
    Select EventType ; WidgetEvent()
      ...
      Case #PB_EventType_Change
        Debug GetItemData(EventWidget, GetState(EventWidget))
          
      Case #PB_EventType_Focus
;         If LostFocus
;           Debug 33333
;           ; EventWidget = LostFocus
;           SetFocus(LostFocus, 1)
;           SetFocus(GetWindow(LostFocus), 1)
;         SetState(Widgets("Inspector"), GetData(LostFocus))
;         SetItemText(Widgets("Properties"), 1, GetText(LostFocus))
;         SetItemText(Widgets("Properties"), 3, Str(X(LostFocus)))
;         SetItemText(Widgets("Properties"), 4, Str(Y(LostFocus)))
;         SetItemText(Widgets("Properties"), 5, Str(Width(LostFocus)))
;         SetItemText(Widgets("Properties"), 6, Str(Height(LostFocus)))
;         Else
;         EndIf
        
        Debug "фокус"
        Protected *f.Widget_s = EventWidget
...
;         Protected *l.Widget_s = EventWidget
;         If *l\anchor[9]
;           Debug 22222
;           LostFocus = EventWidget 
;           SetFocus(EventWidget, 1)
;         EndIf
...
;     EndSelect
  ...
  Procedure.i GetSubLevel(*This)
    ProcedureReturn (GetLevel(*This) - GetLevel(GetWindow(*This)))
  EndProcedure
...
;     If OpenList(Window_0, Canvas_0, #PB_GadgetType_Window)
    ...
    If Open(Window_0, 10, 40, 780, 550, "IDE") : Canvas_0 = Display()
      ; Main panel
      ...
      Widgets("Form_0") = Window(20, 20, 480, 410, "Window_0", #PB_Flag_AnchorsGadget, Widgets("Panel")) 
      SetImage(Widgets("Form_0") , 5)
      
      Widgets("Form_0_Text_0") = Text(120, 10, 100, 101, "Vertical & Horizontal" + #LF$ + "   Centered   Text in   " + #LF$ + "Multiline StringGadget", #PB_Flag_AnchorsGadget)
      Widgets("Form_0_Frame_0") = Frame(230, 10, 100, 101, "Frame_0", #PB_Flag_AnchorsGadget)
      
      Widgets("Container_0") = Container(10, 120, 120, 150, #PB_Flag_AnchorsGadget) 
      SetImage( Widgets("Container_0") , 5)
      SetColor(Widgets("Container_0"), #PB_Gadget_BackColor, $FF00CDFF)
      
      Widgets("Form_0_Container_0_Option_0") = Option(10, 10, 100, 21, "Option_3", #PB_Flag_AnchorsGadget)
      Widgets("Form_0_Container_0_Option_1") = Option(10, 35, 100, 21, "Option_4", #PB_Flag_AnchorsGadget)
      ...
      SetImage(Widgets("Container_1"), 5)
      SetColor(Widgets("Container_1"), #PB_Gadget_BackColor, $FF0CDF0F)
      
      AddItem(Widgets("Container_1"), -1, "Panel_0") 
      Widgets("Form_0_Container_1_Option_0") = Option(10, 10, 100, 21, "Option_5", #PB_Flag_AnchorsGadget) 
      Widgets("Form_0_Container_1_Option_1") = Option(10, 35, 100, 21, "Option_6", #PB_Flag_AnchorsGadget)
      
      ;AddItem(Widgets("Container_1"), -1, "Panel_1") 
      Widgets("Form_0_Container_1_Button_3") = Spin(10, 65, 100, 25, 0, 10, #PB_Flag_AnchorsGadget)
      Widgets("Form_0_Container_1_Button_4") = Spin(10, 95, 100, 25, 0, 10, #PB_Vertical|#PB_Flag_AnchorsGadget)
      CloseList()
      ...
      Widgets("Form_0_Option_0") = Option(10, 40, 100, 21, "Option_0", #PB_Flag_AnchorsGadget)
      Widgets("Form_0_Option_1") = Option(10, 65, 100, 21, "Option_1", #PB_Flag_AnchorsGadget)
      Widgets("Form_0_Option_2") = Option(10, 90, 100, 21, "Option_2", #PB_Flag_AnchorsGadget) 
      SetState(Widgets("Form_0_Option_0"), 1)
      
      Widgets("Form_0_CheckBox_0") = CheckBox(340, 40, 100, 21, "CheckBox_0", #PB_Flag_AnchorsGadget)
      Widgets("Form_0_CheckBox_1") = CheckBox(340, 65, 100, 21, "CheckBox_1", #PB_Flag_AnchorsGadget|#PB_CheckBox_ThreeState)
      SetState(Widgets("Form_0_CheckBox_0"), #PB_Checkbox_Checked)
      SetState(Widgets("Form_0_CheckBox_1"), #PB_Checkbox_Inbetween)
      Widgets("Form_0_String_0") = String(10, 280, 450, 26, "Vertical & Horizontal" + #LF$ + "   Centered   Text in   " + #LF$ + "Multiline StringGadget", #PB_Flag_AnchorsGadget)
      CloseList()
...
;       Define i, count = CountItems(Widgets("Inspector"))
;       For i = 0 To count
;         Debug 999
;       Next
      
      Define *This.Widget_S
      Define *This_0.Widget_S
      Define *par.Widget_s = Widgets("Form_0")
      
      AddItem(Widgets("Inspector"), -1, GetClass(*par)+"_"+GetCount(*par), -1, 0) 
     
      While Enumerate(@*This, *par)
         AddItem(Widgets("Inspector"), -1, GetClass(*This)+"_"+GetCount(*This), -1, GetSubLevel(*This) ) 
         SetData(*This, CountItems(Widgets("Inspector"))-1)
         
         If IsChildrens(*This)
          While Enumerate(@*This_0, *This)
            AddItem(Widgets("Inspector"), -1, GetClass(*This_0)+"_"+GetCount(*This_0), -1, GetSubLevel(*This_0) ) 
            SetData(*This_0, CountItems(Widgets("Inspector"))-1)
