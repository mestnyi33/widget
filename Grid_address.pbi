...
; Универсальный макрос: Mid2(строка, позиция [, длина])
; Если длина не указана, берет всё до конца строки
Macro Mid(txt, pos, length = -1)
  PeekS(@txt + (pos - 1) * SizeOf(Character), length)
EndMacro
