...
CompilerIf #PB_Compiler_IsMainFile ;= 100
  ...
  Procedure.i new_widget_add(Parent, Type, X=0,Y=0,Width=0,Height=0)
    ...
    Select Type
      Case #PB_GadgetType_Window     : *this = Form(10,10,Width+1,Height+1, "", #__Flag_AnchorsGadget, Parent)
      Case #PB_GadgetType_Panel      : *this = Panel(X,Y,Width,Height, #__Flag_AnchorsGadget) : AddItem(*this, -1, "Panel") : AddItem(*this, -1, "+")
        ...
        Select EventType()
          Case #PB_EventType_Change
            *this = GetGadgetItemData(EventGadget(), GetGadgetState(EventGadget()))
            ...
            If *this And SetAnchors(*this)
               Debug "  wait изменено "+ GetGadgetState(EventGadget())
