...
;       EndIf
  ...
  Procedure Window_0_Open(x = 0, y = 0, width = 800, height = 700)
    ...
    If Open(Window_0, 10, 40, width-Bool(WE_Selecting) * 150-20, height-Bool(WE_Code) * 190-10-40, "IDE", #__window_maximizegadget|#__window_minimizegadget) ;+200
      ...
      ; SetState(Widgets("Widgets_splitter"), height(Widgets("Widgets_splitter")))
      
    EndIf
    
    Define *n=new_widget_add(Widgets("MDI"), #__Type_Window)
    Define *c1=new_widget_add(*n, #__Type_Panel, 50, 5, 200, 90)
    Define *c2=new_widget_add(*n, #__Type_Container, 50, 105, 200, 90)
    new_widget_add(*c1, #__Type_Button)
    new_widget_add(*c2, #__Type_Button)
    new_widget_add(*c1, #__Type_Button)
    new_widget_add(*c2, #__Type_Button)
    new_widget_add(*c1, #__Type_Button)
    new_widget_add(*c2, #__Type_Button)
    new_widget_add(*n, #__Type_Button, 210, 75, 100, 50)
    new_widget_add(*n, #__Type_Button, 220, 90, 100, 50)
    ; ;     ;CloseList()
    Debug getClass(*n)
