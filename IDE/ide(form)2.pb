   ...
   *row = *second\RowFocused( )
   If *row
         ...
         Select *row\data
            ...
            Case #__type_String
               *this = Create( *second, "String", #__type_String, 0, 0, 0, 0, *row\text\string, flag, 0, 0, 0, 0, 0, 0 )
...
Procedure AddItemProperties( *splitter._s_WIDGET, item, Text.s, Type=-1, mode=0 )
   ...
   Protected flag = #__flag_NoFocus;= #__flag_child
...
;    EndIf
   ...
   SetItemData(*second, item, Type);*this)
EndProcedure
