...
Procedure   Properties_Updates( *object._s_WIDGET, type$ )
   ...
   If ide_inspector_PROPERTIES
      ...
      If type$ = "Focus" Or type$ = "Flag"
         Properties_SetItemText( ide_inspector_PROPERTIES, #_pi_FLAG, MakeFlag( *object\flag ))
      EndIf
      ...
      If type$ = "Focus"
         If a_focused( )
            PropertiesButton_AddItems( ide_inspector_PROPERTIES, #_pi_flag, MakePBFlags( GetType( a_focused( ))))
         EndIf
