...
;       CHECKBOX_1 = Button( 231, 175, 148, 22, "Подчеркнутый",#PB_Button_Toggle,10 )
      ;
      CHECKBOX_0 = Text( 231, 147, 148, 22, "Зачеркнутый", #__flag_text_center ) : SetRound( CHECKBOX_0, 10 )
      CHECKBOX_0 = CheckBox( 231+4, 147, 148-8, 22, " ", #__flag_border_less|#__flag_Transparent )
      CHECKBOX_1 = Text( 231, 175, 148, 22, "Подчеркнутый", #__flag_text_center ) : SetRound( CHECKBOX_1, 10 )
      CHECKBOX_1 = CheckBox( 231+4, 175, 148-8, 22, " ", #__flag_border_less|#__flag_Transparent )
      ;
;       CHECKBOX_0 = CheckBox( 231, 147, 148, 22, "Зачеркнутый", #__flag_border_less|#__flag_Transparent )
;       CHECKBOX_1 = CheckBox( 231, 175, 148, 22, "Подчеркнутый", #__flag_border_less|#__flag_Transparent )
