...
CompilerIf #PB_Compiler_IsMainFile
   ...
   If Open( 0, 0, 0, 322, 600, "enumeration widgets", #PB_Window_SystemMenu | #PB_Window_ScreenCentered )
      ...
      Button( 21, 14, 120, 64, "button_0" ) : SetClass( widget( ), "#BUTTON_0")
      Button( 21, 91, 120, 71, "button_1" ) : SetClass( widget( ), "#BUTTON_1")
      
      Window( 40, 150, 240, 200, "window_0", #PB_Window_SystemMenu ) : SetClass( widget( ), "#WINDOW_1")
      Button( 21, 14, 120, 64, "button_2" )
      Button( 21, 91, 120, 71, "button_3" )
      
      Window( 70, 300, 240, 200, "window_1", #PB_Window_SystemMenu ) : SetClass( widget( ), "WINDOW_2")
      Button( 21, 14, 120, 64, "button_4" ) : SetClass( widget( ), "#BUTTON_4")
      Button( 21, 91, 120, 71, "button_5" ) : SetClass( widget( ), "#BUTTON_5")
