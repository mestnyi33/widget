...
Procedure.s GetDefaultFontName()
  ...
  ; call at program start to get the default font name for PB gadgets
    ;
    Protected name.s, size.CGFloat = 0.0
    name = GetFontName( CocoaMessage(0, 0, "NSFont controlContentFontOfSize:@", @size) )
...
Procedure.CGFloat GetDefaultFontSize()
    ...
    size = GetFontSize( CocoaMessage(0, 0, "NSFont controlContentFontOfSize:@", @size) )
