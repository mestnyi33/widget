...
Procedure.i SetCursor(Canvas, Type.i, CursorType.i=#PB_Canvas_Cursor)
  Protected.i x=2, y=2
  Protected cursor
  UsePNGImageDecoder()
  UseZipPacker()
  ...
  Select Type
    ...
    Case #PB_Cursor_Arrows
      ...
      *unpacked = AllocateMemory(784)
      ...
      x=12;ImageWidth(cursor)/2
      y=12;ImageHeight(cursor)/2
  ...
  With *This
    If IsGadget(Canvas)
      If CursorType = #PB_Canvas_CustomCursor
        If Cursor
          Protected ImageID = ImageID(Cursor)
...
If OpenWindow(0, 270, 100, 250, 170, "Canvas with custom cursor")
  ...
  If StartDrawing(CanvasOutput(0))
    ...
    Box(5, (80-10)/2, 10, 10, RGB(Random(255), Random(255), Random(255)))
    Box((230-10)/2, 5, 10, 10, RGB(Random(255), Random(255), Random(255)))
    Box(230-10-5, (80-10)/2, 10, 10, RGB(Random(255), Random(255), Random(255)))
    Box((230-10)/2, 80-10-5, 10, 10, RGB(Random(255), Random(255), Random(255)))
      ...
      Case #PB_Event_Gadget
        If EventGadget() = 0 And EventType() = #PB_EventType_MouseMove
          ...
          If x>5 And x<5+10 And y>5 And y<5+10
            SetCursor(EventGadget(), (#PB_Cursor_LeftDownRightUp), #PB_Canvas_CustomCursor)
          ElseIf x>230-10-5 And x<230-5 And y>5 And y<5+10
            SetCursor(EventGadget(), (#PB_Cursor_LeftUpRightDown), #PB_Canvas_CustomCursor)
          ...
          ElseIf x>(230-30)/2 And x<(230+30)/2 And y>(80-30)/2 And y<(80+30)/2
            SetCursor(EventGadget(), (#PB_Cursor_IBeam), #PB_Canvas_CustomCursor)
            
          ElseIf x>(230-10)/2 And x<(230+10)/2 And y>5 And y<5+10
            SetCursor(EventGadget(), (#PB_Cursor_UpDown), #PB_Canvas_CustomCursor)
          ElseIf x>(230-10)/2 And x<(230+10)/2 And y>80-10-5 And y<80-5
            SetCursor(EventGadget(), (#PB_Cursor_UpDown), #PB_Canvas_CustomCursor)
          ElseIf x>230-10-5 And x<230-5 And y>(80-10)/2 And y<(80+10)/2
            SetCursor(EventGadget(), (#PB_Cursor_LeftRight), #PB_Canvas_CustomCursor)
          ElseIf x>5 And x<5+10 And y>(80-10)/2 And y<(80+10)/2
            SetCursor(EventGadget(), (#PB_Cursor_LeftRight), #PB_Canvas_CustomCursor)
          Else
            ; SetGadgetAttribute(EventGadget(), #PB_Canvas_Cursor, #PB_Cursor_Default)
            SetCursor(EventGadget(), (#PB_Cursor_Default), #PB_Canvas_CustomCursor)
          EndIf
        ElseIf EventGadget() = 0 And EventType() = #PB_EventType_MouseLeave
          SetGadgetAttribute(EventGadget(), #PB_Canvas_Cursor, #PB_Cursor_Default)
        EndIf
    EndSelect
  ForEver
