    ...
    Procedure   ReDraw(*this._s_widget)
      If StartDrawing(CanvasOutput(*this\root\canvas\gadget))
        ...
        ForEach *this\root\_childrens()
          If Not *this\root\_childrens()\hide
...
;       ProcedureReturn Updates(*scroll._s_scroll, x.l,y.l,width.l,height.l)
    ...
    Procedure _set_clip_len(*this._s_widget, childrens.b=0)
      ; then move and size parent set clip (width&height)
      If *this\parent And *this\parent\_x[#__c_4] > 0 And *this\parent\_x[#__c_4] < *this\x+*this\width And *this\parent\_x[#__c_2] > *this\parent\_x[#__c_4] 
        *this\width[#__c_4] = *this\parent\_x[#__c_4] - *this\x[#__c_4]
      ElseIf *this\parent And *this\parent\_x[#__c_2] > 0 And *this\parent\_x[#__c_2] < *this\x+*this\width
        *this\width[#__c_4] = *this\parent\_x[#__c_2] - *this\x[#__c_4]
      Else
        *this\width[#__c_4] = (*this\x+*this\width) - *this\x[#__c_4]
      EndIf
      
      If *this\parent And *this\parent\_y[#__c_4] > 0 And *this\parent\_y[#__c_4] < *this\y+*this\height And *this\parent\_y[#__c_2] > *this\parent\_y[#__c_4] 
        *this\height[#__c_4] = *this\parent\_y[#__c_4] - *this\y[#__c_4]
      ElseIf *this\parent And *this\parent\_y[#__c_2] > 0 And *this\parent\_y[#__c_2] < *this\y+*this\height
        *this\height[#__c_4] = *this\parent\_y[#__c_2] - *this\y[#__c_4]
      Else
      ...
      CompilerElse
        ...
        With *this
          ...
          If \resize & #__resize_change
            ...
            *this\_x[#__c_2] = *this\x[#__c_2]+*this\width[#__c_2]
            *this\_x[#__c_3] = *this\x[#__c_2]+*this\width[#__c_3]
            *this\_x[#__c_4] = *this\x[#__c_4]+*this\width[#__c_4]
            
            *this\_y[#__c_2] = *this\y[#__c_2]+*this\height[#__c_2]
            *this\_y[#__c_3] = *this\y[#__c_2]+*this\height[#__c_3]
            *this\_y[#__c_4] = *this\y[#__c_4]+*this\height[#__c_4]
...
;                       EndIf
                  ...
                  Else
                    ...
                    ElseIf (Change_width Or Change_height)
                      _set_clip_len(*this\root\_childrens())
                    EndIf
                  EndIf
                EndIf
              Next
  ...
  Procedure SetParent(*this._s_widget, *Parent._s_widget, parent_item.l=0)
    ...
    Procedure CallBack()
      ...
      If change
        ...
        Repeat                                 
          If _from_point_(mouse_x, mouse_y, Root()\_childrens(), [#__c_4])
        ...
        If Root()\entered <> *this
          If Root()\entered And Root()\entered\state = #__s_1 And 
            ...
            If #__from_mouse_state
              ...
              Repeat                 
                If _is_child(Root()\entered, Root()\_childrens())
