...
;         EndIf
  ...
  Procedure.i Editor_Events(*This.Widget_S, EventType.i)
    ...
    EndIf
      ...
      If *This And *This\Scroll And (Not *This\Scroll\v\at And Not *This\Scroll\h\at)
        If ListSize(*This\items())
          ...
          ; edit events
          If *Value\Focus = *This And (*This\Text\Editable Or \Text\Editable)
  ...
  Procedure.i _Draw_Editor(*This.Widget_S)
    Protected String.s, StringWidth, ix, iy, iwidth, iheight
    Protected IT,Text_Y,Text_X, X,Y, Width,Height, Drawing
    Protected angle.f, widget_state
...
; Folding = AqAAAAAAoAADABAQAAAA33AAAAAAAAAAgAA5-------------8------------------------HGAAAIABAAAMAAAAAAAAAAAAAAACAQAAgAQAAABAAAAAAAAAAAAAAAAAwAAAAAAAAQAAAAAAAAAAAAAAAAAAAAAAACAYMYAAAAAAAYAAAAAAg0AACwPAg-fPCQAAAAAAEAAAAAAAAAAAAAAAAAAAAA9gwBAIAAAAgHQAAAi
; EnableXP