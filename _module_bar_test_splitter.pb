...
If OpenWindow(0, 0, 0, 850, 280, "SplitterGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    Splitter_1 = SplitterGadget(#PB_Any, 0, 0, 0, 0, Button_3, Button_4, #PB_Splitter_Vertical|#PB_Splitter_Separator)
    ...
    Splitter_4 = SplitterGadget(#PB_Any, 10, 10, 410, 210, Button_1, Splitter_3, #PB_Splitter_Vertical|#PB_Splitter_Separator)
    ...
    Splitter_1 = Bar::Splitter(0, 0, 0, 0, Button_3, Button_4, #PB_Splitter_Vertical|#PB_Splitter_Separator)
