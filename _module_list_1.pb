...
Module ListIcon
  ...
  Procedure.l Draw(*this._S_widget)
    ...
    Macro _update_(_this_)
      If _this_\change <> 0
        _this_\scroll\width = Bool(_this_\flag\checkBoxes) * 20 + _this_\row\sublevel - Bool(_this_\flag\checkBoxes And Not _this_\Flag\GridLines) * 4
          ...
          If Not _this_\Columns()\items()\hide
            ...
            If (_this_\change Or _this_\scroll\v\change Or _this_\scroll\h\change)
              ...
              If _this_\flag\buttons Or _this_\flag\lines 
                _this_\Columns()\items()\box[0]\x = _this_\Columns()\x + _this_\Columns()\items()\sublevellen - _this_\row\sublevellen + Bool(_this_\flag\buttons) * 5 + Bool(Not _this_\flag\buttons And _this_\flag\lines) * 9 - _this_\scroll\h\page\pos 
               ; _this_\Columns()\items()\box[0]\x = _this_\Columns()\x + _this_\Columns()\items()\sublevellen - _this_\row\sublevellen  + 8 - _this_\scroll\h\page\pos 
              ...
              _this_\Columns()\items()\image\x = _this_\Columns()\x + _this_\Columns()\items()\image\padding\left + _this_\Columns()\items()\sublevellen -_this_\scroll\h\page\pos
              _this_\Columns()\items()\text\x = _this_\Columns()\x + _this_\Columns()\items()\text\padding\left + _this_\Columns()\items()\sublevellen + _this_\Columns()\sublevel  -_this_\scroll\h\page\pos
      ...
      If Not \hide
        ...
        If \row\count
          ...
          If \Flag\GridLines ;And Not \text\count
              Protected i, l=1, alpha=255, s=((\scroll\v\page\pos+\Columns()\height)/(\text\height+\flag\gridlines))
...
;                   \Columns()\items()\hide = 1
          ...
          If Not \Columns()\index
            ...
            ;\row\sublevel = \image\padding\left + Bool(\flag\buttons) * 20
