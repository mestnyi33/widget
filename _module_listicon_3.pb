    ...
    Macro _update_(_this_)
      ...
      ForEach _this_\Columns()
        ...
        If (_this_\change Or _this_\scroll\v\change Or _this_\scroll\h\change)
          _this_\Columns()\text\x = _this_\Columns()\x + _this_\Columns()\sublevel -_this_\scroll\h\page\pos + 5
          _this_\Columns()\text\y = _this_\Columns()\y+(_this_\Columns()\height+2-_this_\Columns()\text\height)/2
        EndIf
          ...
          If Not _this_\Columns()\items()\hide
            ...
            If _this_\change
              ...
              If ListIndex(_this_\Columns()) = 0
                ...
                _this_\Columns()\items()\sublevel[2] = _this_\Columns()\items()\sublevel[1] ;+ _this_\Columns()\image\width + Bool(_this_\Columns()\image\width) * 3
              EndIf
            EndIf
            ...
            If (_this_\change Or _this_\scroll\v\change Or _this_\scroll\h\change)
              ...
              _this_\Columns()\items()\text\x = _this_\Columns()\x+ _this_\Columns()\items()\sublevel[2]-_this_\scroll\h\page\pos + 5
              ...
              If _this_\flag\checkBoxes
                ...
                _this_\Columns()\items()\box[1]\x = _this_\x[2]+2-_this_\scroll\h\page\pos
              ...
              If _this_\flag\buttons Or _this_\flag\lines 
                ...
                _this_\Columns()\items()\box[0]\x = _this_\x+_this_\Columns()\items()\sublevel[1] - (_this_\sublevel+_this_\flag\buttons)/2 - _this_\scroll\h\page\pos 
            ...
            ForEach \Columns()\items()
              ...
              If \Columns()\items()\draw
                ...
                If \Columns()\items()\text\string.s
                  ...
                  DrawRotatedText(\Columns()\items()\text\x, \Columns()\items()\text\y, \Columns()\items()\text\string.s, Bool(\Columns()\items()\text\vertical)*\text\rotate, \Columns()\items()\color\front[\Columns()\items()\color\state])
                EndIf
              EndIf
...
;       EndIf
  ...
  Procedure.i AddItem(*This._S_widget, Item.l, Text.s, Image.i=-1, sublevel.i=0)
    Protected height.i, *parent._S_items
