...
Module ListIcon
  ...
  Procedure.l Draw(*this._S_widget)
    ...
    Macro _update_(_this_)
      If _this_\change <> 0
        _this_\scroll\width = Bool(_this_\flag\checkBoxes) * 20 + _this_\sub_level
      ...
      ForEach _this_\Columns()
        ...
        If (_this_\change Or _this_\scroll\v\change Or _this_\scroll\h\change)
          _this_\Columns()\text\x = _this_\Columns()\x - _this_\scroll\h\page\pos + 5
          ...
          If Not _this_\Columns()\items()\hide
            ...
            If (_this_\change Or _this_\scroll\v\change Or _this_\scroll\h\change)
              ...
              If _this_\flag\buttons Or _this_\flag\lines 
                ...
                _this_\Columns()\items()\box[0]\x = _this_\x+_this_\Columns()\items()\sub_len - (_this_\sub_len+_this_\flag\buttons)/2 - _this_\scroll\h\page\pos 
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If OpenWindow(0, 0, 0, 1110, 650, "TreeGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    g = 10
    *g = Widget(10, 100, 160, 210,"Column_1",90)                                         
    ...
    *g = Widget(180, 100, 160, 210,"Column_1",90)                                         
    ...
    g = 12
    *g = Widget(350, 100, 340, 210,"Column_1",90, #PB_Flag_FullSelection|#PB_Flag_GridLines|#PB_Flag_CheckBoxes )                            
    AddElement(*List()) : *List() = *g
    For i=1 To 2
    ...
    g = 13
    *g = Widget(700, 100, 180, 210,"Column_1",90, #PB_Flag_AlwaysSelection|#PB_Flag_GridLines)                                         
    AddElement(*List()) : *List() = *g
