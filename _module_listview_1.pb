...
Module ListView
  ...
  Procedure.i Resize(*This._S_widget, X.i,Y.i,Width.i,Height.i)
    With *This
      ...
      If \Resize And \scroll And \scroll\v And \scroll\h
      ...
      Select _type_
        Case #PB_EventType_MouseLeave
         ;  Debug ""+#PB_Compiler_Line +" Мышь находится снаружи итема " + _this_ +" "+ _this_\from
          ...
          If Not _this_\flag\multiselect And (_this_\Items()\Color\State <> 2 Or down)
             _this_\Items()\Line =- 1
        ...
        Case #PB_EventType_MouseEnter
          ...
          If Not _this_\flag\multiselect And _this_\Items()\Color\State <> 2
        ...
        Case #PB_EventType_LeftButtonDown
         ...
         Case #PB_EventType_MouseMove
           If _this_\flag\multiselect And down
...
;           Next
  ...
  Procedure.i CallBack(*This._S_widget, EventType.i)
    ...
    With *This
      Repaint | Bar::CallBack(\scroll\v, EventType, \Canvas\Mouse\X, \Canvas\Mouse\Y);,0, 0, \scroll\h, \Canvas\Window, \Canvas\Gadget)
      If Repaint
        \Scroll\Y =- \scroll\v\Page\Pos
      EndIf
      Repaint | Bar::CallBack(\scroll\h, EventType, \Canvas\Mouse\X, \Canvas\Mouse\Y);,0, 0, \scroll\v, \Canvas\Window, \Canvas\Gadget)
      If Repaint
        \Scroll\X =- \scroll\h\Page\Pos
      EndIf
      
      If *This And (Not *This\scroll\v\from And Not *This\scroll\h\from)
        ProcedureReturn _CallBack(*this, EventType, \Canvas\Mouse\X, \Canvas\Mouse\Y)
      EndIf
    EndWith
...
;               Case #PB_EventType_LeftDoubleClick : PostEvent(#PB_Event_Widget, \Canvas\Window, \Canvas\Gadget, #PB_EventType_LeftDoubleClick)
              ...
              Case #PB_EventType_LeftButtonDown
                ;                 \Line = 
               ; get_from(*This, \Canvas\Mouse\X, \Canvas\Mouse\Y)
;                 \Line[1] = \Line
              ...
              Case #PB_EventType_MouseMove  
                ...
                If \Line <> Item And Item =< ListSize(\Items())
                  ...
                  If \Canvas\Mouse\Y < \scroll\v\page\pos
                    
                    Bar::SetState(\scroll\v, \scroll\v\page\pos - \Text\Height)
                    \Scroll\Y =- \scroll\v\Page\Pos                                   ; в конце
                  ElseIf \Canvas\Mouse\Y >= \scroll\v\max - \scroll\v\page\end
  ...
  Procedure.i Widget(*This._S_widget, Canvas.i, X.i, Y.i, Width.i, Height.i, Text.s, Flag.i=0, Radius.i=0)
    If *This
      With *This
        ...
        \scroll\h = Bar::Scroll(0, 0, 0, 16, 0,0,0, 0, 7)
