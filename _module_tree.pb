...
DeclareModule Structures
  ...
  Structure _S_scrolls Extends _S_coordinate
;     Orientation.b
;     *Vertical._S_bar
;     *Horizontal._S_bar
  EndStructure
...
; ;   Declare.i Height(*Scroll._S_bar)
  ...
  Declare.i Widget(*Scroll._S_bar, X.i,Y.i,Width.i,Height.i, Min.i, Max.i, PageLength.i, Flag.i, Radius.i=0)
...
; ; ;         EndIf
  ...
  Procedure.i Widget(*Scroll._S_bar, X.i,Y.i,Width.i,Height.i, Min.i, Max.i, PageLength.i, Flag.i, Radius.i=0)
    ...
    With *This
      ...
      Else
        CompilerIf Defined(Bar, #PB_Module)
          Width = Abs(\Width[1]-\Text\X*2    -Bar::Width(\vScroll)) ; bug in linux иногда
          Height = \Height[1]-\Text\y*2      -Bar::Height(\hScroll)
        CompilerElse
  ...
  Procedure.i Draw(*This._S_widget)
    ...
    If Not *This\Hide
      ...
      With *This
        ...
        iY=\Y[2]
        CompilerIf Defined(Bar, #PB_Module)
          iwidth = *This\width[2]-Bar::Width(*This\vScroll)
          iheight = *This\height[2]-Bar::Height(*This\hScroll)
        CompilerElse
          iwidth = *This\width[2]
...
;             ; Посылаем сообщение об изменении размера 
          ...
          ForEach *This\Items()
            ...
            If Not \hide And *This\Flag\Lines And *This\sublevellen
              ...
              If x_point>*This\x[2]
                ...
                If \i_Parent
                  If \sublevel 
                    start = \i_Parent\y+\i_Parent\height+\i_Parent\height/2 + *This\Scroll\y - line_size
                  Else 
                    start = *This\y[2]+\i_Parent\height/2 + *This\Scroll\y
                  EndIf
        ...
        If ListSize(*This\Items())
          ...
          CompilerIf Defined(Bar, #PB_Module)
            ...
            If \vScroll\Page\Length And \vScroll\Max<>\Scroll\Height+Bool(\Text\Count<>1 And \Flag\GridLines) And
               Bar::SetAttribute(\vScroll, #PB_ScrollBar_Maximum, \Scroll\Height+Bool(\Text\Count<>1 And \Flag\GridLines))
              Bar::Resizes(\vScroll, \hScroll, #PB_Ignore, #PB_Ignore, #PB_Ignore, #PB_Ignore)
            EndIf
            If \hScroll\Page\Length And \hScroll\Max<>\Scroll\Width And
               Bar::SetAttribute(\hScroll, #PB_ScrollBar_Maximum, \Scroll\Width)
              Bar::Resizes(\vScroll, \hScroll, #PB_Ignore, #PB_Ignore, #PB_Ignore, #PB_Ignore)
            EndIf
  ...
  Procedure.i ToReturn(*This._S_widget) ; Ok
    ...
    With  *This
      ...
      ;       Bar::SetState(\vScroll, \vScroll\Max)
      Repaint = #True
    EndWith
...
DeclareModule Editor
  ...
  Declare.i Repaint(*This._S_widget)
  Declare.i Resize(*This._S_widget, X.i,Y.i,Width.i,Height.i, Canvas.i=-1)
...
Module Editor
  ...
  ;- PROCEDURE
  ;-
  Procedure.i Repaint(*This._S_widget)
    If *This
      PostEvent(#PB_Event_Widget, *This\Canvas\Window, *This, #PB_EventType_Create)
    Else
      ForEach List()
  ...
  Procedure.i SetState(*This._S_widget, State.i)
    ...
    With *This
      ...
      If State <> #PB_Ignore
        ...
        \Items()\Line = \Items()\Item 
        ;PostEvent(#PB_Event_Gadget, *This\Canvas\Window, *This\Canvas\Gadget, #PB_EventType_Repaint)
        Bar::SetState(\vScroll, ((\Line * \Text\Height)-\vScroll\Height) + \Text\Height) : \Scroll\Y =- \vScroll\Page\Pos
      EndIf
    EndWith
  EndProcedure
  ...
  Procedure.i Events(*This._S_widget, EventType.i)
    ...
    With *This
      Repaint | Bar::CallBack(\vScroll, EventType, \Canvas\Mouse\X, \Canvas\Mouse\Y,0, 0, \hScroll, \Canvas\Window, \Canvas\Gadget)
      If Repaint
        \Scroll\Y =- \vScroll\Page\Pos
      EndIf
      Repaint | Bar::CallBack(\hScroll, EventType, \Canvas\Mouse\X, \Canvas\Mouse\Y,0, 0, \vScroll, \Canvas\Window, \Canvas\Gadget)
      If Repaint
  ...
  Procedure Widget_CallBack()
    Protected String.s, *This._S_widget = EventGadget()
...
;         HideWindow(Window, 1, #PB_Window_NoActivate)
  ...
  Procedure get_from(*This._S_widget, MouseX=-1, MouseY=-1, focus=0)
    Protected adress.i
  ...
  Procedure item_from(*This._S_widget, MouseX=-1, MouseY=-1, focus=0)
    Protected adress.i
    Protected lostfocus.i=-1, collapsed.i, sublevel.i
    Protected Buttons
          ...
          If (MouseY > (\Items()\Y) And MouseY =< ((\Items()\Y+\Items()\Height))) And 
            ...
            If \Items()\Line <> \Items()\Item 
              ...
              *This\Line = \Items()\Line
              ...
              ;*This\Text = \Items()\text 
              ;CopyStructure(\Items()\text, *This\Text, _S_text)
  ...
  Procedure.i SetState(*This._S_widget, State.i)
    With *This
      ...
      Bar::SetState(\vScroll, ((State*\Text\Height)-\vScroll\Height) + \Text\Height) : \Scroll\Y =- \vScroll\Page\Pos ; в конце
                                                                                                                         ; Bar::SetState(\vScroll, (State*\Text\Height)) : \Scroll\Y =- \vScroll\Page\Pos ; в начале 
      PopListPosition(\Items())
    EndWith
  EndProcedure
...
;                 \Items()\Line = \Items()\Item
  ...
  Procedure.i _Events(*This._S_widget, EventType.i)
    ...
    If *This
      With *This
        If Not \hide
          If \vScroll
            Repaint = Bar::CallBack(\vScroll, EventType, \Canvas\Mouse\X, \Canvas\Mouse\Y, WheelDelta, 0, \hScroll, \Canvas\Window, \Canvas\Gadget)
            If Repaint
          ...
          If \hScroll
            Repaint = Bar::CallBack(\hScroll, EventType, \Canvas\Mouse\X, \Canvas\Mouse\Y, WheelDelta, 0, \vScroll, \Canvas\Window, \Canvas\Gadget)
            If Repaint
          ...
          If Not (\vScroll\Buttons Or \hScroll\Buttons)
            Select EventType
              Case #PB_EventType_MouseWheel
                If Not \vScroll\Hide
                  Select -WheelDelta
                    Case-1 : Repaint = Bar::SetState(\vScroll, \vScroll\Page\Pos - (\vScroll\Max-\vScroll\Min)/30)
                    Case 1 : Repaint = Bar::SetState(\vScroll, \vScroll\Page\Pos + (\vScroll\Max-\vScroll\Min)/30)
                  EndSelect
                EndIf
