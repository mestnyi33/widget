        ...
        If Not _this_\items()\hide
          ...
          If (_this_\change Or _this_\scroll\v\change Or _this_\scroll\h\change)
            ...
            If _this_\flag\buttons Or _this_\flag\lines 
              _this_\items()\box[0]\x = _this_\x[2] + _this_\items()\sub_len - _this_\sub_len + Bool(_this_\flag\buttons) * 8 + Bool(Not _this_\flag\buttons And _this_\flag\lines) * 12 - _this_\scroll\h\page\pos 
    ...
    With *this
      If *this
        ...
        If handle
          ...
          \items()\sub_len = \items()\sub_level * \sub_len + \flag\buttons + Bool(\flag\buttons) * 5 + Bool(\flag\checkBoxes) * 18      ;     - Bool(Not \flag\buttons And \flag\lines) * 6
