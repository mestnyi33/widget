...
Module Tree
  ...
  Procedure.l CallBack(*this._S_widget, EventType.l, mouse_x.l=-1, mouse_y.l=-1)
    Protected Result, from =- 1
    Static cursor_change, LastX, LastY, Last, Down, buttons, *leave._S_widget
...
;         EndIf
      ...
      If leave
        ...
        If *this\canvas\mouse\buttons = 0
          Events(*leave, #PB_EventType_MouseLeave, *leave\from)
        EndIf
        
        If *leave And *this\canvas\gadget <> *leave\canvas\gadget
          ...
          Select EventType
            ...
            Case #PB_EventType_LeftButtonUp 
              ...
              If \mouse\buttons
                ...
                If *this <> *leave
                  Events(*this, #PB_EventType_MouseLeave, *this\from)
                  Events(*leave, #PB_EventType_MouseEnter, *leave\from)
                EndIf
              EndIf
