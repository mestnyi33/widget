...
Module Tree
  ...
  ;-
  Procedure Events(*this._S_widget, eventtype.l, mouse_x.l=-1, mouse_y.l=-1)
  ...
  Procedure.l CallBack(*this._S_widget, EventType.l, mouse_x.l=-1, mouse_y.l=-1)
    ...
    With *this
      ...
      If enter Or (EventType = #PB_EventType_LeftButtonUp And ((*this = *leave And Not *event\leave) Or (*leave And *event\leave <> *leave And *this = *event\leave)))
        If *this <> *event\leave
          *leave = *this
        EndIf
        
        If *leave And *this\canvas\mouse\buttons = 0
          Events(*leave, #PB_EventType_MouseEnter, mouse_x, mouse_y)
          *event\leave = *leave
        EndIf
      EndIf
      ...
      ; под курсором   
      If *this = *leave ; And Not *this\mouse\buttons
