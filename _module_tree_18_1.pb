...
Module Tree
  ...
  Macro _bar_update_(_this_, _item_)
    If (_item_\y-_this_\scroll\v\y-_this_\scroll\v\page\pos) < 0
      _this_\change = Bar::SetState(_this_\scroll\v, (_item_\y - _this_\scroll\v\y)) 
      
    ElseIf (_item_\y-_this_\scroll\v\y-_this_\scroll\v\page\pos) > (_this_\height[2]-_item_\height) 
      _this_\change = Bar::SetState(_this_\scroll\v, (_item_\y-_this_\scroll\v\y) - (_this_\height[2]-_item_\height)) 
              ...
              Case #PB_Shortcut_Up, #PB_Shortcut_Home
                If *this\row\selected
                  ...
                  ElseIf *this\row\selected\index > 0
                    ...
                    ;                     Debug ">0 "+ Bool(((*this\scroll\v\y - *this\row\selected\y) + *this\scroll\v\page\pos) > 0)
                    ;                     Debug "<0 "+Bool((*this\row\selected\y-*this\scroll\v\y-*this\scroll\v\page\pos) < 0)
                    ;                     Debug Bool((*this\row\selected\y-*this\scroll\v\y-*this\scroll\v\page\pos) > (*this\height[2]-*this\row\selected\height))
