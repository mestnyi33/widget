...
DeclareModule Tree
  ...
  Declare.i AddItem(*this, Item.l, Text.s, Image.i=-1, Flag.i=0)
...
Module Tree
  ...
  ;-
  Procedure.i AddItem(*this._S_widget, Item.l, Text.s, Image.i=-1, Flag.i=0)
    Static first.i
  ...
  Procedure.l SetItemState(*this._S_widget, Item.l, State.b)
    ...
    If (*this\flag\multiSelect Or *this\flag\clickSelect)
      ...
      If Item > *this\text\count - 1 : Item = *this\text\count - 1 :  EndIf
