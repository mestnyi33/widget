        ...
        If \text\count
          ...
          ForEach \items()
            ...
            If \flag\lines And \sub_len
              ...
              ; Vertical plot
              If \items()\parent And x_point>\x And \items()\draw
                
               ; Debug \items()\draw
                If \items()\sub_level 
                  y_point = \items()\parent\y + \items()\parent\height - \scroll\v\page\pos
                Else 
                  y_point = \y[2] + \items()\parent\height/2 - \scroll\v\page\pos
                EndIf
                If y_point < \y[2] : y_point = \y[2] : EndIf
                
                h_point = \items()\box[0]\y+\items()\box[0]\height/2 - y_point 
      ...
      If *this
        ...
        If \items()\handle
          ...
          If \items()\image\change
            ...
            \sub_level = \items()\image\padding\left + ImageWidth(Image)
          EndIf
