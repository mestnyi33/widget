...
Module Tree
  ...
  Procedure.l Draw(*this._S_widget)
    ...
    Macro _update_(_this_, _items_)
      ...
      If _this_\change <> 0
        _this_\width[2] = _this_\scroll\h\page\Len ; (_this_\scroll\v\x + Bool(_this_\scroll\v\hide) * _this_\scroll\v\width) - _this_\x[2]
        _this_\height[2] = _this_\scroll\v\page\Len ; (_this_\scroll\h\y + Bool(_this_\scroll\h\hide) * _this_\scroll\h\height) - _this_\y[2]
    ...
    Macro _draws_(_this_, _items_)
      ...
      ForEach _items_
        If _items_\draw
          If _items_\width <> _this_\scroll\h\page\len
            _items_\width = _this_\scroll\h\page\len
          EndIf
...
;     ;EndIf
    ...
    SplitterGadget(10,8, 8, 306, 491-16,g, 0)
    CompilerIf #PB_Compiler_Version =< 546
