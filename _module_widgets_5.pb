...
;     EndIf
  ...
  Procedure.b CallBack_Bar(*this._S_widget, EventType.l, mouse_x.l, mouse_y.l, Wheel_X.b=0, Wheel_Y.b=0)
    Protected Result, from =- 1 
    Static cursor_change, LastX, LastY, Last, *leave._S_widget, Down, *active._S_widget
...
;           EndMacro
          ...
          If from = 0 And \button[#_b_3]\interact 
            If \Vertical
              Result = SetPos_Bar(*this, (mouse_y-\thumb\len/2))
            Else
              Result = SetPos_Bar(*this, (mouse_x-\thumb\len/2))
            EndIf
        ...
        Case #PB_EventType_MouseMove
          If Down And *leave = *this And Bool(LastX|LastY) 
            If \Vertical
              Result = SetPos_Bar(*this, (mouse_y-LastY))
            Else
              Result = SetPos_Bar(*this, (mouse_x-LastX))
            EndIf
          EndIf
  ...
  Macro _set_color_state_(_this_, _state_)
    Select _this_\type 
      Case #PB_GadgetType_Button, #PB_GadgetType_ComboBox, #PB_GadgetType_HyperLink
        _this_\color\state = _state_
    EndSelect
  EndMacro
  
  
  Procedure _left_button_down_(*this._S_widget, mouse_x.l, mouse_y.l, at)
    Protected Repaint, delta
  ...
  Procedure Events(*this._S_widget, eventtype.l, mouse_x.l=-1, mouse_y.l=-1, position.l=0)
    ...
    Select eventtype
      ...
      Case #PB_EventType_LeftButtonDown
        ...
        _set_color_state_(*this, 2)
        _left_button_down_(*this, mouse_x, mouse_y, *this\from)
        Result = 1
        
      Case #PB_EventType_LeftButtonUp
        Debug "left up - "+*this
        
        _set_color_state_(*this, 1)
...
;             EndIf
    ...
    If Not position And *this\scroll And *this\scroll\v And *this\scroll\h
      Result | CallBack_Bar(*this\scroll\v, eventtype, mouse_x, mouse_y, *this\root\canvas\mouse\wheel\x, *this\root\canvas\mouse\wheel\y)
      Result | CallBack_Bar(*this\scroll\h, eventtype, mouse_x, mouse_y, *this\root\canvas\mouse\wheel\x, *this\root\canvas\mouse\wheel\y)
  ...
  Procedure.l CallBack(*this._S_widget, EventType.l, mouse_x.l=-1, mouse_y.l=-1)
    ...
    If Not *this\handle ; Or *this = *this\root
      ProcedureReturn 0
    EndIf
    ...
    With *this
      ...
      ;Debug mouse_x;_from_point_(mouse_x, mouse_y, *this)
      
      Protected enter = Bool(*value\event\enter <> *this And Not (*value\event\enter And *value\event\enter\index > *this\index) And _from_point_(mouse_x, mouse_y, *this, [4]))
      Protected leave = Bool(*value\event\enter And (enter Or (*value\event\enter = *this And Not _from_point_(mouse_x, mouse_y, *value\event\enter, [4]))))
      ...
      If leave
          ...
          If Not *this\root\canvas\mouse\buttons And *value\event\enter <> *this\parent
            Result | Events(*value\event\enter, #PB_EventType_MouseLeave, mouse_x, mouse_y)
            
            If *value\event\enter And *value\event\enter\root\canvas\gadget <> *this\root\canvas\gadget
        ...
        If enter
          *value\event\enter = *this
          ...
          If Not *this\root\canvas\mouse\buttons And Not (*value\event\leave And *value\event\leave\parent = *this)
      ...
      ;Debug ""+*this +" "+ *Value\event\enter +" "+ *Value\event\leave
...
;                 EndIf
          ...
          If *this = *value\event\active
            ...
            Select *this\root\canvas\key
              Case #PB_Shortcut_PageUp
                If SetState_Bar(*this\scroll\v, 0) 
                  *this\change = 1 
                  Result = 1
                EndIf
                
              Case #PB_Shortcut_PageDown
                If SetState_Bar(*this\scroll\v, *this\scroll\v\page\end) 
                  *this\change = 1 
                  Result = 1
                EndIf
              ...
              Case #PB_Shortcut_Up, #PB_Shortcut_Home
                If *this\row\selected
                  If (*this\root\canvas\key[1] & #PB_Canvas_Alt) And
                    ...
                    If SetState_Bar(*this\scroll\v, *this\scroll\v\page\pos-18) 
                      *this\change = 1 
                      Result = 1
                    EndIf
                  ...
                  ElseIf *this\row\selected\index > 0
                    ...
                    If ((*this\scroll\v\y - *this\row\selected\y) + *this\scroll\v\page\pos) > 0
                      *this\change = SetState_Bar(*this\scroll\v, (*this\row\selected\y - *this\scroll\v\y)) 
                    ...
                    ElseIf (*this\row\selected\y-*this\scroll\v\y-*this\scroll\v\page\pos) > (*this\height[2]-*this\row\selected\height) 
                      *this\change = SetState_Bar(*this\scroll\v, (*this\row\selected\y-*this\scroll\v\y) - (*this\height[2]-*this\row\selected\height)) 
              ...
              Case #PB_Shortcut_Left
                If (*this\root\canvas\key[1] & #PB_Canvas_Alt) And
                  ...
                  *this\change = SetState_Bar(*this\scroll\h, *this\scroll\h\page\pos-(*this\scroll\h\page\end/10)) 
                  Result = 1
                EndIf
      ...
      If *this\row\count And *this = *value\event\enter And 
         (*this\scroll And *this\scroll\v\from =- 1 And *this\scroll\h\from =- 1) ;And Not *this\root\canvas\key; And Not *this\mouse\buttons
      ...
      ; 
      ;       Select *this
      ;         Case *value\event\leave, *value\event\active
      ;           
  ...
  Procedure.l ReCallback(*this._S_widget, eventtype.l, mouse_x.l, mouse_y.l)
    Static repaint
    
    With *this
      If _from_point_(mouse_x, mouse_y, *this, [4])
        If *value\event\enter <> *this 
          If Not *this\color\state
      ...
      If \CountItems ; ListSize(\childrens())
        ForEach \childrens()
          ...
          If \childrens()\CountItems ; ListSize(\childrens()\childrens()) 
            ProcedureReturn ReCallback(\childrens()\childrens(), eventtype, mouse_x, mouse_y)
          EndIf
        Next
      EndIf
...
;       EndIf
    ;  Debug 8888888
      Repaint | ReCallBack(*this, EventType, *this\root\canvas\mouse\x, *this\root\canvas\mouse\y)
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If OpenWindow(0, 100, 100, 220, 220, "Window_0", #PB_Window_SystemMenu);, WindowID(100))
    ...
    SetData(Container(20, 20, 180, 180), 20)
;     SetData(Container(20, 20, 180, 180), 30)
    SetData(Button(0, 20, 180, 60, "butt_0"), 100)
...
; Folding = AAAAAAAAAAIAAAAgAAwAgCAAACAgwQAAAA-PAbbAAAAAAAAAAAgAAAAAgCAAAASQAAAAAAAAAAAAAAADAAAACCAAAAAAAAADAAAAAAAAAAAAAAAACABAACABAAEwBAAAAAAAAAAAAAGAAAAAAAAEAAAAAAAAAAAAAAA+nDAAAAAAAjBDAAAAAAADAAAAAAAweAAIA+BA5f3-jAEAAAAAABAAAMAjxAw8AAAAEEAAAhHAAAAQAAAcAYRzAAAAAAAAA+-PA+
; EnableXP