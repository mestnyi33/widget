       ...
       ; Debug \area\len
        ...
        If \splitter
          If \splitter\fixed = #_b_1
            \button[#_b_1]\len = \thumb\pos - \area\pos - Bool(\thumb\len<>\button\len) * \button\len
            \page\pos = 0
          EndIf
          If \splitter\fixed = #_b_2
            \button[#_b_2]\len = \area\len - ((\thumb\pos+\thumb\len)-\area\pos) - Bool(\thumb\len<>\button\len) * (\button\len - 1)
            \page\pos = \max
           EndIf
        EndIf
    ...
    With *this
      ...
      If (\max-\min) >= \page\len
        ...
        If \splitter
          If \splitter\fixed = 1
            If \vertical
              If \height - \button\len > \button[#_b_1]\len + \button[#_b_2]\len
                \page\pos = 0
              Else
                \button[#_b_1]\len = \height - \button\len
                \area\len = \height
                \page\pos = \max
                \area\pos = \y
              EndIf
            Else
              If \width - \button\len > \button[#_b_1]\len + \button[#_b_2]\len
                \page\pos = 0
              Else
                \button[#_b_1]\len = \width - \button\len
                \area\len = \width
                \page\pos = \max
                \area\pos = \X 
              EndIf
          ...
          If \splitter\fixed = 2
            ...
            Else
              If \width - \button\len > \button[#_b_1]\len + \button[#_b_2]\len
                \page\pos = \max
              Else
                \button[#_b_2]\len = \width - \button\len
                \area\len = \width
                \area\pos = \X 
                \page\pos = 0
              EndIf
