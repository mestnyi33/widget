  ...
  Procedure _pos_(*this._struct_, _scroll_pos_)
    *this\bar\thumb\pos = _thumb_pos_(*this\bar, _scroll_pos_)
    ...
    If *this\bar\change
      ...
      If *this\parent And *this\parent\scroll : *this\parent\change =- 1
        If *this\bar\vertical
...
; ; ;         Wend
  ...
  Procedure.i text_multiline_make(*this._struct_)
    ...
    With *this
      ...
      If string_out <> String.s+Str(*this)     And (Not \text\multiline And Not ListSize(\row\_s())) Or (string_out <> String.s+Str(*this)     And \text\multiline)
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If OpenWindow(0, 0, 0, 615, (height+5)*8+20+90+150, "String on the canvas", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    *S_5 = GetGadgetData(Gadget(15, 305+8, (height+5)*5+10, 290, height, Text1, #__flag_borderless|#__string_center))
    ...
    *S_8 = GetGadgetData(Gadget(18, 305+8, (height+5)*8+10, 290, 90+150, Text, #__flag_gridlines|#__string_multiline))
