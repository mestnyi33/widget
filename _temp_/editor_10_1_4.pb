...
;     Debug *this\text[1]\string.s
  ...
  Procedure _text_sel_change_(*this._s_widget, _line_, _caret_) ; Ok
    ...
    If Repaint
      ...
      ElseIf *this\index[2] > _line_
        If *this\index[2] = _last_line_ ; *this\index[1]
  ...
  Procedure editor_setsel(*this._s_widget, _line_)
    ...
    With *this
      ...
      If _start_drawing_(*this)
        ...
        Repaint = Bool(_text_sel_change_(*this, _line_, text_caret(*this) ))
  ...
  ;-
  ;- - KEYBOARDs
  Procedure _set_selector_(*this._s_widget, _line_)
    Protected Repaint.i, _caret_
    ...
    With *this
      ...
      If _start_drawing_(*this)
        ...
        _text_sel_change_(*this, _line_, _caret_)
  ...
  Procedure.i ToUp(*this._s_widget)
    Protected Repaint
    Static Line
    Protected Shift.i = Bool(*this\root\keyboard\key[1] & #PB_Canvas_Shift)
    ; Если дошли до начала строки то 
    ; переходим в конец предыдущего итема
    
    With *this
      If Shift
        If (\index[2] > 0 And \index[1] = \index[2])
          _set_selector_(*this, \index[2])   
          \index[2] - 1 : \index[1] = \index[2]
        EndIf                               
      Else
  ...
  Procedure.i ToDown(*this._s_widget)
    ...
    With *this
      If Shift
        ...
        _text_sel_change_(*this, \index[2], \text\caret\pos)
        Repaint = 1 
            ...
            Select EventType 
              ...
              Case #PB_EventType_MouseMove  
                If \root\mouse\buttons & #PB_Canvas_LeftButton 
                  ...
                  Repaint = editor_setsel(*this, _line_)
                EndIf
