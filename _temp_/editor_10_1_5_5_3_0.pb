...
Module Editor
  ...
  ;-
  Procedure.l text_caret(*this._s_widget)
  ...
  Procedure _text_sel_(*this._s_widget, _pos_, _len_)
    ...
    *this\text\caret\y = *this\items()\text\y
    ...
    If *this\index[1] > *this\index[2] Or (*this\index[1] = *this\index[2] And *this\text\caret\stop > *this\text\caret\start)
      ...
      If Repaint > 0
        ...
        *this\change = _bar_update_(*this\scroll\v, *this\items()\y, *this\items()\height)
        ...
        ForEach *this\items()
          ...
          ElseIf (*this\items()\text[2]\width And *this\index[2] <> *this\items()\index And _line_ <> *this\items()\index)
    ...
    With *this
      ...
      If _start_drawing_(*this)
        ...
        If _caret_ =- 1
          ...
          ;ElseIf _caret_ > *this\items()\text\len
          ;  _caret_ = *this\items()\text\len
        EndIf
        
        Repaint = Bool(_text_sel_set_(*this, _line_, _caret_))
  ...
  Procedure.i text_sel_reset(*this._s_widget)
    With *this
      PushListPosition(\items())
      ForEach \items() 
        If \items()\text[2]\width <> 0
          \items()\text[1]\len = 0 
          \items()\text[2]\len = 0 
          \items()\text[3]\len = 0 
    ...
    If Not *this\hide
      ...
      With *this
        ...
        If *this\text\editable And *this\focus = *this : DrawingMode(#PB_2DDrawing_XOr)             
          ;  Line((\items()\text\x-\scroll\h\page\pos) + \text\caret\len - Bool(#PB_Compiler_OS = #PB_OS_Windows) - Bool(Left < \scroll\h\page\pos), \items()\y-\scroll\v\page\pos, 1, Height, $FFFFFFFF)
          ;  Line(\text\caret\x - Bool(Left < \scroll\h\page\pos), \text\caret\y, \text\caret\width, \text\caret\height, $FFFFFFFF)
          Line(\text\caret\x - Bool(Left < \scroll\x)-\scroll\h\page\pos, \text\caret\y-\scroll\v\page\pos, 1, height, $FFFFFFFF)
        EndIf
          ...
          If Not \hide And Not \Disable And \interact
            ...
            Select EventType 
              Case #PB_EventType_LeftDoubleClick 
                ...
                *this\text\caret\line = *this\index[2]
              ...
              Case #PB_EventType_LeftButtonDown
                ...
                If *this\text\caret\line And 
                   *this\text\caret\line = \items()\index And
                ...
                Else
                  ...
                  If \items()\text[2]\width And 
                     \root\mouse\x > \items()\text[2]\x And
                     \root\mouse\y > \items()\text\y And 
                     \root\mouse\x < \items()\text[2]\x+\items()\text[2]\width And
                     \root\mouse\y < \items()\text\y+\items()\text\height
                    
                    Debug \items()\text[2]\width
                  Else
                    text_sel_reset(*this)
                    ...
                    If \text\caret\stop = DoubleClick
                      DoubleClick =- 1
                      Caret = 0
                      \text\caret\start = \items()\text\len
                    Else
              ...
              Case #PB_EventType_LeftButtonUp  
                ...
                ForEach \items()
                  ...
                  ;             
                  ;           _text_sel_(*this, 0, (\items()\text\len - Bool(Not \items()\text\len)))
                  ;           Repaint = #True
                  ;           
