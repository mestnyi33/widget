...
Module Editor
  ...
  Procedure _text_sel_(*this._s_widget, _pos_, _len_)
    ...
    *this\text\caret\y = *this\items()\text\y
    ;  Debug Right(*this\items()\text[1]\string, 1)
    *this\text\caret\width = TextWidth(Right(*this\items()\text[1]\string, 1))
    
    If *this\index[1] > *this\index[2] Or (*this\index[1] = *this\index[2] And *this\text\caret\stop > *this\text\caret\start)
      *this\text\caret\x = *this\items()\text[3]\x-*this\text\caret\width
    Else
      *this\text\caret\x = *this\items()\text[2]\x-*this\text\caret\width
    EndIf
    ...
    If Not *this\hide
      ...
      With *this
        ...
        If *this\text\editable And *this\focus = *this : DrawingMode(#PB_2DDrawing_XOr)             
          ...
          Box(\text\caret\x - Bool(Left < \scroll\x)-\scroll\h\page\pos, \text\caret\y-\scroll\v\page\pos, \text\caret\width, height, $FFFFFFFF)
        EndIf
