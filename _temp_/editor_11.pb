...
Module Editor
  ...
  Procedure _text_sel_set_(*this._s_widget, _pos_, _len_)
    ...
    *this\items()\text[3]\pos = *this\items()\text[2]\pos + Bool(*this\items()\text[2]\len > 0) * *this\items()\text[2]\len ; (_pos_ + Bool(_len_ > 0) * _len_)
          ...
          If \text\change =- 1
            ...
            If \items()\text[2]\change : \items()\text[2]\change = #False 
              ...
              \items()\text[2]\width = TextWidth(\items()\text[2]\string.s) + 
                                       Bool(*this\index[2] > *this\items()\index And Not *this\items()\text[3]\len And *this\items()\text[3]\pos = *this\items()\text\len) * *this\flag\fullSelection
          ...
          ForEach \items()
            ...
            If Drawing
              ...
              If \items()\text[2]\change : \items()\text[2]\change = #False 
                ...
                \items()\text[2]\width = TextWidth(\items()\text[2]\string.s) + Bool(\items()\text[3]\pos = \items()\text\len) * *this\flag\fullSelection ; TextWidth() - bug in mac os
