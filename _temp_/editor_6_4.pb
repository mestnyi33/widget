        ...
        ForEach \items()
          If Bool((_selected_index_ >= \items()\index And _index_ =< \items()\index) Or ; верх
            ...
            Else
              ...
              \items()\text[2]\width = TextWidth(\items()\text[2]\string.s) + Bool(\items()\text\len = \items()\text[2]\len Or \items()\text[2]\len =- 1) * *this\flag\fullSelection ; TextWidth() - bug in mac os
