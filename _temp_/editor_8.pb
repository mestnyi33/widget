      ...
      If StartDrawing(CanvasOutput(*this\root\canvas)) 
        ...
        If *this\index[1] <> _index_ 
          ...
          If *this\index[2] = *this\index[1] 
            ...
            Else
              *this\text\caret\pos = *this\items()\text\len ; - Bool(Not \items()\text\len) ; Выделение пустой строки
            EndIf
        ...
        If *this\index[1] <> _index_ 
          ...
          ForEach *this\items()
            ...
            If Bool((_selected_index_ > *this\items()\index And _index_ < *this\items()\index) Or   ; верх
              ...
              _text_select_(*this, 0, (*this\items()\text\len - Bool(Not *this\items()\text\len)))
