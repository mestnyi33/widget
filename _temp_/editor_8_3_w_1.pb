          ...
          ForEach \items()
            ...
            If Drawing 
              If (\items()\index=*this\index[1]) ; \color\state;
                If *this\items()\color\back[\items()\color\state]<>-1                                 ; no draw transparent
                  If *this\items()\color\fore[\items()\color\state]
                    DrawingMode(#PB_2DDrawing_Gradient|#PB_2DDrawing_AlphaBlend)
                ...
                If *this\items()\color\frame[\items()\color\state]<>-1 ; no draw transparent
                  DrawingMode(#PB_2DDrawing_Outlined|#PB_2DDrawing_AlphaBlend)
            ...
            ; Draw text
              Protected Front_BackColor_1 = RowFontColor(*this, *this\color\state) ; *this\color\front[*this\color\state]&$FFFFFFFF|*this\items()\color\alpha<<24
              Protected Front_BackColor_2 = RowFontColor(*this, 2)                 ; *this\color\front[2]&$FFFFFFFF|*this\items()\color\alpha<<24
