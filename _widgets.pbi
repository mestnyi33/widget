...
;       ProcedureReturn Updates(*scroll._s_scroll, x.l,y.l,width.l,height.l)
    ...
    Procedure _set_clip_len(*this._s_widget)
      ...
      ; if _is_scroll_bar_(*this)
      If (*this\parent\scroll And (*this\parent\scroll\v = *this Or *this = *this\parent\scroll\h))
        ; If *this\bar\_type = #PB_GadgetType_ScrollBar
        parent_x2 = *this\parent\x[#__c_2]+*this\parent\width[#__c_3]   ; -*this\parent\bs*2
        parent_y2 = *this\parent\y[#__c_2]+*this\parent\height[#__c_3]  ; -*this\parent\bs*2-*this\parent\__height
        parent_x4 = *this\parent\x[#__c_4]+*this\parent\width[#__c_4]
        parent_y4 = *this\parent\y[#__c_4]+*this\parent\height[#__c_4]
      Else
        parent_x2 = *this\parent\x[#__c_2]+*this\parent\width[#__c_2]
        parent_y2 = *this\parent\y[#__c_2]+*this\parent\height[#__c_2]
        parent_x4 = *this\parent\x[#__c_4]+*this\parent\width[#__c_4]
        parent_y4 = *this\parent\y[#__c_4]+*this\parent\height[#__c_4]
      EndIf
          ...
          If \resize & #__resize_change
            ...
            If (*this\scroll And *this\scroll\v And *this\scroll\h)
              ...
              If (Change_width Or Change_height)
                Resizes(\scroll, 0, 0, \width[#__c_3], \height[#__c_3])
              EndIf
              
              \width[#__c_2] = \width[#__c_3] - Bool(Not \scroll\v\hide) * \scroll\v\width ; \scroll\h\bar\page\len
              \height[#__c_2] = \height[#__c_3] - Bool(Not \scroll\h\hide) * \scroll\h\height ; \scroll\v\bar\page\len
            Else
              \width[#__c_2] = \width[#__c_3]
              \height[#__c_2] = \height[#__c_3]
            EndIf
