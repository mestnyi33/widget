...
Module Button
  ...
  ;- - MACROS
  ;- - PROCEDUREs
  Procedure.s Text_Wrap (Text.s, Width.i, Mode=-1, DelimList$=" "+Chr(9), nl$=#LF$)
  ...
  Procedure MakeMultiLine(*This.Widget)
...
;               Debug \count\items
              ...
              Protected pos, *Sta.Character = @\text\string.s[2], *End.Character = @\text\string.s[2] 
              While *End\c 
                If *End\c = #LF And *Sta <> *End
                  If Text_Y+\Text\Height < \bs : Text_Y+\Text\Height : Continue : EndIf
