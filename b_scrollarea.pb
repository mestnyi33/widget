...
;         EndIf
        ...
        If *this\bar\page\pos > *this\bar\page\end And *this\bar\button[2]\color\state = 3; And *this\parent And *this\parent\scroll And *this\parent\scroll\v And *this\parent\scroll\h
    ...
    Procedure.b Update(*this._s_widget)
      ...
      If Bool(*this\resize & #__resize_change)
        ...
        Else
          ...
          EndIf
          Debug ""+*this\bar\max +" "+ *this\bar\page\len+" - "+*this\bar\page\end
;           If *this\bar\page\end < 0
;             *this\bar\page\end = 0
;           EndIf
        EndIf
...
;           If *this\bar\page\end >- 1 And *this\bar\page\pos > *this\bar\page\end And *this\parent And *this\parent\scroll And *this\parent\scroll\v And *this\parent\scroll\h
;             
;             Debug  ""+*this\bar\page\pos +" "+ *this\bar\page\end
;             
;             *this\bar\thumb\change = *this\bar\page\pos - *this\bar\page\end
             ...
             ; _move_childrens_(*this, 0,0)
                ...
                ForEach *this\root\_childrens()
                  If *this\root\_childrens()\parent = *this 
                    ; Debug *this\root\_childrens()\class +" - "+ *this\root\_childrens()\parent\class +" - "+ *this\class +" - "+ *this\parent\class; Bool(*this\root\_childrens()\type = #PB_GadgetType_Button)
