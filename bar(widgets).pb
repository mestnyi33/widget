  ...
  Procedure.b Draw_Spin(*this._s_widget)
    With *this
      ...
      If Not \hide And \color\alpha
        ...
        Else
          Line( \bar\button[#__b_2]\X-1, \bar\button[#__b_1]\y, 1, \bar\button[#__b_1]\height, \bar\button[#__b_1]\color\frame&$FFFFFF|\color\alpha<<24) ; $FF000000) ;   
        EndIf
  ...
  Procedure.b Draw_Scroll(*this._s_widget)
    With *this
      ...
      If Not \hide And \color\alpha
        ...
        If \bar\button[#__b_1]\len Or
           \bar\button[#__b_2]\len
          ; Draw buttons back
          DrawingMode(#PB_2DDrawing_Gradient|#PB_2DDrawing_AlphaBlend)
