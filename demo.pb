...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If Open(0, 0, 0, 995, 605, "demo then draw id on the canvas", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    id(Hex(#PB_GadgetType_CheckBox)) = CheckBox(5, 305, 160,95, "CheckBox_"+Hex(#PB_GadgetType_CheckBox), #PB_CheckBox_ThreeState) : SetState(id(Hex(#PB_GadgetType_CheckBox)), #PB_Checkbox_Inbetween)
    id(Hex(#PB_GadgetType_Option)) = Option(5, 405, 160,95, "Option_"+Hex(#PB_GadgetType_Option) ) : SetState(id(Hex(#PB_GadgetType_Option)), 1)                                                       
    id(Hex(#PB_GadgetType_ListView)) = ListView(5, 505, 160,95) : AddItem(id(Hex(#PB_GadgetType_ListView)), -1, "ListView_"+Hex(#PB_GadgetType_ListView)) : For i=1 To 5 : AddItem(id(Hex(#PB_GadgetType_ListView)), i, "item_"+Hex(i)) : Next
    
    ;\\ 2
    id(Hex(#PB_GadgetType_Frame)) = Frame(170, 5, 160,95, "Frame_"+Hex(#PB_GadgetType_Frame) )
    id(Hex(#PB_GadgetType_ComboBox)) = ComboBox(170, 105, 160,45 ) : AddItem(id(Hex(#PB_GadgetType_ComboBox)), -1, "ComboBox_"+Hex(#PB_GadgetType_ComboBox)) : For i=1 To 5 : AddItem(id(Hex(#PB_GadgetType_ComboBox)), i, "item_"+Hex(i)) : Next : SetState(id(Hex(#PB_GadgetType_ComboBox)), 0) 
    id(Hex(100+#PB_GadgetType_ComboBox)) = ComboBox(170, 155, 160,45, #PB_ComboBox_Editable) : AddItem(id(Hex(100+#PB_GadgetType_ComboBox)), -1, "ComboBox_"+Hex(100+#PB_GadgetType_ComboBox)) : For i=1 To 5 : AddItem(id(Hex(100+#PB_GadgetType_ComboBox)), i, "item_"+Hex(i)) : Next : SetState(id(Hex(100+#PB_GadgetType_ComboBox)), 0) 
    ...
    id(Hex(101)) = Option(10, 10, 110,20, "Container_"+Hex(#PB_GadgetType_Container) )  : SetState(id(Hex(101)), 1)  
    ...
    ;\\ 3
    id(Hex(#PB_GadgetType_IPAddress)) = IPAddress(335, 5, 160,95 ) : SetState(id(Hex(#PB_GadgetType_IPAddress)), MakeIPAddress(1, 2, 3, 4))    
    id(Hex(#PB_GadgetType_ProgressBar)) = Progress(335, 105, 160,95,0,100, 0, round) : SetState(id(Hex(#PB_GadgetType_ProgressBar)), 50)
    id(Hex(#PB_GadgetType_ScrollBar)) = Scroll(335, 205, 160,95,0,120,20) : SetState(id(Hex(#PB_GadgetType_ScrollBar)), 50)
    ...
    id(Hex(#PB_GadgetType_TrackBar)) = Track(335, 405, 160,95,0,21, #PB_TrackBar_Ticks ) : SetState(id(Hex(#PB_GadgetType_TrackBar)), 11)
    ...
    id(Hex(#PB_GadgetType_Editor)) = Editor(500, 305, 160,95 ) : AddItem(id(Hex(#PB_GadgetType_Editor)), -1, "editor_"+Hex(#PB_GadgetType_Editor) +#LF$+"add"+#LF$+"multi"+#LF$+"line"+#LF$+"text")  
    ...
    AddItem(id(Hex(#PB_GadgetType_Tree)), -1, "Tree_"+Hex(#PB_GadgetType_Tree)) 
    For i=1 To 5 : AddItem(id(Hex(#PB_GadgetType_Tree)), i, "item_"+Hex(i)) : Next
