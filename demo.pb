...
CompilerIf #PB_Compiler_IsMainFile ;= 100
  ...
  If OpenWindow(#PB_Any, 0, 0, 995, 605, "", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    Widgets(Hex(#PB_GadgetType_String)) = String(5, 105, 160,95, "String_"+Hex(#PB_GadgetType_String)+" set"+#LF$+"multi"+#LF$+"line"+#LF$+"text"); ok
    Widgets(Hex(#PB_GadgetType_Text)) = Text(5, 205, 160,95, "Text_"+Hex(#PB_GadgetType_Text)+#LF$+"set"+#LF$+"multi"+#LF$+"line"+#LF$+"text"+#LF$+"center", #__text_center|#__text_border)        ; ok
    ...
    Widgets(Hex(301)) = Spin(0, 0, 100,20,0,10, #__bar_Vertical);, "Button_1")
