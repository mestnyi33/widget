  ...
  Module widget
    ...
    Procedure.i Create(type.l, *parent._s_widget, x.l,y.l,width.l,height.l, *param_1, *param_2, *param_3, size.l, flag.i=0, round.l=7, scroll_step.f=1.0)
      ...
      With *this
        ...
        *this\bar\from =- 1
        *this\bar\state =- 1
        *this\bar\increment = scroll_step
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If OpenWindow(0, 0, 0, 605+30, 140+200+140+140, "ScrollBarGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    widget::Text(300+10, 15, 250,  20, "ScrollBar Standard  (start=50, page=30/150)",#PB_Text_Center)
    ...
    widget::SetState    (Widget(),  50)  ; set 1st scrollbar (ID = 0) to 50 of 100
    widget::Text(300+10,110, 250,  20, "ScrollBar Vertical  (start=100, page=50/300)",#PB_Text_Right)
    ...
    widget::Text(300+10,  140+10, 250, 20,"TrackBar Standard", #PB_Text_Center)
    ...
    widget::SetState(Widget(), 5000)
    widget::Text(300+10, 140+90, 250, 20, "TrackBar Ticks", #PB_Text_Center)
    ...
    widget::Text(300+60, 140+160, 200, 20, "TrackBar Vertical", #PB_Text_Right)
    ...
    widget::Text(300+10, 140+200+10, 250,  20, "ProgressBar Standard  (start=65, page=30/100)",#PB_Text_Center)
    ...
    widget::SetState   (Widget(),  65)   ; set 1st scrollbar (ID = 0) to 50 of 100
    widget::Text(300+10,140+200+100, 250,  20, "ProgressBar Vertical  (start=100, page=50/300)",#PB_Text_Right)
    ...
    Button_1 = widget::Text(0, 0, 0, 0, text, #PB_Text_Border) ; No need to specify size or coordinates
