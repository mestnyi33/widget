      ...
      If _from_point_(mouse_x, mouse_y, *this, [4])
        If *value\event\enter <> *this 
          If Not *this\color\state
            enter = Events(*this, #PB_EventType_MouseEnter, mouse_x, mouse_y)
          EndIf
          *value\event\enter = *this
        EndIf
      ElseIf *this\color\state
        leave = Events(*this, #PB_EventType_MouseLeave, mouse_x, mouse_y)
      EndIf
          ...
          If _from_point_(mouse_x, mouse_y, \childrens(), [4])
            If *value\event\enter <> \childrens()
              If Not \childrens()\color\state
                enter = Events(\childrens(), #PB_EventType_MouseEnter, mouse_x, mouse_y)
              EndIf
              *value\event\enter = \childrens()
            EndIf
          ElseIf \childrens()\color\state
            leave = Events(\childrens(), #PB_EventType_MouseLeave, mouse_x, mouse_y)
          EndIf
