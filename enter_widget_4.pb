...
;                Debug "  "+Bool(*value\event\enter And *value\event\enter\index < \childrens()\index And \childrens()\parent = *value\event\enter\parent)
;                
;                If (*value\event\enter And Not *value\event\enter\State And 
;                       *value\event\enter\index > \childrens()\index And \childrens()\parent = *value\event\enter\parent)
...
; ;     SetData(Container(0, 20, 180, 30, #PB_Flag_NoGadget), 100) 
; ;     SetData(Container(0, 35, 180, 30, #PB_Flag_NoGadget), 100) 
; ;     SetData(Container(0, 50, 180, 30, #PB_Flag_NoGadget), 100) 
; ;     SetData(Container(20, 70, 180, 180), 20)
; ;     ;  SetData(Container(20, 20, 180, 50), 200)
; ;     
    ...
    SetData(Container(20, 70, 180, 180, #PB_Flag_NoGadget), 7)
    
    CloseList()
    CloseList()
    SetData(Container(10, 70, 70, 180, #PB_Flag_NoGadget), 8)
