...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If OpenWindow(0, 0, 0, 908, (height+5)*5+20+110, "Buttons on the canvas", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    *S_1 = (Gadget(1, 8,  (height+5)*1+10, 140, height, text_h,          #__text_multiline|#__text_left|center))
    *S_2 = (Gadget(2, 8,  (height+5)*2+10, 140, height, text_h,          #__text_multiline|#__text_left|#__text_bottom))
    
    *S_3 = (Gadget(3, 8+150,  10, 140, height, text_h,                  #__text_multiline|#__text_top|center))
    *S_4 = (Gadget(4, 8+150,  (height+5)*1+10, 140, height, text_h,     #__text_multiline|center))
    *S_5 = (Gadget(5, 8+150,  (height+5)*2+10, 140, height, text_h,     #__text_multiline|#__text_bottom|center))
    
    *S_6 = (Gadget(6, 8+300,  10, 140, height, text_h,                  #__text_multiline|#__text_right|#__text_top))
    *S_7 = (Gadget(7, 8+300,  (height+5)*1+10, 140, height, text_h,     #__text_multiline|#__text_right|center))
    ...
    *S_11 = (Gadget(11, 8+450,  (height+5)*1+10, 140, height, text_h,      #__text_multiline|#__text_invert|#__text_left|center))
    *S_12 = (Gadget(12, 8+450,  (height+5)*2+10, 140, height, text_h,      #__text_multiline|#__text_invert|#__text_left|#__text_bottom))
    
    *S_13 = (Gadget(13, 8+150+450,  10, 140, height, text_h,              #__text_multiline|#__text_invert|#__text_top|center))
    *S_14 = (Gadget(14, 8+150+450,  (height+5)*1+10, 140, height, text_h, #__text_multiline|#__text_invert|center))
    *S_15 = (Gadget(15, 8+150+450,  (height+5)*2+10, 140, height, text_h, #__text_multiline|#__text_invert|#__text_bottom|center))
    
    *S_16 = (Gadget(16, 8+300+450,  10, 140, height, text_h,              #__text_multiline|#__text_invert|#__text_right|#__text_top))
    *S_17 = (Gadget(17, 8+300+450,  (height+5)*1+10, 140, height, text_h, #__text_multiline|#__text_invert|#__text_right|center))
    ...
    *S_21 = (Gadget(21, 8,  (height+5)*4+10, 140, height, text_h,          #__text_multiline|#__flag_vertical|#__text_left|center))
    *S_22 = (Gadget(22, 8,  (height+5)*5+10, 140, height, text_h,          #__text_multiline|#__flag_vertical|#__text_left|#__text_bottom))
    
    *S_23 = (Gadget(23, 8+150,  (height+5)*3+10, 140, height, text_h,     #__text_multiline|#__flag_vertical|#__text_top|center))
    *S_24 = (Gadget(24, 8+150,  (height+5)*4+10, 140, height, text_h,     #__text_multiline|#__flag_vertical|center))
    *S_25 = (Gadget(25, 8+150,  (height+5)*5+10, 140, height, text_h,     #__text_multiline|#__flag_vertical|#__text_bottom|center))
    
    *S_26 = (Gadget(26, 8+300,  (height+5)*3+10, 140, height, text_h,     #__text_multiline|#__flag_vertical|#__text_right|#__text_top))
    *S_27 = (Gadget(27, 8+300,  (height+5)*4+10, 140, height, text_h,     #__text_multiline|#__flag_vertical|#__text_right|center))
    ...
    *S_31 = (Gadget(31, 8+450,  (height+5)*4+10, 140, height, text_h,      #__text_multiline|#__flag_vertical|#__text_invert|#__text_left|center))
    ...
    *S_33 = (Gadget(33, 8+150+450,  (height+5)*3+10, 140, height, text_h, #__text_multiline|#__flag_vertical|#__text_invert|#__text_top|center))
    *S_34 = (Gadget(34, 8+150+450,  (height+5)*4+10, 140, height, text_h, #__text_multiline|#__flag_vertical|#__text_invert|center))
    *S_35 = (Gadget(35, 8+150+450,  (height+5)*5+10, 140, height, text_h, #__text_multiline|#__flag_vertical|#__text_invert|#__text_bottom|center))
    ...
    *S_37 = (Gadget(37, 8+300+450,  (height+5)*4+10, 140, height, text_h, #__text_multiline|#__flag_vertical|#__text_invert|#__text_right|center))
