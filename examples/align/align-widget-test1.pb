...
;          EndIf
   ...
   *root = Open( 5, 70, 70, 200, 200, #PB_Compiler_Procedure+"(auto-alignment)", #PB_Window_SizeGadget)
   window = GetCanvasWindow(*root)
   
   wlist(Hex(1)) = Button(0, 0, 20, 20, "1")  
   wlist(Hex(2)) = Button(0, 0, 20, 20, "2")   
   wlist(Hex(3)) = Button(0, 0, 20, 20, "3")    
   wlist(Hex(4)) = Button(0, 0, 20, 20, "4")   
   wlist(Hex(5)) = Button(0, 0, 20, 20, "5")   
   wlist(Hex(6)) = Button(0, 0, 20, 20, "6")   
   wlist(Hex(7)) = Button(0, 0, 20, 20, "7")   
   wlist(Hex(8)) = Button(0, 0, 20, 20, "8")   
   wlist(Hex(9)) = Button(0, 0, 20, 20, "9")   
   
   
   SetAlign_(wlist(Hex(1)), #__align_auto, 0,-10,-10,0 )              
   ;SetAlign_(wlist(Hex(2)), #__align_auto, 0,-10,-10,0 )              
   SetAlign_(wlist(Hex(2)), #__align_auto, 0,1,1,0 )              
   SetAlign_(wlist(Hex(3)), #__align_auto, 0,1,1,0 )              
   SetAlign_(wlist(Hex(4)), #__align_auto, 0,1,1,0 )              
   SetAlign_(wlist(Hex(5)), #__align_auto, 0,1,1,0 )              
   SetAlign_(wlist(Hex(6)), #__align_auto, 0,1,1,0 )              
   SetAlign_(wlist(Hex(7)), #__align_auto, 0,1,1,0 )              
   SetAlign_(wlist(Hex(8)), #__align_auto, 0,1,1,0 )              
   SetAlign_(wlist(Hex(9)), #__align_auto, 0,1,1,0 )              
   
;    SetAlign_(wlist(Hex(1)), #__align_auto, 1,0,0,1 )              
;    SetAlign_(wlist(Hex(2)), #__align_auto, 1,0,0-,1 )              
;    SetAlign_(wlist(Hex(3)), #__align_auto, 1,0,0,1 )              
;    SetAlign_(wlist(Hex(4)), #__align_auto, 1,0,0,1 )              
;    SetAlign_(wlist(Hex(5)), #__align_auto, 1,0,0,1 )              
;    SetAlign_(wlist(Hex(6)), #__align_auto, 1,0,0,1 )              
;    SetAlign_(wlist(Hex(7)), #__align_auto, 1,0,0,1 )              
;    SetAlign_(wlist(Hex(8)), #__align_auto, 1,0,0,1 )              
;    SetAlign_(wlist(Hex(9)), #__align_auto, 1,0,0,1 )              
