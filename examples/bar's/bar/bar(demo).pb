...
CompilerIf #PB_Compiler_IsMainFile
   ...
   If OpenRoot(0, 0, 0, 605+30, 140+200+140+140, "ScrollBarGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
      ...
      *w = widget::TrackBarWidget(300+270, 140+10, 25, 170, 0, 10000, #PB_TrackBar_Vertical)
      widget::SetWidgetState(*w, 8000)
      *w = widget::TrackBarWidget(300+270+30, 140+10, 25, 170, 0, 10000, #__bar_vertical|#__bar_invert)
      widget::SetWidgetState(*w, 8000)
      ...
      *w = widget::Progress  (300+270+30, 140+200,  25, 120 ,0, 300, #__bar_vertical|#__bar_invert)
      ...
      Define *Tab = widget::TabBarWidget(0,0,0,0, 0, #__flag_autosize|#__bar_vertical); No need to specify size or coordinates
      ...
      Button_5 = widget::TabBarWidget(0, 0, 0, 0, 0)                        ; No need to specify size or coordinates
      ...
      If Button_2 And widget::OpenWidgetList(Button_2)
         Button_4 = widget::ScrollAreaWidget(-1, -1, 50, 50, 100, 100, 1);, #__flag_noGadget)
                                                                   ;       Define i
                                                                   ;       For i=0 To 1000
