Macro _draw_progress_(_reverse_, _vertical_, _pos_, _x_, _y_, _width_ ,_height_, _round_, _fore_color1_, _fore_color2_, _back_color1_, _back_color2_, _frame_color_, _gradient_, _frame_size_=1)
    ...
    Else
      If (_pos_) > _round_
        ...
        If _round_ > (_width_ - (_pos_))
          Box(_x_ + _round_, _y_ + _frame_size_, ((_pos_) - _round_) + (_width_ - _round_ - (_pos_)), _height_ - _frame_size_*2)
        Else
      ...
      Else
        For a = _frame_size_ To (_pos_) + _frame_size_ - 1
          For i = _frame_size_ To (_height_ - _frame_size_*2)
            If Point(_x_ + a, _y_ + i) & $FFFFFF = _frame_color_ & $FFFFFF
              Line(_x_ + a, _y_ + i, 1, _height_ - i*2)
              Break
    ...
    If _vertical_
      If (_pos_) > _round_
        ...
        If _round_ > (_height_ - (_pos_))
          Box(_x_ + _frame_size_, _y_ + _round_, _width_ - _frame_size_*2, ((_pos_) - _round_) + (_height_ - _round_ - (_pos_)))
        Else
          Box(_x_ + _frame_size_, _y_ + _round_, _width_ - _frame_size_*2, ((_pos_) - _round_))
        EndIf
...
If CreateImage(0, 300, 310) And StartDrawing(ImageOutput(0))
  ...
  DrawingMode(#PB_2DDrawing_Default|#PB_2DDrawing_AlphaBlend)
  _draw_progress_(_reverse_, _vertical_, _pos_, _x_, _y_, _width_ ,_height_, _round_, _fore_color1_, _fore_color2_, _back_color1_, _back_color2_, _frame_color_, _gradient_)
