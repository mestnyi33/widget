...
;     ResizeWidget(s_1, #PB_Ignore, #PB_Ignore, width - 250, #PB_Ignore)
  ...
  s_0 = widget::SplitterWidget(0, 0, 0, 0, b_0, b_1, #PB_Splitter_Separator | #PB_Splitter_Vertical | #PB_Splitter_FirstFixed)
  
  b_2 = widget::ButtonWidget(0, 0, 0, 0, "BTN3")
  b_3 = widget::ButtonWidget(0, 0, 0, 0, "BTN4")
  s_1 = widget::SplitterWidget(0, 0, 0, 0, b_2, b_3, #PB_Splitter_Separator | #PB_Splitter_Vertical | #PB_Splitter_SecondFixed)
  ;
  ...
  b_0 = widget::ButtonWidget(0, 0, 0, 0, "BTN1")
  b_1 = widget::ButtonWidget(0, 0, 0, 0, "BTN2")
  s_3 = widget::SplitterWidget(0, 0, 0, 0, b_0, b_1, #PB_Splitter_Separator | #PB_Splitter_Vertical | #PB_Splitter_FirstFixed)
  
  b_2 = widget::ButtonWidget(0, 0, 0, 0, "BTN3")
  b_3 = widget::ButtonWidget(0, 0, 0, 0, "BTN4")
  s_4 = widget::SplitterWidget(0, 0, 0, 0, b_2, b_3, #PB_Splitter_Separator | #PB_Splitter_Vertical | #PB_Splitter_SecondFixed)
  ;
