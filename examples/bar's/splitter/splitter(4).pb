...
CompilerIf #PB_Compiler_IsMainFile
   ...
   If OpenRoot(0, 0, 0, 850, 280, "SplitterGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
      ...
      ;
      Splitter_0 = SplitterWidget(430, 10, w, 210, Button_0, Button_1, #PB_Splitter_Vertical|#PB_Splitter_FirstFixed)
      ;
      Button_2 = TextWidget(0,0,0,0, "")
      Splitter_1 = SplitterWidget(430, 10, 410, 210, Splitter_0, Button_2, #PB_Splitter_Vertical)
      ;
