...
CompilerIf Not Defined(Splitter, #PB_Module)
   DeclareModule Splitter
      ...
      Declare Gadget(Gadget.i, X.i, Y.i, Width.i, Height.i, First.i, Second.i, Flag.q=0)
...
CompilerIf #PB_Compiler_IsMainFile
   ...
   If OpenWindow(0, 0, 0, 850, 280, "SplitterGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
      ...
      Splitter_0 = SplitterGadget(#PB_Any, 10, 10, 410, 210, Button_0, Button_1, #PB_Splitter_Vertical|#PB_Splitter_FirstFixed|#PB_Splitter_Separator)
      Splitter_1 = SplitterGadget(#PB_Any, 0, 0, 0, 0, Button_3, Button_4, #PB_Splitter_Vertical|#PB_Splitter_SecondFixed|#PB_Splitter_Separator)
      ...
      Splitter_4 = Splitter::Gadget(#PB_Any, 10, 10, 410, 210, Splitter_0, Splitter_3, #PB_Splitter_Vertical)
...
CompilerIf #PB_Compiler_IsMainFile = 99 
   ...
   s_tbar = TextGadget(#PB_Any, 0,0,0,0,"", #__flag_text_Border)
   s_desi = TextGadget(#PB_Any, 0,0,0,0,"", #__flag_text_Border)
   s_view = TextGadget(#PB_Any, 0,0,0,0,"", #__flag_text_Border)
   s_list = TextGadget(#PB_Any, 0,0,0,0,"", #__flag_text_Border)
   s_insp = TextGadget(#PB_Any, 0,0,0,0,"", #__flag_text_Border)
   s_help  = TextGadget(#PB_Any, 0,0,0,0,"", #__flag_text_Border)
