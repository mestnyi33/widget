...
;       Button_5 = 0
      ...
      SetWidgetText(Splitter_0, "0")
      SetWidgetText(Splitter_1, "1")
      SetWidgetText(Splitter_2, "2")
      SetWidgetText(Splitter_3, "3")
      SetWidgetText(Splitter_4, "4")
