...
CompilerIf #PB_Compiler_IsMainFile
  ...
  SetGadGetWidgetAttribute( 3, #PB_Splitter_FirstMinimumSize, 50 )
  SetGadGetWidgetAttribute( 9, #PB_Splitter_SecondMinimumSize, 50 )
  SetGadGetWidgetState(3, 30)
  SetGadGetWidgetState(6, 30)
  SetGadGetWidgetState(9, 250-30)
  
  widget::SetWidgetAttribute( w_3, #PB_Splitter_FirstMinimumSize, 50 )
  widget::SetWidgetAttribute( w_9, #PB_Splitter_SecondMinimumSize, 50 )
  widget::SetWidgetState(w_3, 30)
  widget::SetWidgetState(w_6, 30)
  widget::SetWidgetState(w_9, 250-30)
