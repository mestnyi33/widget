...
SetGadgetTextWidget(toolbar_design, "size: ("+Str(GadgetWidth(toolbar_design))+"x"+Str(GadgetHeight(toolbar_design))+") - " + Str(IDWidget( GetParent( toolbar_design ))) )
SetGadgetTextWidget(mdi_design, "size: ("+Str(GadgetWidth(mdi_design))+"x"+Str(GadgetHeight(mdi_design))+") - " + Str(IDWidget( GetParent( mdi_design ))))
SetGadgetTextWidget(listview_debug, "size: ("+Str(GadgetWidth(listview_debug))+"x"+Str(GadgetHeight(listview_debug))+") - " + Str(IDWidget( GetParent( listview_debug ))))
SetGadgetTextWidget(tree_inspector, "size: ("+Str(GadgetWidth(tree_inspector))+"x"+Str(GadgetHeight(tree_inspector))+") - " + Str(IDWidget( GetParent( tree_inspector ))))
SetGadgetTextWidget(panel_inspector, "size: ("+Str(GadgetWidth(panel_inspector))+"x"+Str(GadgetHeight(panel_inspector))+") - " + Str(IDWidget( GetParent( panel_inspector ))))
SetGadgetTextWidget(text_help, "size: ("+Str(GadgetWidth(text_help))+"x"+Str(GadgetHeight(text_help))+") - " + Str(IDWidget( GetParent( text_help ))))
