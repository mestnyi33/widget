...
CompilerIf #PB_Compiler_IsMainFile
  ...
  Procedure events_widgets()
    ...
    Select WidgetEvent( )
      Case #PB_EventType_Change
        SetGadGetWidgetState((EventWidget( )\index - 1), GetWidgetState(EventWidget( )))
        Debug  Str(EventWidget( )\index - 1)+" - widget change " + GetWidgetState(EventWidget( ))
    EndSelect
  EndProcedure
  ...
  Global *w, Button_0, Button_1, Button_2, Button_3, Button_4, Button_5, Splitter_0, Splitter_1, Splitter_2, Splitter_3, Splitter_4
    ...
    widget::SetWidgetState(Button_0, 5)
    
    Button_1 = widget::TabBarWidget(0, 0, 0, 0, #__bar_vertical)                  ; No need to specify size or coordinates
    ...
    widget::SetWidgetState(Button_1, 3)
    ...
    widget::SetWidgetState(Button_5, 1)
    ...
    Splitter_3 = widget::SplitterWidget(0, 0, 0, 0, Button_1, Button_5);, #PB_Splitter_Separator)
    Splitter_4 = widget::SplitterWidget(10, 10, 400, 300, Button_0, Splitter_3, #PB_Splitter_Vertical);|#PB_Splitter_Separator)
    ...
    Define *panel_1 = PanelWidget(8, 8+350, 306, 203, #__bar_vertical)
    AddItem (*panel_1, -1, "Panel 1")
    Define *panel_2 = PanelWidget(5, 5, 290, 166-30)
    AddItem(*panel_2, -1, "Sub 1")
    AddItem(*panel_2, -1, "Sub 2")
    AddItem(*panel_2, -1, "Sub 3")
    AddItem(*panel_2, -1, "Sub 4")
    SetWidgetState(*panel_2, 2)
    CloseWidgetList()
    
    ButtonWidget(10, 145, 80, 24,"remove")
    ButtonWidget(95, 145, 80, 24,"add")
    ButtonWidget(95+85, 145, 80, 24,"clear")
    
    AddItem (*panel_1, -1,"Panel 2")
    ButtonWidget(10, 15, 80, 24,"Button 3")
    ButtonWidget(95, 15, 80, 24,"Button 4")
    ...
    SetWidgetItemFont(*panel_1, 1, 6)
    SetWidgetItemFont(*panel_2, 1, 6)
