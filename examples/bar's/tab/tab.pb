...
CompilerIf #PB_Compiler_IsMainFile
   ...
   If OpenRoot(0, 10, 10, 850, 210, "SPLITTER", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
      ;
      ...
      Next
      ;
      SetWidgetState(tab_1, -1)
      SetWidgetState(tab_2, 9)
      SetWidgetState(tab_3, 6)
      SetWidgetState(tab_4, 1)
