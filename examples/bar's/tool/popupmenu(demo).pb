...
CompilerIf #PB_Compiler_IsMainFile
   ...
   Macro row_x_( _this_, _address_ )
      ...
      Procedure.b update_tab_items_( *this._s_WIDGET, List *items._s_TABS( ) )
         With *this
            Protected Color
 ...
 *this\scroll_height( ) = 0
                  ...
                  ForEach *this\__tabs( )
                     ...
                     If *bar\vertical
                        ...
                        *this\__tabs( )\y = *this\scroll_height( )
                        If *this\scroll_width( ) < ( *this\__tabs( )\x + *this\__tabs( )\text\x + *this\__tabs( )\text\width + *this\mode\fullSelection + *this\text\padding\x * 2 ) ; - *this\inner_x( )
                           *this\scroll_width( ) = ( *this\__tabs( )\x + *this\__tabs( )\text\x + *this\__tabs( )\text\width + *this\mode\fullSelection + *this\text\padding\x * 2 ) ; - *this\inner_x( )
                        EndIf
                     Else
         ...
         If *this
            ...
            Else
               ...
               If *this\root = *display\root
                  ...
                  Else
                     update_tab_items_( *this, *this\__tabs( ) )
                  EndIf
