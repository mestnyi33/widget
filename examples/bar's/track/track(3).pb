...
;     Resize(s_1, #PB_Ignore, #PB_Ignore, width - 250, #PB_Ignore)
  ...
  ; first splitter
  TrackBarGadget(3, 0, 0, 0, 0, 0, 250, 0)
  
  TrackBarGadget(6, 0, 0, 0, 0, 0, 250, 0)
  SplitterGadget(7, 125, 10, 250, 70, 3, 6, #PB_Splitter_Separator )
  
  ; first splitter
  TrackBarGadget(31, 0, 0, 0, 0, 0, 250, 0)
  
  TrackBarGadget(61, 0, 0, 0, 0, 0, 250, 0)
  ...
  ; first splitter
  s_0 = widget::Track(0, 0, 0, 0, 0,250,0)
  s_1 = widget::Track(0, 0, 0, 0, 0,250,0)
  s_2 = widget::Splitter(125, 170, 250, 70, s_0, s_1, #PB_Splitter_Separator)
  
  ; first splitter
  s_3 = widget::Track(0, 0, 0, 0, 0,250,0)
  
  s_4 = widget::Track(0, 0, 0, 0, 0,250,0)
