Macro _draw_v_progress_(_pos_, _len_, _x_, _y_, _width_ ,_height_, _round_, _fore_color1_,_fore_color2_, _back_color1_, _back_color2_, _frame_color_, _frame_size_, _gradient_=1)
    ...
    Else 
      If _pos_ > _round_
        ...
        If _round_ > (_height_ - (_pos_))
          Box(_x_ + _frame_size_, _y_ + _frame_size_ + _round_, _width_ - _frame_size_*2, ((_pos_) - _frame_size_ - _round_) + (_height_ - _round_ - (_pos_)))
        Else
          Box(_x_ + _frame_size_, _y_ + _frame_size_ + _round_, _width_ - _frame_size_*2, ((_pos_) - _frame_size_ - _round_))
        EndIf
        ...
        If _round_ > (_height_ - (_pos_))
          For a = (_height_ - _round_) To (_pos_)
            For i = 0 To (_width_)
              If Point(_x_ + i, _y_ + a) & $FFFFFF = _frame_color_ & $FFFFFF
                Line(_x_ + i, _y_ + a, (_width_) - i*2, 1)
                Break
  ...
  If Not _round_
    Box(_x_ + _frame_size_, _y_ + _frame_size_ + _pos_, _width_ - _frame_size_*2, (_height_ - (_pos_)) - _frame_size_*2)
  Else 
    If (_height_ - (_pos_)) > _round_
      ...
      For a = (_height_ - _round_) To (_height_)
        For i = 0 To (_width_)
          If Point(_x_ + i, _y_ + a) & $FFFFFF = _frame_color_ & $FFFFFF
            Line(_x_ + i, _y_ + a, (_width_) - i*2, 1)
            Break
      ...
      ; если позиция ползунка больше начало второго округленыя
      If _round_ > (_pos_)
        For a = 0 To _round_ + _frame_size_ - 1
          For i = 0 To (_width_)
            If Point(_x_ + i, _y_ + a) & $FFFFFF = _frame_color_ & $FFFFFF
              Line(_x_ + i, _y_ + a, (_width_) - i*2, 1)
              Break
...
Macro _draw_h_progress_(_pos_, _len_, _x_, _y_, _width_ ,_height_, _round_, _fore_color1_,_fore_color2_, _back_color1_, _back_color2_, _frame_color_, _frame_size_, _gradient_=1)
  FrontColor(_frame_color_)
  DrawingMode(#PB_2DDrawing_Outlined)
  RoundBox(_x_ + _frame_size_, _y_ + _frame_size_, _width_ - _frame_size_*2, _height_ - _frame_size_*2, _round_,_round_)
  ...
  If Not _round_
    Box(_x_ + _pos_ + _frame_size_, _y_ + _frame_size_, (_width_ - (_pos_)) - _frame_size_*2, _height_ - _frame_size_*2)
  Else 
    If (_width_ - (_pos_)) > _round_
      ...
      For a = (_width_ - _round_) To (_width_)
        For i = 0 To (_height_)
          If Point(_x_ + a, _y_ + i) & $FFFFFF = _frame_color_ & $FFFFFF
            Line(_x_ + a, _y_ + i, 1, (_height_) - i*2)
            Break
      ...
      If _round_ > (_pos_)
        For a = 0 To _round_ + _frame_size_ - 1
          For i = 0 To (_height_) -_frame_size_*2
            If Point(_x_ + a, _y_ + i+_frame_size_) & $FFFFFF = _frame_color_ & $FFFFFF
              Line(_x_ + a, _y_ + i+_frame_size_, 1, (_height_) - i*2 -_frame_size_*2)
              Break
            EndIf
          Next i
        Next a
...
Macro _draw_progress_(_reverse_, _vertical_, _pos_, _x_, _y_, _width_ ,_height_, _round_, _fore_color1_, _fore_color2_, _back_color1_, _back_color2_, _frame_color_)
  ...
  If _vertical_
    If _reverse_
      ...
      ;_draw_v_progress_(_pos_, _width_, _x_, _y_, _width_ ,_height_, _round_, _fore_color1_, _fore_color2_, _back_color1_, _back_color2_, _frame_color_, 0, _gradient_)
      _draw_v_progress_(_pos_, _width_, _x_, _y_, _width_ ,_height_, _round_, _fore_color2_, _fore_color1_, _back_color2_, _back_color1_, _frame_color_, _frame_size_, _gradient_)
    Else
  ...
  Else
    ...
    If _reverse_
      ...
      ;_draw_h_progress_(_pos_, _height_, _x_, _y_, _width_ ,_height_, _round_, _fore_color1_, _fore_color2_, _back_color1_, _back_color2_, _frame_color_, 0, _gradient_)
      _draw_h_progress_(_pos_, _height_, _x_, _y_, _width_ ,_height_, _round_, _fore_color1_, _fore_color2_, _back_color1_, _back_color2_, _frame_color_, _frame_size_, _gradient_)
    Else
      ; _draw_h_progress_(_pos_, _height_, _x_, _y_, _width_ ,_height_, _round_, _fore_color1_, _fore_color2_, _back_color1_, _back_color2_, _frame_color_, 0, _gradient_)
      _draw_h_progress_(_pos_, _height_, _x_, _y_, _width_ ,_height_, _round_, _fore_color1_, _fore_color2_, _back_color1_, _back_color2_, _frame_color_, _frame_size_, _gradient_)
