Macro _round_v_box_(_pos_, _x_, _y_, _width_ ,_height_, _round_, _back_color1_, _back_color2_, _frame_color1_, _frame_color2_, _reverse_)
  ;https://www.purebasic.fr/english/viewtopic.php?f=13&t=75757&p=557936#p557936 ; thank you infratec
  If _reverse_
    _pos_ = _height_ - _pos_
    RoundBox(_x_, _y_, _width_ ,_height_, _round_,_round_, _frame_color1_)
    ...
    RoundBox(_x_+1, _y_+1, _width_-2,_height_-2, _round_,_round_, _back_color1_)
  ...
  Else
    ...
    RoundBox(_x_, _y_, _width_ ,_height_, _round_,_round_, _frame_color2_)
    ...
    RoundBox(_x_+1, _y_+1, _width_-2,_height_-2, _round_,_round_, _back_color2_)
...
Macro _round_h_box_(_pos_, _x_, _y_, _width_ ,_height_, _round_, _back_color1_, _back_color2_, _frame_color1_, _frame_color2_, _reverse_)
  ;https://www.purebasic.fr/english/viewtopic.php?f=13&t=75757&p=557936#p557936 ; thank you infratec
  If _reverse_
    _pos_ = _width_ - _pos_
    RoundBox(_x_, _y_, _width_ ,_height_, _round_,_round_, _frame_color1_)
...
If CreateImage(0, 300, 310) And StartDrawing(ImageOutput(0))
  ...
  _round_h_box_(_pos_, _x_, _y_, _width_ ,_height_, _round_, _back_color1_, _back_color2_, _frame_color1_, _frame_color2_, _reverse_)
...
If CreateImage(10, 310, 300) And StartDrawing(ImageOutput(10))
  ...
  DrawingMode(#PB_2DDrawing_Default|#PB_2DDrawing_AlphaBlend)
  _round_v_box_(_pos_, _x_, _y_, _width_ ,_height_, _round_, _back_color1_, _back_color2_, _frame_color1_, _frame_color2_, _reverse_)
