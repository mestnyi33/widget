...
Macro _draw_h_progress_2(_pos_, _len_, _x_, _y_, _width_ ,_height_, _round_, _color1_, _color2_)
  ...
  If (_pos_)
   FrontColor(_color1_)
    ...
    For y = _y_ + _frame_size_ To _y_ + _height_ - _frame_size_
      For x = _x_ + _frame_size_ To (_x_ + (_pos_))
        color = Point(x, y)
    ...
    FillArea(_x_ + (_pos_)/2, _y_ + _height_/2,  -1, _color2_) 
  EndIf
...
; ;       _draw_h_progress_(_pos_, _height_, _x_+1, _y_+1, _width_-2 ,_height_-2, _round_, _back_color1_, _back_color2_)
    ...
    Else
      ...
      ;ResetGradientColors()
      _draw_h_progress_(_pos_, _y_ + _height_, _x_, _y_, _width_ ,_height_, _round_, _back_color1_, _back_color2_, 1)
