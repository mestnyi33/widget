...
CompilerIf #PB_Compiler_IsMainFile
   ...
   Macro TestGadget( gadget, X,Y,Width,Height, txt, Flag=0)
      TextGadget( gadget, X,Y,Width,Height, txt, Flag)
      ; StringGadget( gadget, X,Y,Width,Height, txt, Flag)
      ; EditorGadget( gadget, X,Y,Width,Height, Flag) : SetGadgetText( gadget, txt)
      SetGadgetColor(gadget, #PB_Gadget_BackColor, #Yellow)
   EndMacro
