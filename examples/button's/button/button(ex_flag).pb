...
;     gadget = ButtonGadget(#PB_Any, 100, 100, 250, 200, text, #PB_Button_MultiLine) : HideGadget(gadget,1)
    *this = widget::Button(100, 100, 250, 250, get_text(), #__button_multiline);|#__flag_anchorsgadget);|#__text_vertical) 
    ...
    f_0 = widget::Button(width+20, y+30*4, 150, 26, "default", #__button_toggle) 
    f_1 = widget::Button(width+20, y+30*5, 150, 26, "multiline", #__button_toggle) 
    f_4 = widget::Button(width+20, y+30*6, 150, 26, "toggle", #__button_toggle) 
    
    f_8 = widget::Button(width+20, y+30*7, 150, 26, "vertical", #__button_toggle) 
