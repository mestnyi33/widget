...
CompilerIf #PB_Compiler_IsMainFile
   ...
   If Open( 0, 0, 0, 300, 300, "Buttons on the canvas", #PB_Window_SystemMenu | #PB_Window_ScreenCentered )
      ...
      *g1 = Test( 10+size, 10, 100, size, "top button" )
      *g2 = Test( 10, 10+size, size, 100, "left button", #__flag_Vertical)
      *g3 = Test( 100+10+size, 10+size, size, 100, "right button", #__flag_Vertical|#__flag_Invert)
      *g4 = Test( 10+size, 100+10+size, 100, size, "bottom button", #__flag_Invert)
