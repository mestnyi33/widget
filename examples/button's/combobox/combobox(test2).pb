...
; ;     Widgets(Hex(#PB_GadgetType_CheckBox)) = CheckBoxWidget(5, 305, 160,95, "CheckBox_"+Hex(#PB_GadgetType_CheckBox)+" text clip clip clip clip text", #PB_CheckBox_ThreeState) : SetState(Widgets(Hex(#PB_GadgetType_CheckBox)), #PB_Checkbox_Inbetween)
...
;     Widgets(Hex(302)) = SpinWidget(0, 0, 100,20,0,1000000000000000000) : SetState(Widgets(Hex(302)), 100000000000 )               
