...
CompilerIf #PB_Compiler_IsMainFile
   ...
   Procedure ComboButton( X,Y,Width,Height, Text.s, flags)
      ...
      *g = ComboBox( X,Y,Width,Height, flags|#__flag_Center|#__flag_vertical)
      AddItem( *g, -1, Text,1 )
      SetState( *g, 0 )
;       *g = Progress(X,Y,Width,Height, 0,100, flags|#__flag_TextCenter|#__flag_vertical)
;       SetState( *g, 50)
   EndProcedure
   ...
   If Open(0, 0, 0, Width+20, 760, "test alignment Image", #PB_Window_SizeGadget | #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
      ...
      ComboButton(10, 610, Width, 140, "default"                         , #__flag_BorderFlat);|#__flag_TextCenter)
