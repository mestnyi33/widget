...
CompilerIf #PB_Compiler_IsMainFile
  ...
  Procedure ResizeCallBack()
    ...
    ;\\
    ForEach widget( )
      ResizeWidget(widget( ), #PB_Ignore, #PB_Ignore, Width-90, #PB_Ignore )
    Next
  ...
  If OpenRootWidget(11, 0, 0, 150, 235, "ImageButton", #PB_Window_SystemMenu | #PB_Window_ScreenCentered | #PB_Window_SizeGadget)
    ...
    ButtonWidget( 10,40,60,25,"text_left",#PB_Text_InLine|#PB_Text_Right,10)
    ButtonWidget( 10,70,60,75,"text_top",#PB_Text_Bottom, 0);,32,32)
    ButtonWidget( 10,150,60,75,"text_bottom",#Null,11)
