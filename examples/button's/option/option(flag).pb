...
;         EndSelect
  ...
  If Open(OpenWindow(#PB_Any, 0, 0, width + 180, height + 20, "change button flags", #PB_Window_SystemMenu | #PB_Window_ScreenCentered))
    ...
    *this  = widget::Option(100, 100, 250, 200, text, #__text_MultiLine);|#__flag_anchorsgadget)
...
;     ; flag
;     tree = widget::Tree(width + 20, y + bh * 11 + 10, 150, height - (y + bh * 11), #__Tree_NoLines | #__Tree_NoButtons | #__tree_OptionBoxes | #__tree_Optiones | #__Tree_threestate)
