...
CompilerIf #PB_Compiler_IsMainFile
  ...
  *scroll1 = ScrollArea(10, 10, 480,200, 2000, 2000, 1, #PB_ScrollArea_Flat|#PB_ScrollArea_Center) : *scroll1\class = "area_1"
  Button(0,0,imgw,imgh, "", 0,0)
  Button(imgw,imgh,2000-imgw*2,2000-imgh*2, "")
  Button(2000-imgw,2000-imgh,imgw,imgh, "", 0,0)
  CloseList()
  
  *scroll2 = ScrollArea(10, 220, 480,200, 2000, 2000, 1, #PB_ScrollArea_Flat|#PB_ScrollArea_Center) : *scroll2\class = "area_2"
  Button(0,0,imgw,imgh, "", 0,0)
  Button(imgw,imgh,2000-imgw*2,2000-imgh*2, "")
  Button(2000-imgw,2000-imgh,imgw,imgh, "", 0,0)
  CloseList()
