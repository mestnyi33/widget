...
CompilerIf #PB_Compiler_IsMainFile
   ...
   If Open(0, 50, 50, width, height, "Root_0_Window", #PB_Window_SystemMenu | #PB_Window_MinimizeGadget | #PB_Window_MaximizeGadget)
      ...
      ;\\
      Define *w = root() ; Window(10, 10, 250, 200, "window_0_root_0", #PB_Window_SystemMenu ) : SetClass(widget( ), "window_0_root_0" )
       Window(10, 10, 200, 150, "window_1_root_0", #PB_Window_SystemMenu|#__flag_child, *w) : SetClass(widget( ), "window_1_root_0" )
       widget( )\child =- 1
       Window(100, 10, 150, 100, "window_2_root_0", #PB_Window_SystemMenu|#__flag_child, *w) : SetClass(widget( ), "window_2_root_0" )
