...
Global *Object1,*Object2,*Object3,*Object4,*Object5
  ...
  If Text
    SetText(widget(), Text)
  EndIf
  SetColor(widget(), #PB_Gadget_BackColor, Color)
  SetColor(widget(), #__FrameColor, Color&$FFFFFF | 255<<24)
  SetColor(widget(), #PB_Gadget_FrontColor, Color&$FFFFFF | 255<<24)
  widget()\round = 20
...
If Open(0, 0, 0, 782, 452, "Example 3: Object boundaries to position and size", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
  ...
  *Object5 = _a_object(300, 250, 200, 100, "Limit in height", 3, RGBA(64, 128, 192, alpha))
  ...
  SetMoveBounds(*Object1, 0, 0, 782, 452)
  SetMoveBounds(*Object2, 250, #PB_Ignore, 550, #PB_Ignore)
  SetMoveBounds(*Object3, #PB_Ignore, 50, #PB_Ignore, 200)
