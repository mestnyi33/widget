...
Module AnchorBox
   ...
   Procedure Create(X,Y,Width,Height)
      ...
      Button = widget::Button(X,Y,Width, Height, "LEFT&TOP",constants::#__flag_ButtonToggle);,radius)
      ...
      DBUTTON = widget::Button(size, size, size*2, size*2, "",constants::#__flag_ButtonToggle,radius)
