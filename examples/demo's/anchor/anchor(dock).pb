...
;     SetClass(*ce, "ce_anchor")
    ...
    SetAlignment(*t, #__align_Center|#__align_top)
    SetAlignment(*b, #__align_Center|#__align_bottom)
    SetAlignment(*l, #__align_Center|#__align_left)
    SetAlignment(*r, #__align_Center|#__align_right)
    
    
    SetAlignment(*lt, #__align_left|#__align_top)
    SetAlignment(*rt, #__align_right|#__align_top)
    SetAlignment(*rb, #__align_right|#__align_bottom)
    SetAlignment(*lb, #__align_left|#__align_bottom)
    SetAlignment(*ce, #__align_center)
    
    SetAlignment(*c, #__align_Center|#__align_full)
    CloseList()
