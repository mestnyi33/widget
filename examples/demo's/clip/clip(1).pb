...
CompilerIf #PB_Compiler_IsMainFile
  ...
  Define *g = window(10,10,200,200, "window", #PB_Window_SystemMenu|#__flag_autosize) : SetWidgetClass(*g, "window")
  
  Define *g0 = window(10,10,200,200, "form_0-window", #PB_Window_SystemMenu|#__window_child, *g) : SetWidgetClass(*g0, "form_0")
...
;   ButtonWidget(10,90,100,30,"button_0_2") : SetWidgetClass(widget(), GetTextWidget(widget()))
  ...
  Define *g1 = window(30,10,200,200, "form_1-form_0", #PB_Window_SystemMenu|#__window_child, *g0) : SetWidgetClass(*g1, "form_1")
  ...
  Define *g2 = window(50,10,200,200, "form_2-form_1", #PB_Window_SystemMenu|#__window_child, *g1) : SetWidgetClass(*g2, "form_2")
...
;   window(120,40,200,200, "window_0", #PB_Window_SystemMenu|#__window_child, *g) : SetWidgetClass(widget(), "window_0")
