...
CompilerIf #PB_Compiler_IsMainFile
  ...
  Macro Area_Draw( _this_ )
    ...
    Box( DesktopScaledX(X), DesktopScaledY(Y), DesktopScaledX(Width), DesktopScaledY(Height), RGB( 0,255,0 ) )
...
;         EndIf
  ...
  *mdi = MDI(X,Y,Width,Height);, #__flag_autosize)
  ...
  Define b=DesktopScaledX(19)      
  *mdi\scroll\v\round = DesktopScaledY(11)
  ...
  *mdi\scroll\h\round = DesktopScaledX(11)
