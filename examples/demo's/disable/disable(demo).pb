...
CompilerIf #PB_Compiler_IsMainFile ;= 100
  ...
  If OpenWindow(#PB_Any, 0, 0, 995, 605, "", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    Widgets(Hex(#PB_GadgetType_Button)) = Button(5, 5, 160,95, "Multiline Button_"+Hex(#PB_GadgetType_Button)+" (longer text gets automatically multiline)", #__flag_Textmultiline ) 
...
;      Button(10,5,50,35, "butt_1") 
    ...
    DisableWidget(Widgets(Hex(#PB_GadgetType_Button)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_ButtonImage)), 1)
    ;DisableWidget(Widgets(Hex(#PB_GadgetType_Calendar)), 1)
    ;DisableWidget(Widgets(Hex(#PB_GadgetType_Canvas)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_CheckBox)), 1)
    ;DisableWidget(Widgets(Hex(#PB_GadgetType_ComboBox)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_Container)), 1)
    ;DisableWidget(Widgets(Hex(#PB_GadgetType_Date)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_Editor)), 1)
    ;DisableWidget(Widgets(Hex(#PB_GadgetType_ExplorerCombo)), 1)
    ;DisableWidget(Widgets(Hex(#PB_GadgetType_ExplorerList)), 1)
    ;DisableWidget(Widgets(Hex(#PB_GadgetType_ExplorerTree)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_Frame)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_HyperLink)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_Image)), 1)
    ;DisableWidget(Widgets(Hex(#PB_GadgetType_IPAddress)), 1)
    ;DisableWidget(Widgets(Hex(#PB_GadgetType_ListIcon)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_ListView)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_MDI)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_Option)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_Panel)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_ProgressBar)), 1)
    ;DisableWidget(Widgets(Hex(#PB_GadgetType_Scintilla)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_ScrollBar)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_ScrollArea)), 1)
    ;DisableWidget(Widgets(Hex(#PB_GadgetType_Shortcut)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_Spin)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_Splitter)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_String)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_Text)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_TrackBar)), 1)
    DisableWidget(Widgets(Hex(#PB_GadgetType_Tree)), 1)
    ;DisableWidget(Widgets(Hex(#PB_GadgetType_Web)), 1)
