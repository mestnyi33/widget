      ...
      Case #PB_EventType_LeftClick
        Select EventWidget
          ...
          Case button_top,
            ...
            Flag(*this, #__flag_Textleft|#PB_CheckBox_Right|#__flag_Texttop|#__flag_Textbottom, 0)
            ;
            ...
            ElseIf GetWidgetState(button_right) And GetWidgetState(button_bottom)
              Flag(*this, #PB_CheckBox_Right|#__flag_Textbottom, 1)
            ...
            ElseIf GetWidgetState(button_right) And GetWidgetState(button_top)
              Flag(*this, #PB_CheckBox_Right|#__flag_Texttop, 1)
...
;         EndSelect
  ...
  If OpenRoot(0, 0, 0, width + 180, height + 20, "change button flags", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    *this  = widget::CheckBoxWidget(100, 100, 250, 200, Text, #__flag_Textmultiline);|)
...
;     AddItem(tree, #tree_item_invert, "invert")
    ...
    SetWidgetState(button_left, Flag(*this, #__flag_Textleft))
    If Button_type
       Hide(Button_type, 1)
    EndIf
