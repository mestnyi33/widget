...
CompilerIf #PB_Compiler_IsMainFile
   ...
   If Open(0, 0, 0, Width + 180, Height + 20, "change button flags", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
      ...
      *this  = Widget::String(100, 100, 250, 200, Text )
      ...
      *b32 = Button( Width + 45 + 70, Y, 30, bh, "32")
      ...
      button_inline    = Widget::Button(Width + 45, Y + p * 5, 100, bh, "inline", #PB_Button_Toggle)
      Button_wordwrap  = Widget::Button(Width + 45, Y + p * 6, 100, bh, "wordwrap", #PB_Button_Toggle)
      button_multiline = Widget::Button(Width + 45, Y + p * 7, 100, bh, "multiline", #PB_Button_Toggle)
      button_numeric    = Widget::Button(Width + 45, Y + p * 8, 100, bh, "numeric", #PB_Button_Toggle)
      button_upper    = Widget::Button(Width + 45, Y + p * 9, 100, bh, "upper", #PB_Button_Toggle)
      button_lower    = Widget::Button(Width + 45, Y + p * 10, 100, bh, "lower", #PB_Button_Toggle)
      button_read    = Widget::Button(Width + 45, Y + p * 11, 100, bh, "read", #PB_Button_Toggle)
      button_pass      = Widget::Button(Width + 45, Y + p * 12, 100, bh, "pass", #PB_Button_Toggle)
      button_vertical  = Widget::Button(Width + 45, Y + p * 13, 100, bh, "vertical", #PB_Button_Toggle)
      button_invert    = Widget::Button(Width + 45, Y + p * 14, 100, bh, "invert", #PB_Button_Toggle)
