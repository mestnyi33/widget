...
Procedure Tool_Gadget( Window, Width, Height )
   ...
   Tool_Alignment_Mode = Frame(5, 4, 317, 124, "Режим выравнивания", #__flag_border_Less|#__flag_Transparent)
   
   Tool_Grid_Container = Container(10, 25, 152, 101)
   ;Tool_Grid_Frame = Frame(1, 4, 150, 93, "")
   Tool_Grid_Show = CheckBox(6, 24, 126, 16, "Показать сетку", #__flag_border_Less|#__flag_Transparent)
   Tool_Grid_Snap = CheckBox(6, 44, 136, 16, "Привязать к сетке", #__flag_border_Less|#__flag_Transparent)
   Tool_Grid_Size_Info = Text(65, 72, 126, 16, "Размер сетки", #__flag_border_Less|#__flag_Transparent)
   ...
   Tool_Line_Show = CheckBox(6, 24, 126, 16, "Показать линию", #__flag_border_Less|#__flag_Transparent)
   Tool_Line_Snap = CheckBox(6, 44, 136, 16, "Привязать к линии", #__flag_border_Less|#__flag_Transparent)
   Tool_Line_Size_Info = Text(65, 72, 126, 16, "Размер линии", #__flag_border_Less|#__flag_Transparent)
   ...
   Tool_Align_To_Grid = Option(X(Tool_Grid_Container, 3)+6, Y(Tool_Grid_Container, 3)+2, 152-12, 16, "Выровнять по сетке", #__flag_border_Less|#__flag_Transparent)
   Tool_Align_To_Line = Option(X(Tool_Line_Container, 3)+6, Y(Tool_Line_Container, 3)+2, 152-12, 16, "Выровнять по линии", #__flag_border_Less|#__flag_Transparent)
   CloseList( )
   CloseList( )
