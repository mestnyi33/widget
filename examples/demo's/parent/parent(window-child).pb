...
CompilerIf #PB_Compiler_IsMainFile
  ...
  MyCanvas = GetCanvasGadget(OpenRoot(0, 10, 10))
  a_init(Root())
  
  ;\\
  ;Define *g = WindowWidget(50,50,100,100, "window", #PB_Window_SystemMenu|#__flag_autosize) : SetWidgetClass(*g, "window")
  Define *g = WindowWidget(50,50,400,400, "window", #PB_Window_SystemMenu) : SetWidgetClass(*g, "window")
  
  ;\\
  Define *g0 = WindowWidget(10,10,200,200, "form_0-window", #PB_Window_SystemMenu|#__window_child, *g) : SetWidgetClass(*g0, "form_0")
  
  ;\\
  Define *g1 = WindowWidget(30,10,200,200, "form_1-form_0", #PB_Window_SystemMenu|#__window_child, *g0) : SetWidgetClass(*g1, "form_1")
  ...
  ;\\
  Define *g2 = WindowWidget(50,10,200,200, "form_2-form_1", #PB_Window_SystemMenu|#__window_child, *g1) : SetWidgetClass(*g2, "form_2")
