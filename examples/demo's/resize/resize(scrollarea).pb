...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If OpenRoot(OpenWindow(#PB_Any, 0, 0, 380, 400, "ScrollBarGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered))
    ; gadgets
    ...
    SetGadGetWidgetState(Splitter_1, 40)
    SetGadGetWidgetState(Splitter_2, 245)
    ...
    SetWidgetState(Splitter_1, 40)
    SetWidgetState(Splitter_2, 245)
