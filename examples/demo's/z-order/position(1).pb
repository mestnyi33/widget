...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If OpenRoot(0, 0, 0, 455, 405, "hide/show widgets", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    *c0 = ContainerWidget(5, 40, 200, 100) : SetWidgetClass(widget(), "con0") 
    ...
    ButtonWidget(80, 20, 80, 50,"ctn1") : SetWidgetClass(widget(), GetWidgetText(widget()))  
    CloseWidgetList()
