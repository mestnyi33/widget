...
;   ButtonWidget(10,90,100,30,"button_0_2") : SetWidgetClass(widget(), GetWidgetText(widget()))
  ...
  ButtonWidget(10,10,100,30,"button_3_0") : SetWidgetClass(widget(), GetWidgetText(widget()))
  ButtonWidget(10,50,100,30,"button_3_1") : SetWidgetClass(widget(), GetWidgetText(widget()))
  ButtonWidget(10,90,100,30,"button_3_2") : SetWidgetClass(widget(), GetWidgetText(widget()))
  ...
  OpenWidgetList(*g0)
  ButtonWidget(10,10,150,30,"button_0_0") : SetWidgetClass(widget(), GetWidgetText(widget()))
  ButtonWidget(10,50,150,30,"button_0_1") : SetWidgetClass(widget(), GetWidgetText(widget()))
  ButtonWidget(10,90,150,30,"button_0_2") : SetWidgetClass(widget(), GetWidgetText(widget()))
  CloseWidgetList()
