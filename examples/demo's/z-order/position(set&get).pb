...
CompilerIf #PB_Compiler_IsMainFile
  ...
  Procedure Demo()
    ...
    ButtonWidget(x, y+51+s*8, 195, h, "2",#__flag_TextRight|#__flag_Texttop) : SetWidgetClass(widget(), GetWidgetText(widget())) ; Gadget(8, 
    *current = ButtonWidget(x, y+47+s*7, 175, h, "3",#__flag_TextRight|#__flag_Texttop) : SetWidgetClass(widget(), GetWidgetText(widget())) ; Gadget(7, 
    ...
    *button = ButtonWidget(4, 4, 200-4, (80+h+s*9)-16-4, "6 < 5 > 4", #__flag_TextRight|#__flag_Texttop) 
    ...
    SetWidgetText(*button, GetWidgetClass(GetPosition(*this, #PB_List_Before)) +" < 5 > "+ GetWidgetClass(GetPosition(*this, #PB_List_After)) ) 
