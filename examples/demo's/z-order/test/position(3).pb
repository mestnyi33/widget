...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If Open(0, 0, 0, 240,205, "hide/show widgets", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    If #demo = #before
      *b1 = Button(55, 5,80,30, "btn1") : SetClass(widget(), GetText(widget()))
      *b2 = Button(75,15,80,30, "btn2") : SetClass(widget(), GetText(widget()))
    EndIf
    
    *c0 = Panel(5, 40, 200, 100) : SetClass(widget(), "pan0") 
    ...
    If #demo = #after
      *b1 = Button(55, 5,80,50, "btn1") : SetClass(widget(), GetText(widget()))
      *b2 = Button(75,15,80,50, "btn2") : SetClass(widget(), GetText(widget()))
    EndIf
