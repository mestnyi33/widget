...
Procedure properties_update(*this._s_widget, Value.i)
  ...
  SetItemText(*this, #_pi_id, "id:"+Chr(10)+Str(Value))
  SetItemText(*this, #_pi_class, "class:"+Chr(10)+GetClass(Value)+"_"+GetCount(Value))
  SetItemText(*this, #_pi_text, "text:"+Chr(10)+GetText(Value))
  SetItemText(*this, #_pi_x, "x:"+Chr(10)+Str(X(Value)))
  SetItemText(*this, #_pi_y, "y:"+Chr(10)+Str(Y(Value)))
  SetItemText(*this, #_pi_width, "width:"+Chr(10)+Str(Width(Value)))
  SetItemText(*this, #_pi_height, "height:"+Chr(10)+Str(Height(Value)))
;   SetItemText(*this, #_pi_disable, "disable:"+Chr(10)+Str(Disable(Value)))
;   SetItemText(*this, #_pi_hide, "hide:"+Chr(10)+Str(Hide(Value)))
EndProcedure
...
Procedure add_to_inspector(*this._s_widget, *new._s_widget, Class.s)
  ...
  Protected i, Position = GetState(*this) + 1
  
  ; get childrens position and sublevel
  For i = 0 To CountItems - 1
    If Parent = GetItemData(*this, i)
  ...
  For i = Position To CountItems - 1
    *Sublevel = GetItemAttribute(*this, i, #PB_Tree_SubLevel)
    
    If SubLevel >= *Sublevel
      If SubLevel > *Sublevel
        SetData( GetItemData(*this, i), (i+1))
      EndIf
    Else
      Position = (i+1)
      Break
  ...
  Select Type
    Case #__type_window    
      If *parent\type = #PB_GadgetType_MDI
        *new = AddItem(*parent, #PB_Any, text, - 1, flag)
      Else
    ...
    Case #PB_GadgetType_ScrollArea : *new = ScrollArea(x,y,width,height, *param1, *param2, *param3, flag)
      
    Case #PB_GadgetType_Button     : *new = Button(x,y,width,height, text, flag)
  EndSelect
...
;   CloseList()
  ...
  AddItem(id_properties_tree, #_pi_disable, "disable:"+Chr(10)+Str(Disable(Value)), #PB_GadgetType_ComboBox, 1);Str(Disable(Value)))
