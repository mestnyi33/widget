...
CompilerIf #PB_Compiler_IsMainFile
   ...
   Procedure HideItem_( *this._s_WIDGET, Item.l, state )
      ProcedureReturn HideItem( *this, Item, state )
   EndProcedure
      ...
      Select EventType( )
         ...
         Case #PB_EventType_LeftClick
            If g2 = EventGadget()
              ...
              ; HideGadgetItem(g1, item, 1 )
              ; HideGadgetItem(g2, item, 1 )
...
;       EndSelect
   ...
   If Open(1, 100, 50, 525, 435+40, "demo Hide item", #PB_Window_SystemMenu)
      ; demo gadget
      ...
      For a = 0 To CountItems
         If a > 4
            If a > 10
               If a > 14
                  ...
                  AddGadgetItem(g2, -1, "нажмите спрятать\показать "+Str(a), 0, 2)
               Else
                  AddGadgetItem(g1, -1, "Item "+Str(a), 0, 1)
                  AddGadgetItem(g2, -1, "нажмите спрятать\показать "+Str(a), 0, 1)
               EndIf
            Else
               AddGadgetItem(g1, -1, "Item "+Str(a), 0, 2)
               AddGadgetItem(g2, -1, "нажмите спрятать\показать "+Str(a), 0, 2)
         ...
         ; AddGadgetItem(g2, -1, "нажмите спрятать\показать "+Str(a), 0)
      Next
      ...
      *g2 = Tree(265, 240, 250, 225);, #PB_Tree_NoButtons|#PB_Tree_NoLines )
      ...
      For a = 0 To CountItems
         If a > 4
            If a > 10
               If a > 14
                  ...
                  AddItem(*g2, -1, "нажмите спрятать\показать "+Str(a), -1, 2)
               Else
                  AddItem(*g1, -1, "Item "+Str(a), -1, 1)
                  AddItem(*g2, -1, "нажмите спрятать\показать "+Str(a), -1, 1)
               EndIf
            Else
               AddItem(*g1, -1, "Item "+Str(a), -1, 2)
               AddItem(*g2, -1, "нажмите спрятать\показать "+Str(a), -1, 2)
         ...
         ;   AddItem(*g2, -1, "нажмите спрятать\показать "+Str(a), -1)
      Next
