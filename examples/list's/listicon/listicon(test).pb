...
CompilerIf #PB_Compiler_IsMainFile
   ...
   If Open(0, 0, 0, 800, 300, "ListIcons", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
      ;\\ left column
      ...
      For a = 0 To 4            ; add columns to each of the first 5 listicons
         For b = 2 To 4         ; add 3 more columns to each listicon
            AddColumn(GetWidget(a), b, "Column " + Str(b), 65)
         Next
         For b = 0 To 2          ; add 4 items to each line of the listicons
            AddItem(GetWidget(a), b, "Item 1"+Chr(10)+"Item 2"+Chr(10)+"Item 3"+Chr(10)+"Item 4")
         Next
      Next
      ...
      If LoadImage(0, #PB_Compiler_Home+"Examples/Sources/Data/File.bmp")     ; change path/filename to your own 32x32 pixel image
         SetAttribute(GetWidget(5), #PB_ListIcon_DisplayMode, #PB_ListIcon_LargeIcon)
         AddItem(GetWidget(5), 1, "Picture 1", ImageID(0))
         AddItem(GetWidget(5), 2, "Picture 2", ImageID(0))
      EndIf
