...
If Open(0, 0, 0, 270+260, 160+150+150, "listviewGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
  ...
  *g = ListView(270, 30, 250, 120) : SetFrame( Widget( ), 2)
  For a = 0 To 12
    AddItem (*g, -1, "listview item " + Str(a)) ; define listview content
    SetItemState(*g, a, #PB_Tree_Selected) 
  Next
  SetState(*g, 5) 
  SetState(*g, 7) 
  SetState(*g, 9) 
  ...
  *g = ListView(270, 30+150, 250, 120, #PB_ListView_ClickSelect) : SetFrame( Widget( ), 2)
  For a = 0 To 12
    AddItem (*g, -1, "listview item " + Str(a) + " 1long 2long 3long 4long 5long 6long 7long 8long") ; define listview content
    If a%2
      SetItemState(*g, a, #PB_Tree_Selected) 
    EndIf
  Next
  ...
  *g = ListView(270, 30+150+150, 250, 120, #PB_ListView_MultiSelect) : SetFrame( Widget( ), 2)
  For a = 0 To 12
    AddItem (*g, -1, "listview item " + Str(a)) ; define listview content
    If a%2
      SetItemState(*g, a, #PB_Tree_Selected) 
