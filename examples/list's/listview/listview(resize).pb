...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If Open(OpenWindow(#PB_Any, 0, 0, width+20, height+20, "resize demo", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)) ; #__flag_autosize | 
    *this = Tree( 0,0,0,0, #__flag_NoButtons | #__flag_NoLines | #__flag_gridlines | #__flag_borderless ) ; widget::ListView(100, 100, 250, 200, #__flag_anchorsgadget |#__tree_optionBoxes | #__tree_nolines | #__tree_nobuttons );| #__tree_OptionBoxes)  ; |#__tree_GridLines
