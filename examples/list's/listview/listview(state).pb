...
;     CompilerEndSelect
  ...
  If OpenRoot(1, 100, 50, 525, 435+40, "demo ListView state", #PB_Window_SystemMenu)
    ; demo gadget
    ...
    *g2 = ListViewGadget_(#PB_Any, 10, 115, 250, 310, #PB_ListView_MultiSelect)
    ...
    ; demo widget
    *w1 = widget::ListViewWidget(265, 10, 250, 100, #PB_ListView_ClickSelect )
    *w2 = widget::ListViewWidget(265, 115, 250, 310, #PB_ListView_MultiSelect )
