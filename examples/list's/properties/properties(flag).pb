...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If Open(0, 0, 0, 605+30, 560, "ScrollBarGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    CheckBoxWidget(30,30*3, 100, 30, "checkbox_0")
    ...
    widget::AddItem(*Tree, #_pi_y, "y:"+Chr(10)+Str(Y(Value)), #PB_WidgetType_Spin, 1)
    widget::AddItem(*Tree, #_pi_width, "width:"+Chr(10)+Str(WidgetWidth(Value)), #PB_WidgetType_Spin, 1)
    widget::AddItem(*Tree, #_pi_height, "height:"+Chr(10)+Str(WidgetHeight(Value)), #PB_WidgetType_Spin, 1)
