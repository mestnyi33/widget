   ...
   Procedure widget_events()
      ...
      Select WidgetEvent( )
         Case #__event_RightClick
            If *g1 = EventWidget( )
               RemoveItem_(*g1, WidgetEventItem())
                              
            ForEach *g1\__rows( )
                  Debug ""+*g1\__rows( )\index +" "+*g1\__rows( )\sublevel +" "+*g1\__rows( )\text\string +" "+*g1\RowFirstLevelLast( )\text\string
               Next
...
;       EndSelect
   ...
   If Open(1, 100, 50, 525, 435+40, "demo remove item", #PB_Window_SystemMenu)
      ...
      ;  
      AddGadgetItem(g1, 0, "Window "+Str(a), 0, 0)
      AddGadgetItem(g1, 1, "Container "+Str(a), 0, 1)
      AddGadgetItem(g1, -1, "but7ton "+Str(a), 0, 1)
      AddGadgetItem(g1, 2, "Cont3ainer "+Str(a), 0, 2)
       AddGadgetItem(g1, 5, "but4ton "+Str(a), 0, 3)
;       AddGadgetItem(g1, 2, "but2ton "+Str(a), 0, 2)
;       AddGadgetItem(g1, -1, "button "+Str(a), 0, 1)
       
      ;       
      Define i : For i=0 To CountGadgetItems(g1) : SetGadgetItemState(g1, i, #PB_Tree_Expanded) : Next
      ...
      *g2 = Tree(265, 240, 250, 225);, #PB_Tree_NoButtons|#PB_Tree_NoLines )
      ...
      ; 
      AddItem(*g1, 0, "Window "+Str(a), -1, 0)
      AddItem(*g1, 1, "Container "+Str(a), -1, 1)
      AddItem(*g1, -1, "but7ton "+Str(a), -1, 1)
      AddItem(*g1, 2, "Cont3ainer "+Str(a), -1, 2)
       AddItem(*g1, 5, "but4ton "+Str(a), -1, 3)
;       AddItem(*g1, 2, "but2ton "+Str(a), -1, 2)
;       AddItem(*g1, -1, "button "+Str(a), -1, 1)
      
      ;
      ; Define i : For i=0 To CountItems(*g1) : SetItemState(*g1, i, #PB_Tree_Expanded) : Next
