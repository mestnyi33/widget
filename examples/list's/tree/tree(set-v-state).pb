...
CompilerIf #PB_Compiler_IsMainFile
  ...
  ; first splitter
  *w0 = widget::Tree(0, 0, 0, 0, #__tree_noButtons|#__tree_noLines )
  For i=0 To 3
    widget::AddItem(*w0, -1, "tab_0_"+Str(i))
  Next
  
  *w1 = widget::Tree(0, 0, 0, 0, #__tree_noButtons|#__tree_noLines )
  For i=0 To 10
    widget::AddItem(*w1, -1, "tab_1_"+Str(i))
  Next
  
  *w2 = widget::Splitter(300, 30, 350, 70, *w0, *w1, #PB_Splitter_Separator|#PB_Splitter_Vertical)
  
  ; first splitter
  *w3 = widget::Tree(0, 0, 0, 0, #__tree_noButtons|#__tree_noLines)
  For i=0 To 10
    widget::AddItem(*w3, -1, "tab_2_"+Str(i))
  Next
  
  *w4 = widget::Tree(0, 0, 0, 0, #__tree_noButtons|#__tree_noLines)
  For i=0 To 10
    widget::AddItem(*w4, -1, "tab_3_"+Str(i))
  Next
  
  *w5 = widget::Splitter(30, 110, 350, 70, *w3, *w4, #PB_Splitter_Separator|#PB_Splitter_Vertical)
  
  
  *w6 = widget::Splitter(30, 30, 260, 150, *w2, 0, #PB_Splitter_Separator)
  *w7 = widget::Splitter(300, 30, 260, 150, *w5, 0, #PB_Splitter_Separator)
  widget::SetState(*w6, 250)
  widget::SetState(*w7, 250)
  
   
  *w8 = widget::Tree(30, 210, 150, 150, #__tree_noButtons|#__tree_noLines)
  For i=0 To 10
