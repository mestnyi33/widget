...
CompilerIf #PB_Compiler_IsMainFile
  ...
  *window_1 = Window(202, 0, 630, 319+#__window_frame, "demo set  new parent", Flags )
  ...
  *scrollarea = ScrollArea(420,150,200,160,200,160,10,#PB_ScrollArea_Flat) 
  ...
  *b_0 = Button(450,90,160,30,"Button >>(Back)") 
  ...
  OpenWindow(20, X, Y, 200, 346, "", Flags, WindowID(GetWindow(GetRoot(*window_1))))
  Open(20)
  SetWindowTitle(GetWindow(Root()), "old parent") 
  *window_2 = Window(0,0,0,0, "", #__flag_autosize)
