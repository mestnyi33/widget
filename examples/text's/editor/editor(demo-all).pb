...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If OpenWindow(0, 0, 0, 615, (Height+5)*7+20+90+160, "String on the canvas", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    *S_0 = String( 305+8,  10, 290, Height, "Read-only StringGadget...", #PB_String_ReadOnly|#__flag_text_Top)
    *S_1 = String( 305+8,  (Height+5)*1+10, 290, Height, "123-only-4567", #PB_String_Numeric|#__flag_text_Center)
    *S_2 = String( 305+8,  (Height+5)*2+10, 290, Height, "Right-text StringGadget", #__flag_text_Right|#__flag_text_Bottom)
    ...
    *S_7 = String( 305+150+8, (Height+5)*6+10, 140, Height, "Password", #PB_String_Password )
    ;     ; *S_8 = String( 305+8, (height+5)*8+10, 290, 90+150, Text, #__flag_gridlines|#__flag_text_numeric|#__flag_text_multiline)
    ;     *S_8 = String( 305+8, (height+5)*8+10, 290, 90+30, Text, #__flag_gridlines|#__flag_text_numeric|#__flag_text_multiline)
    ;     *S_9 = String( 305+8, (height+5)*9+10+60, 290, 90+30, Text, #__flag_gridlines|#__flag_text_numeric|#__flag_text_wordwrap)
