    ...
    If Open(OpenWindow(#PB_Any, 0, 0, 355, 240, "TreeGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered))
      ...
      *tree = Tree(180, 10, 160, 160, #__Tree_CheckBoxes | #__Tree_NoLines | #__Tree_ThreeState | #__Tree_Collapse); | | #__Tree_AlwaysShowSelection #__Tree_GridLines)   ; TreeGadget with Checkboxes + NoLines
        ...
        For a = 0 To 10
          ...
          AddGadgetItem(tree, -1, "Sub-Item 1_2", 0, 2)         ; These are on the 1st sublevel
        ...
        For a = 0 To 10
          ...
          AddItem(*tree, -1, "Sub-Item 1", img, 1)           ; These are on the 1st sublevel
          AddItem(*tree, -1, "Sub-Item 1_2", img, 2)         ; These are on the 1st sublevel
          AddItem(*tree, -1, "Sub-Item 2", img, 1)
          AddItem(*tree, -1, "Sub-Item 3", img, 1)
          AddItem(*tree, -1, "Sub-Item 4", img, 1)
