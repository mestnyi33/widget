...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If Open(OpenWindow(#PB_Any, 0, 0, 720+40, 400, "Button on the canvas", #PB_Window_SystemMenu | #PB_Window_SizeGadget | #PB_Window_ScreenCentered))
    ...
    *f_4 = window(370+10, 10, 180,  120, "form_4", #__flag_BorderLess)
    button(5, 5, 80, 20, "Butt_4_0")
    *f_5 = window(370+10, 130+10, 180,  120, "form_6", #PB_Window_SizeGadget)
    button(5, 5, 80, 20, "Butt_6_0")
    
    *f_6 = window(370+10, 130+10+130, 180,  120, "form_8", #PB_Window_TitleBar)
    button(5, 5, 80, 20, "Butt_8_0")
    
    *f_7 = window(370+10+190, 10, 180,  120, "form_5 SystemMenu", #PB_Window_SystemMenu)
    button(5, 5, 80, 20, "Butt_5_0")
    
    *f_8 = window(370+10+190, 130+10, 180,  120, "form_7 Minimize", #PB_Window_MinimizeGadget)
    button(5, 5, 80, 20, "Butt_7_0")
    
    *f_9 = window(370+10+190, 130+10+130, 180,  120, "form_9 Maximize", #PB_Window_MaximizeGadget)
