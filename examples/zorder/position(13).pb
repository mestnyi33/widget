...
;   Button(10,90,100,30,"button_0_2") : SetClass(widget(), GetText(widget()))
  ...
  Define *g1 = window(30,10,200,200, "form_1", 0, *g0) : SetClass(widget(), "form_1")
  ...
  Define *g2 = window(50,10,200,200, "form_2", 0, *g1) : SetClass(widget(), "form_2")
  ...
  window(120,40,200,200, "window_0", 0, *g) : SetClass(widget(), "window_0")
