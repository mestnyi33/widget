...
CompilerIf #PB_Compiler_IsMainFile
  ...
  Global *s1, *s2, *p1, *sb1,*sb2, *b0,*b1,*b2,*b3, *b4, *b5
  ...
  If Open(OpenWindow(#PB_Any, 0, 0, 455, 405, "hide/show widgets", #PB_Window_SystemMenu | #PB_Window_ScreenCentered))
    ...
    *s1 = Panel(5, 40, 200, 100) 
    ...
    Button(105, 5, 50, 30,"102") : SetClass(widget(), GetText(widget()))  
    Button(105, 5, 50, 30,"103") : SetClass(widget(), GetText(widget()))  
    AddItem(*s1, -1, "2")
    Button(105, 25, 50, 30,"201") : SetClass(widget(), GetText(widget()))  
    Button(105, 25, 50, 30,"202") : SetClass(widget(), GetText(widget()))  
    Button(105, 25, 50, 30,"203") : SetClass(widget(), GetText(widget()))  
    AddItem(*s1, -1, "3")
    Button(105, 25, 50, 30,"301") : SetClass(widget(), GetText(widget()))  
    Button(105, 25, 50, 30,"302") : SetClass(widget(), GetText(widget()))  
    Button(105, 25, 50, 30,"303") : SetClass(widget(), GetText(widget()))  
    CloseList()
