...
Module Area
  ...
  Procedure.b Updates(*scroll._S_scroll, ScrollArea_X, ScrollArea_Y, ScrollArea_Width, ScrollArea_Height)
    With *scroll
      ...
      If \v\max<>ScrollArea_Height : SetBarAttribute(\v, #PB_ScrollBar_Maximum, ScrollArea_Height) : EndIf
      If \h\max<>ScrollArea_Width : SetBarAttribute(\h, #PB_ScrollBar_Maximum, ScrollArea_Width) : EndIf
