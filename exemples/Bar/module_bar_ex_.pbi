...
DeclareModule Bar
  ...
  Declare.i OpenList(*This.Bar_S, Item.i=-1)
  Declare.i CloseList(*This.Bar_S)
  Declare.i SetParent(*This.Bar_S, *Parent.Bar_S, Item.i=-1)
...
Module Bar
  ...
  *Bar\Type =- 1
  ...
  Macro Resize_Splitter(_this_)
    If _this_\Vertical
      Resize(_this_\s\v, _this_\x, _this_\y, _this_\width, _this_\Thumb\Pos-_this_\y)
      Resize(_this_\s\h, _this_\x, _this_\Thumb\Pos+_this_\Thumb\len, _this_\width, _this_\height-((_this_\Thumb\Pos+_this_\Thumb\len)-_this_\y))
    Else
      Resize(_this_\s\v, _this_\x, _this_\y, _this_\Thumb\Pos-_this_\x, _this_\height)
      Resize(_this_\s\h, _this_\Thumb\Pos+_this_\Thumb\len, _this_\y, _this_\width-((_this_\thumb\Pos+_this_\thumb\len)-_this_\x), _this_\height)
    EndIf
  EndMacro
  
  Procedure.i Draw_Progress(*This.Bar_S, scroll_x,scroll_y)
    With *This 
      ; Draw progress
      If \Vertical
  ...
  Procedure.i Draw_Splitter(*This.Bar_S, scroll_x,scroll_y)
  ...
  Procedure.i Draw_Scroll(*This.Bar_S, scroll_x,scroll_y)
...
;       Debug ""+Str(\Area\Pos+\Area\len) +" "+ \Y[2]
  ...
  Procedure.i Draw_Track(*This.Bar_S, scroll_x,scroll_y)
    With *This 
      Protected i, a = 3
      DrawingMode(#PB_2DDrawing_Default)
  ...
  Procedure.i Draw_Image(*This.Bar_S, scroll_x,scroll_y)
    With *This 
  ...
  Procedure.i Draw_ScrollArea(*This.Bar_S, scroll_x,scroll_y)
    Protected Alpha.i
  ...
  Procedure Draw_Childrens(*This.Bar_S)
    With *This
    ...
    If *This > 0 And *This\Type 
      With *This
       If Not \hide And \color\alpha And \Height>0 And \width>0
         If \p
           x = Bool(ListSize(\p\Childrens()))*\p\x+\p\s\x
           y = Bool(ListSize(\p\Childrens()))*\p\y+\p\s\y
         EndIf
...
;               UnclipOutput()
  ...
  ;-
  Procedure.i SetParent(*This.Bar_S, *Parent.Bar_S, Item.i=-1)
    Protected x,y
  ...
  Procedure.i OpenList(*This.Bar_S, Item.i=-1)
    With *This
      If *This > 0
      EndIf
    EndWith
  ...
  Procedure.i CloseList(*This.Bar_S)
    With *This
      If *This > 0
      EndIf
    EndWith
        ...
        If \Resize
          ...
          If \s 
            If (\Type = #PB_GadgetType_Splitter)
              Resize_Splitter(*This)
            Else
              Resizes(\s,\x+2,\y+2,\Width-4,\Height-4)
            EndIf
          EndIf
          
;           If ListSize(\Childrens())
;             ForEach \Childrens()
;               Resize(\Childrens(), \Childrens()\p\x+\Childrens()\x, #PB_Ignore, #PB_Ignore, #PB_Ignore)
;             Next
;           EndIf
...
;             SetState(\s\v,\s\v\Page\Pos - ((Bool(\Image\Align\Bottom Or \Image\Align\Vertical) * (\s\v\Page\len-\Image\height)) / (\Image\Align\Vertical+1)))
;             SetState(\s\h,\s\h\Page\Pos - ((Bool(\Image\Align\Right Or \Image\Align\Horizontal) * (\s\h\Page\len-\Image\width)) / (\Image\Align\Horizontal+1)))
  ...
  Procedure.i CallBack(*This.Bar_S, EventType.i, MouseScreenX.i=0, MouseScreenY.i=0)
    Protected repaint.i
    Static Last.i, Down.i, *Lastat.Bar_S, *Last.Bar_S, mouseB.i, *mouseat.Bar_S, Buttons
  ...
  Procedure.i Image(X.i,Y.i,Width.i,Height.i, Image.i, Flag.i=0)
    Protected Size = 16, *This.Bar_S = AllocateStructure(Bar_S) 
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  Global *child_0.Bar_S=AllocateStructure(Bar_S)
  Global *child_1.Bar_S=AllocateStructure(Bar_S)
  Global *child_2.Bar_S=AllocateStructure(Bar_S)
  Global *ScrollArea.Bar_S=AllocateStructure(Bar_S)
...
;     Repaint | CallBack(*Scroll_1, EventType, mouseX,mouseY)
  ...
  Procedure Window_0()
    If OpenWindow(0, 0, 0, 400, 400, "Demo inverted scrollbar direction", #PB_Window_SystemMenu | #PB_Window_ScreenCentered | #PB_Window_SizeGadget)
      ...
      *Scroll_1.Bar_S  = Image(0, 0, 0, 0, 0); : SetState(*Scroll_1, 50) 
      ;*Scroll_1.Bar_S  = Progress(0, 0, 0, 0, 0,100,0) : SetState(*Scroll_1, 50)
      *Scroll_2.Bar_S  = ScrollArea(0, 0, 0, 0, 250,250) 
      ...
      *child_0.Bar_S  = Scroll(10, 10, 80, 20, 0,200,100) : SetState(*child_0, 20)
      *child_1.Bar_S  = Scroll(10, 40, 80, 20, 0,200,100) : SetState(*child_1, 50)
      *child_2.Bar_S  = Scroll(10, 70, 80, 20, 0,200,100) : SetState(*child_2, 80)
      ;*ScrollArea.Bar_S  = ScrollArea(50, 50, 150, 150, 250,250) 
       
      
      SetParent(*child_0, *Scroll_2)
      SetParent(*child_1, *Scroll_2)
      SetParent(*child_2, *Scroll_2)
      
      ;SetState(*Scroll_2\s\h, 45)
