...
Module ProgressBar
  ...
  Procedure Gadget(Gadget, X.i, Y.i, Width.i, Height.i, Min.i, Max.i, Flag.i=0)
    ...
    Protected *Root.Widget::Widget_S = AllocateStructure(Widget::Widget_S)
    With *Root
      \X =- 1
      \Y =- 1
      \Root = *Root
      ...
      LastElement(Widget::*Value\OpenedList())
      If AddElement(Widget::*Value\OpenedList())
        Widget::*Value\OpenedList() = *Root
      EndIf
      
      Widget::*Value\Root = \Root
      Widget::*Value\Root\CanvasWindow = -1
      Widget::*Value\Root\Canvas = Gadget
      Widget::*Value\Root\adress = Widget::@*Value\OpenedList()
      
      Widget::*Value\Last = Widget::*Value\Root
    EndWith
