...
CompilerIf #PB_Compiler_IsMainFile
  ...
  Procedure ReDraw(Gadget.i)
    If *Bar_1\Change Or *Bar_1\Resize
      Bar::Resize(*Scroll_3, *Bar_1\x[1], *Bar_1\y[1], *Bar_1\width[1], *Bar_1\height[1])
      Bar::Resize(*Bar_0, *Bar_1\x[2], *Bar_1\y[2], *Bar_1\width[2], *Bar_1\height[2])
    EndIf
    If *Bar_0\Change Or *Bar_0\Resize
      Bar::Resize(*Scroll_1, *Bar_0\x[1], *Bar_0\y[1], *Bar_0\width[1], *Bar_0\height[1])
      Bar::Resize(*Scroll_2, *Bar_0\x[2], *Bar_0\y[2], *Bar_0\width[2], *Bar_0\height[2])
    EndIf
