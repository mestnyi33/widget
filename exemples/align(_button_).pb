...
;           EndIf
  ...
  Procedure.s Text_Wrap (*this.widget, text$, softWrapPosn.i, hardWrapPosn.i=-1, delimList$=" "+Chr(9), nl$=#LF$, liStart$="")
    ; ## Main function ##
  ...
  Procedure.s make_multiline(*this.widget, String.s)
    ...
    With *This
      ...
      If \count\items
        ...
        If \Vertical
          \scroll\width = text_height
        Else
          \scroll\height = text_height
        EndIf
    ...
    If Not *This\Hide
      With *This
        ...
        If \Text\String.s
          ...
          If Bool(\Text\Change Or \Resize) = 8
            If \Text\Vertical
              Width = \Height[1]
              Height = \Width[1]
            Else
            ...
            If \count\items
              ...
              Protected pos, *Sta.Character = @String, *End.Character = @String : #__sOC = SizeOf(Character)
              While *End\c 
                If *End\c = #LF And *Sta <> *End And AddElement(\items())
                  \items()\text\pos = pos+ListSize(\items()) : pos + \items()\text\Len
                  \items()\text\Len = (*End-*Sta)>>#PB_Compiler_Unicode
            ...
            ;             EndIf
          Else
            \Text\String.s[2] = make_multiline(*This, \Text\String.s)
          EndIf
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If OpenWindow(0, 0, 0, 222+222, 205+70, "Buttons on the canvas", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    *B_1 = Create(10, -1, 30, 100, 80, 100, "Standard Button Button (Vertical)", #PB_Widget_Vertical|#PB_Text_MultiLine,8)
    *B_2 = Create(10, -1, 120, 10, 100, 80, "Standard Button Button (horizontal)", #PB_Text_MultiLine|#PB_Text_Invert,8)
    *B_3 = Create(10, -1, 120, 100, 80, 100, "Standard Button Button (Vertical)", #PB_Widget_Vertical|#PB_Text_MultiLine|#PB_Text_Invert,8)
    ...
    *B_3 = Create(10, -1, 230,100, 200, 60, "Multiline Button (longer text gets automatically multiline)", #PB_Text_MultiLine|#PB_Button_Default, 4)
    *B_4 = Create(10, -1, 230,170, 200, 60, "Multiline Button (longer text gets automatically wrapped)", #PB_Text_WordWrap, 4)
    *B_6 = Create(10, -1, 10,170+40, 210, 55, "Toggle Button", #PB_Button_Toggle,0, 10)
