...
Module Widget
    ...
    If *this\text\string
      ForEach *this\row\_s()
        If *this\row\_s()\text\string
          DrawingMode(#PB_2DDrawing_Transparent|#PB_2DDrawing_AlphaBlend)
          DrawRotatedText(*this\row\_s()\text\x+*this\scroll\x, *this\row\_s()\text\y+*this\scroll\y, *this\row\_s()\text\string, *this\text\rotate, *this\color\front[*this\color\state]&$FFFFFF|*this\color\alpha<<24)
        EndIf
      Next
    EndIf
  EndProcedure
  ...
  Macro _make_line_y_(_this_)
    ...
    Else
      ...
      ElseIf _this_\text\rotate = 180
        _this_\row\_s()\text\y = _y_ + (_height_ - _this_\scroll\height)
      EndIf
    EndIf
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  Define text_v.s = "Standard Button Button (horizontal)" ; Standard"+ m.s +"Button Button"+ m.s +"(Vertical)"
  ...
  If Open(0, 0, 0, 908, (height+5)*5+20+110, "Buttons on the canvas", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    *S_0 = (Gadget(20, 8,  (height+5)*3+10, 140, height, text_v,          #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_left|#__text_top))
    *S_1 = (Gadget(21, 8,  (height+5)*4+10, 140, height, text_v,          #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_left))
    *S_2 = (Gadget(22, 8,  (height+5)*5+10, 140, height, text_v,          #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_left|#__text_bottom))
    
    *S_0 = (Gadget(23, 8+150,  (height+5)*3+10, 140, height, text_v,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_center|#__text_top|#__string_readonly))
    *S_1 = (Gadget(24, 8+150,  (height+5)*4+10, 140, height, text_v,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_center))
    *S_2 = (Gadget(25, 8+150,  (height+5)*5+10, 140, height, text_v,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_center|#__text_bottom))
    
    *S_0 = (Gadget(26, 8+300,  (height+5)*3+10, 140, height, text_v,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_right|#__text_top|#__string_readonly))
    *S_1 = (Gadget(27, 8+300,  (height+5)*4+10, 140, height, text_v,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_right))
    *S_2 = (Gadget(28, 8+300,  (height+5)*5+10, 140, height, text_v,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_right|#__text_bottom))
    
    
    *S_0 = (Gadget(30, 8+450,  (height+5)*3+10, 140, height, text_v,      #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__text_left|#__text_top))
    *S_1 = (Gadget(31, 8+450,  (height+5)*4+10, 140, height, text_v,      #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__text_left))
    *S_2 = (Gadget(32, 8+450,  (height+5)*5+10, 140, height, text_v,      #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__text_left|#__text_bottom))
    
    *S_0 = (Gadget(33, 8+150+450,  (height+5)*3+10, 140, height, text_v, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_center|#__text_top|#__string_readonly))
    *S_1 = (Gadget(34, 8+150+450,  (height+5)*4+10, 140, height, text_v, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_center))
    *S_2 = (Gadget(35, 8+150+450,  (height+5)*5+10, 140, height, text_v, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_center|#__text_bottom))
    
    *S_0 = (Gadget(36, 8+300+450,  (height+5)*3+10, 140, height, text_v, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_right|#__text_top|#__string_readonly))
    *S_1 = (Gadget(37, 8+300+450,  (height+5)*4+10, 140, height, text_v, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_right))
    *S_2 = (Gadget(38, 8+300+450,  (height+5)*5+10, 140, height, text_v, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_right|#__text_bottom))
...
; Folding = AAAAAAAAAAAAAAAAAwDAAAEAAAAGEAAAgBAAA-PAwDIAAAAstBAAAAAAAAAAAAAAAAAAAAAAIAAAAMBAACAAAAAAAAAAQAAw-----DAAGAPEAAAAAAAAAAAAAAAAAAAAAAAMYAAAAAAAAAAAAAAAAEAAAAE+BAAQgAUUAAAAAABAAAAAAAAAAAAAAAAAAAAAAAAh0
; EnableXP