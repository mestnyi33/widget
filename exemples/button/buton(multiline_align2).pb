        ...
        If \Text\String.s
          ...
          If CountString
            ...
            For IT = 1 To CountString
              ...
              If \Text\Align\Right
                Text_X=(Width-StringWidth-\Text\X) + Bool(#PB_Compiler_OS <> #PB_OS_Windows)
              ElseIf \Text\Align\horizontal 
                If ch <> CountString
                  ch = CountString
                  tw = Width
              ...
              If \Vertical
               ...
               ;;;DrawRotatedText(\X[1]+\Text\Y+Text_Y+\Text\Height, \Y[1]+\Text\X+Text_X, String4.s, 270, \Color\Front[\color\state])
                Text_Y+TxtHeight : If Text_Y > (Height) : Break : EndIf
              Else
                DrawText(\X[2]+\Text\X+Text_X, \Y[2]+\Text\Y+Text_Y-1, String4.s, \Color\Front[\color\state])
                Text_Y+TxtHeight : If Text_Y > (Height-TxtHeight) : Break : EndIf
              EndIf
...
;         *this\text\rotate = (Bool(*this\bar\vertical And *this\bar\inverted) * 270) +
;                                       (Bool(*this\bar\vertical And Not *this\bar\inverted) * 90)
         *this\fs = 1
        *this\bs = *this\fs
