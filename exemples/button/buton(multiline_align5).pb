...
;           _this_\text\align\bottom = constants::_check_(_flag_, #__text_bottom)
            ...
            For IT = 1 To CountString
              ...
              Else
                ...
                If \scroll\width < StringWidth
                  ...
                  \scroll\y = \Text\y+Text_y-TxtHeight
              ...
              If \Vertical
                If \text\rotate = 270
                  DrawRotatedText(\X[2]+\Text\x+(Height-Text_Y), \Y[2]+\Text\y+Text_X, String4.s, 270, \Color\Front[\color\state])
                EndIf
                If \text\rotate = 90
    ...
    Procedure.i Button(x.l,y.l,width.l,height.l, Text.s, Flag.i=0, Image.i=-1, round.l=0)
      ...
      *this\bs = *this\fs
       ...
       If *this\Vertical
        *this\Text\X = *this\fs;+10 
        *this\Text\y = *this\fs;+10;+3 ; 2,6,1
      Else
