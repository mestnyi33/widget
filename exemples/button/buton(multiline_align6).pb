...
CompilerIf Not Defined(widget, #PB_Module)
  ...
  Module widget
            ...
            EndIf
              ...
              If \Vertical
                ...
                If \scroll\height < StringWidth
                  ...
                  If \text\rotate = 270
                   ;\scroll\x = \Text\x+(width-Text_y)
                   If Not \scroll\x
                    \scroll\x = \Text\x+(width-Text_y-TxtHeight)  
                  EndIf
              ...
              If \Vertical
                ...
                Text_Y+TxtHeight : If Text_Y-\Text\x > (Height-TxtHeight) : Break : EndIf
              Else
                If \text\rotate = 0
    ...
    Procedure.i Button(x.l,y.l,width.l,height.l, Text.s, Flag.i=0, Image.i=-1, round.l=0)
      Protected *this._s_widget = Text(x,y,width,height, Text, Flag|#__text_center, round)
