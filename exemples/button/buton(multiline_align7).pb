...
;                       If \Text\Align\right
;                        ; Text_Y=(Height-(\Text\Height*CountString)-Text_Y) 
;                          \scroll\x = \Text\x;+(\Text\Height*CountString)-Text_Y
;                      ElseIf \Text\Align\horizontal 
;                         \scroll\x = \Text\x+Text_y
;                       Else
...
;                       EndIf
        ...
        If \scroll
          DrawingMode(#PB_2DDrawing_Outlined|#PB_2DDrawing_AlphaBlend)
          ; Scroll area coordinate
          Box(\x[2]+*this\scroll\x, \y[2]+*this\scroll\y, \scroll\width, \scroll\height, $FFFF0000) ; + \text\y*2 - \flag\gridlines), $FF0000FF)
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If OpenWindow(0, 0, 0, 222+222+222, 205+70, "Buttons on the canvas", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    Open(0,  222, 0, 222+222, 205+70)
    
    Button(10, 10, 200, 20, "Standard Button", 0,-1,8)
    Button(10, 40, 200, 20, "Left Button", #PB_Button_Left)
    Button(10, 70, 200, 20, "Right Button", #PB_Button_Right)
    Button(10,100, 200, 60, "Multiline Button  (longer text gets automatically wrapped)", #__text_wordwrap, 4)
    Button(10,170, 200, 60, "Multiline Button  (longer text gets automatically multiline)", #PB_Button_MultiLine|#PB_Button_Default, 4)
    Button(10,170+70, 200, 25, "Toggle Button", #PB_Button_Toggle)
    ...
    Button(10+222,100, 200, 60, "Multiline Button  (longer text gets automatically wrapped)", #__text_wordwrap, 4)
    Button(10+222,170, 200, 60, "Multiline Button  (longer text gets automatically multiline)", #__button_multiline|#__button_default, 4)
  ...
  Procedure ResizeCallBack()
    ...
    Resize(*Button_0, #PB_Ignore, #PB_Ignore, #PB_Ignore, Height-30)
    Resize(*Button_1, #PB_Ignore, #PB_Ignore, #PB_Ignore, Height-30)
    Resize(*Button_2, #PB_Ignore, #PB_Ignore, #PB_Ignore, Height-30)
  ...
  If OpenWindow(11, 0, 0, 325+80, 160, "Button on the canvas", #PB_Window_SystemMenu | #PB_Window_SizeGadget | #PB_Window_ScreenCentered)
    Open(11, 10, 10 , 325+80, 160)
    c2 = GetGadget(Root())
    
    *Button_0 = Button(280, 5,  60, 120, "Button (Vertical)", #__button_multiline|#__button_vertical);|#__button_inverted)
    ...
    *Button_1 = Button(30, 5, 80,  120, "Button (Horisontal)", #__button_multiline|#__flag_vertical|#__text_left,-1)
    *Button_2 = Button(160, 5, 80,  120, "Button (Horisontal)", #__button_multiline|#__flag_vertical|#__string_right,-1)
