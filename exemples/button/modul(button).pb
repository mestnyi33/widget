...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If OpenWindow(0, 0, 0, 260, 160, "Button on the canvas", #PB_Window_SystemMenu | #PB_Window_SizeGadget | #PB_Window_ScreenCentered)
    g=1
    CanvasGadget(g,  10,10,200,140, #PB_Canvas_Keyboard)
    ...
    With *Button_0
      ...
      Widget(*Button_0, 270, 10,  60, 120, "Button (Vertical)", #__text_Center|#__text_Middle|#PB_Text_Border | #__text_Vertical)
    ...
    With *Button_1
      ...
      Widget(*Button_1, 10, 42, 250,  60, "Button (horizontal)", #PB_Text_Border)
