...
;                 Debug "string2 - "+Mid(*w\text\string[2], *w\items()\text\pos, 3)
               ...
               With *w 
                Debug Left(\Text\String.s, \Items()\Text\Pos-*w\items()\index) + \Items()\Text[1]\String.s
                Debug "----"
                Debug \Items()\Text[3]\String.s + Right(\Text\String.s, \Text\Len-((\Items()\Text\Pos-*w\items()\index)+\Items()\Text\Len))
                
                ;                 Debug Left(\Text\String.s[2], \Items()\Text\Pos) + \Items()\Text[1]\String.s
;                 Debug "----"
;                 Debug \Items()\Text[3]\String.s + Right(\Text\String.s[2], Len(\Text\String.s[2])-(\Items()\Text\Pos+\Items()\Text\Len))
               EndWith
