...
; ;         Next 
  ...
  Procedure.i Paste(*This.Widget_S, Chr.s, Count.i=0)
    Protected Repaint.i, String.s, Caret.i
...
;         ;           PushListPosition(\Items())
        If SelectElement(\Items(), \Index[2])
          ; String.s = Left(\Text\String.s, \Items()\Text\Pos+\Text\Caret) + Chr.s
          \Items()\Text[2]\Len = 0 : \Items()\Text[2]\String.s = "" : \Items()\Text[2]\change = 1
        EndIf   
        
        If SelectElement(\Items(), \Index[1])
          ; String.s + Right(\Text\String.s, \Text\Len-\Text[3]\Pos)
          ; String.s + Right(\Text\String.s, \Text\Len-(\Items()\Text\Pos+\Items()\Text[2]\Len))
          ; String.s + Mid(\Text\String.s, 1 + \Items()\Text\Pos+\Items()\Text[2]\Len)
         \Items()\Text[2]\Len = 0 : \Items()\Text[2]\String.s = "" : \Items()\Text[2]\change = 1
        EndIf
        ;           PopListPosition(\Items())
        ;Debug \Text[1]\String
        ...
        \Text[1]\Change = 1
        \Text[1]\String + Chr.s
        String.s = \Text[1]\String + \Text[3]\String
  ...
  Procedure.i ToReturn(*This.Widget_S) ; Ok
    ...
    With  *This
      If Not Paste(*This, #LF$)
        String.s = Left(\Text\String.s, \Items()\Text\Pos+\Text\Caret) + #LF$ +
                   Right(\Text\String.s, \Text\Len-(\Items()\Text\Pos+\Text\Caret))
