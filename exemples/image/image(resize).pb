...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If Not LoadImage(0, #PB_Compiler_Home + "examples/sources/Data/Background.bmp") ; world.png") ; File.bmp") ; Измените путь/имя файла на собственное изображение 32x32 пикселя
    End
  EndIf
  ...
  If OpenWindow(0, 0, 0, 222, 491, "ImageGadget", #PB_Window_SystemMenu | #PB_Window_SizeGadget | #PB_Window_ScreenCentered)
    ButtonGadget(100, 490-60,490-30,67,25,"~wrap")
    
    Define i,a,g 
    g = 0
    ImageGadget(g, 230, 10, 210, 210, 0)                                         
    SetGadgetState(g, ImageID(0))
...
;     EndMacro
    ...
    *g=Image(0, 0, 250, 150, -1, #__Flag_autosize|#__flag_borderless)
    SetState(*g, 0)
