...
DeclareModule Area
  ...
  Declare.l SetAttribute(*this._S_scroll, Attribute.l, Value.l)
  ...
  Declare.i Gadget(X.l,Y.l,Width.l,Height.l, ScrollAreaWidth.l, ScrollAreaHeight.l, ScrollStep.l, Flag.l, Radius.l=0)
EndDeclareModule
...
Module Area
  ...
  Procedure.l SetBarAttribute(*this._S_widget, Attribute.l, Value.l)
    Protected Result.l
  ...
  Procedure.l SetAttribute(*this._S_scroll, Attribute.l, Value.l)
    Protected Result.l
    ...
    With *this
      Select Attribute
        ...
        Case #PB_Area_Y
          SetState(\v, Value)
        Case #PB_Area_Width
          SetBarAttribute(\h, #PB_Bar_Maximum, Value)
        Case #PB_Area_Height
          SetBarAttribute(\v, #PB_Bar_Maximum, Value)
      EndSelect
    EndWith
  ...
  Procedure.b Updates(*scroll._S_scroll, ScrollArea_X, ScrollArea_Y, ScrollArea_Width, ScrollArea_Height)
    With *scroll
      ...
      If ScrollArea_Width <> #PB_Ignore And ScrollArea_Width<\h\page\pos+iWidth 
        ScrollArea_Width=\h\page\pos+iWidth
        ; Влево работает как надо
      ElseIf ScrollArea_X <> #PB_Ignore And ScrollArea_X>\h\page\pos And
             ScrollArea_Width=\h\page\pos+iWidth 
        ScrollArea_Width = iWidth 
      EndIf
      
      ; Вниз работает как надо
      If ScrollArea_Height <> #PB_Ignore And ScrollArea_Height<\v\page\pos+iHeight
        ScrollArea_Height=\v\page\pos+iHeight 
        ; Верх работает как надо
      ElseIf ScrollArea_Y <> #PB_Ignore And ScrollArea_Y>\v\page\pos And
             ScrollArea_Height=\v\page\pos+iHeight 
        ScrollArea_Height = iHeight 
      EndIf
      
      If ScrollArea_X <> #PB_Ignore And ScrollArea_X>0 : ScrollArea_X=0 : EndIf
      If ScrollArea_Y <> #PB_Ignore And ScrollArea_Y>0 : ScrollArea_Y=0 : EndIf
      
      If ScrollArea_X <> #PB_Ignore And ScrollArea_X<-\h\page\pos : ScrollArea_Width-ScrollArea_X : EndIf
      If ScrollArea_Y <> #PB_Ignore And ScrollArea_Y<-\v\page\pos : ScrollArea_Height-ScrollArea_Y : EndIf
      
      If ScrollArea_Height <> #PB_Ignore And \v\max<>ScrollArea_Height : SetBarAttribute(\v, #PB_ScrollBar_Maximum, ScrollArea_Height) : EndIf
      If ScrollArea_Width <> #PB_Ignore And \h\max<>ScrollArea_Width : SetBarAttribute(\h, #PB_ScrollBar_Maximum, ScrollArea_Width) : EndIf
      
      If \v\page\len<>iHeight : SetBarAttribute(\v, #PB_ScrollBar_PageLength, iHeight) : EndIf
      If \h\page\len<>iWidth : SetBarAttribute(\h, #PB_ScrollBar_PageLength, iWidth) : EndIf
      
      If ScrollArea_Y <> #PB_Ignore And ScrollArea_Y<-\v\page\pos : SetState(\v, (ScrollArea_Height-ScrollArea_Y)-ScrollArea_Height) : EndIf
      If ScrollArea_X <> #PB_Ignore And ScrollArea_X<-\h\page\pos : SetState(\h, (ScrollArea_Width-ScrollArea_X)-ScrollArea_Width) : EndIf
  ...
  Procedure.b Resizes(*scroll._S_scroll, X.l,Y.l,Width.l,Height.l )
    With *scroll
      ...
      If \v\width And \v\page\len<>iHeight : SetBarAttribute(\v, #PB_ScrollBar_PageLength, iHeight) : EndIf
      If \h\height And \h\page\len<>iWidth : SetBarAttribute(\h, #PB_ScrollBar_PageLength, iWidth) : EndIf
  ...
  Procedure.i Bar(X.l,Y.l,Width.l,Height.l, Min.l, Max.l, PageLength.l, Flag.l, Radius.l=0)
    ...
    With *this
      ...
      If \min <> Min : SetBarAttribute(*this, #PB_Bar_Minimum, Min) : EndIf
      If \max <> Max : SetBarAttribute(*this, #PB_Bar_Maximum, Max) : EndIf
      If \page\len <> Pagelength : SetBarAttribute(*this, #PB_Bar_PageLength, Pagelength) : EndIf
    EndWith
  ...
  Procedure.i Gadget(X.l,Y.l,Width.l,Height.l, ScrollAreaWidth.l, ScrollAreaHeight.l, ScrollStep.l, Flag.l, Radius.l=0)
    Protected *this._S_scroll = AllocateStructure(_S_scroll)
    
    With *this
      \v = Bar(X,Y,Width,Height, 0, ScrollAreaHeight, Height, Flag|#PB_Bar_Vertical, Radius)
      \h = Bar(Y,X,Height,Width, 0, ScrollAreaWidth, Width, Flag, Radius)
    EndWith
...
CompilerIf #PB_Compiler_IsMainFile
    ...
    Select EventType
      Case #PB_EventType_LeftButtonUp
        ...
        If (ScrollX<0 Or ScrollY<0)
          ...
          ScrollX-*scroll\h\page\pos
          ScrollY-*scroll\v\page\pos
    ...
    Else
      Select EventType
        ...
        Case #PB_EventType_Resize : ResizeGadget(Canvas, #PB_Ignore, #PB_Ignore, #PB_Ignore, #PB_Ignore) ; Bug (562)
          ...
          If *scroll\width<>ScrollWidth : SetAttribute(*scroll, #PB_Area_Width, ScrollWidth) : EndIf
          If *scroll\h<>ScrollHeight : SetAttribute(*scroll, #PB_Area_Height, ScrollHeight) : EndIf
  ...
  *Scroll = Gadget(0, 0,  20, 0, 0, 0, 1, 0, 9)
  
  ;   *Scroll\v = GetAttribute(*Scroll, #PB_Bar_Vertical)
  ;   *Scroll\h = GetAttribute(*Scroll, #PB_Bar_Horizontal)
