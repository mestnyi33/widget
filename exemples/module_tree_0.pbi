...
Module tree
          ...
          *This\Scroll\height=*This\y[2]
          ...
          ForEach *This\Items()
            If Not \hide
              ...
              x_content=\x+(Bool(*This\Flag\Buttons=0)*w+\sublevel*w)-*This\hScroll\Page\Pos-1
  ...
  Procedure.i _1Draw(*This.Widget_S)
      ...
      With *This\Items()
        If ListSize(*This\Items())
          ...
          *This\sublevellen = 18
            ...
            ; Draw coordinates 
            \sublevellen = (12 - *This\sublevellen) + ((\sublevel+Bool(Not *This\Flag\Buttons))**This\sublevellen) + Bool(*This\Flag\CheckBoxes)*12
      ...
      With *This\Items()
        If ListSize(*This\Items())
          ...
          *This\sublevellen = 18
          ...
          EndIf
            ; Draw coordinates 
           ; \sublevellen = ((\sublevel+Bool(Not *This\Flag\Buttons))**This\sublevellen) - *This\sublevellen/2 + Bool(*This\Flag\CheckBoxes)*13 ; (\sublevel**This\sublevellen) + (Bool(\childrens)**This\sublevellen);((\sublevel+Bool(Not *This\Flag\Buttons))**This\sublevellen) + Bool(*This\Flag\CheckBoxes)*15
    ...
    If Not *This\Hide
      ...
      With *This\Items()
        If ListSize(*This\Items())
          ...
          *This\sublevellen = 14
            ; Draw coordinates 
            \sublevellen = *This\sublevellen/2+((\sublevel+Bool(Not *This\Flag\Buttons))**This\sublevellen/2) - *This\sublevellen/2 + Bool(*This\Flag\CheckBoxes)*13 ; (\sublevel**This\sublevellen) + (Bool(\childrens)**This\sublevellen);((\sublevel+Bool(Not *This\Flag\Buttons))**This\sublevellen) + Bool(*This\Flag\CheckBoxes)*15
    ...
    If Not *This\Hide
      ...
      With *This\Items()
        If ListSize(*This\Items())
          ...
          *This\sublevellen = 8
            ; Draw coordinates 
            \sublevellen = 6+((\sublevel+Bool(Not *This\Flag\Buttons))**This\sublevellen) - *This\sublevellen/2 + Bool(*This\Flag\CheckBoxes)*13 ; (\sublevel**This\sublevellen) + (Bool(\childrens)**This\sublevellen);((\sublevel+Bool(Not *This\Flag\Buttons))**This\sublevellen) + Bool(*This\Flag\CheckBoxes)*15
...
;           CompilerEndIf 
        ...
        If Bool(Not \flag\Buttons Or Not \flag\Lines)
