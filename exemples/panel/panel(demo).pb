...
Procedure events_widgets()
   Debug ""+Str(*event\widget\index - 1)+ " - gadget  event - " +*event\type
EndProcedure
...
; Shows using of several panels...
  ;If Open(OpenWindow(#PB_Any, 0, 0, 322 + 322, 220, "PanelGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered))
