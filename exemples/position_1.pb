        ...
        If *this\parent <> *Parent
          ...
          *this\parent = *Parent
          ...
          If Not *this\root\first 
            ...
            ; *this\root\first = *this
          Else
            If Not *this\root\first\after
             *this\root\first\after = *this
             *this\before = *this\root\first
             EndIf
           
            If *this\root\last
              *this\root\last\after = *this
              *this\before = *this\root\last
           EndIf
            
            ; If *this\root <> *this\parent
            If Not *this\root\after
              *this\root\after = *this\before
              ; *this\parent\before = *this;\parent
            EndIf
            ; EndIf
...
CompilerIf #PB_Compiler_IsMainFile
      ...
      Select Position
        Case #PB_List_First  
          If *this\parent
            ...
            ;               EndIf
            ;             Wend 
            ProcedureReturn *this\parent\first
          Else
            Result = FirstElement(GetChildrens(*this))
          EndIf
  ...
  Procedure.i _2GetPosition(*this._s_widget, Position.l)
    ...
    Select Position
      Case #PB_List_First 
        ...
        If *this\root\last = *this
          *this\root\last = *this\before
          *this\before\after = 0
          
          *this\after = *this\root\first
      ...
      Case #PB_List_After 
        *next._s_widget = *this\after ; _GetPosition(*this, #PB_List_After)
