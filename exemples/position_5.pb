...
;             EndIf
            ...
            If *this\before
               Debug "first - "+*before\index+" "+*this\before\index
            ...
            *this\before           = *before\before 
            ...
            get_pos_string(*this)
            Debug ""
            get_pos_string(*this\parent\first)
          EndIf
        ...
        Case #PB_List_Before 
          ...
          If *before
            ...
            Debug " before "+*before\index+" "+*this\before\index
            If *this\before
              *this\before\after   = *this\after
            EndIf
        ...
        Case #PB_List_After 
          ...
          If *after
            *Last = GetParentLast(*after)
            ...
            Debug " after "+*after\index+" "+*this\after\index
            If *this\after
