...
;       EndIf
  ...
  Procedure.b CallBack(*This.Bar_S, EventType.i)
    Protected repaint
        ...
        If \Type = #PB_GadgetType_ScrollBar
          ...
          Else
            ...
            If \Vertical
              If \s\h\buttons
                If \Color[2]\State
                  repaint | Events(*This, #PB_EventType_MouseLeave, \buttons)
          ...
          If *Scroll = *This
            If Last <> \Buttons
              ...
              If Last > 0 Or (Last = 2 And \Buttons =- 1 And *Last)
                repaint | Events(*This, #PB_EventType_MouseLeave, Last) : *Last = 0
              EndIf
              If Not \Buttons Or (Last = 2 And \Buttons =- 1 And *Last)
                repaint | Events(*This, #PB_EventType_MouseLeave, - 1) : *Last = 0
              EndIf
              
              If Not last ; Or (Last =- 1 And \Buttons = 2 And *Last)
                repaint | Events(*This, #PB_EventType_MouseEnter, - 1)
              EndIf
              If \Buttons > 0
                repaint | Events(*This, #PB_EventType_MouseEnter, \Buttons)
              EndIf
            ...
            Select EventType 
              Case #PB_EventType_LeftButtonDown
                If \Buttons
                  Down = \Buttons
                  repaint | Events(*This, EventType, \Buttons)
                EndIf
                
              Case #PB_EventType_LeftButtonUp 
                If Down
                  repaint | Events(*This, EventType, Down)
                EndIf
