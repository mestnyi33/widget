    ...
    With *Scroll
      If Not \Hide And \Alpha
        ...
        If \Thumb\len
          ...
          BoxGradient(\Vertical,\button[3]\x,\button[3]\y,\button[3]\width,\button[3]\height,\Color[3]\Fore,\Color[3]\Back, \Radius, \Alpha)
          
          ; Draw thumb frame
          DrawingMode(#PB_2DDrawing_Outlined|#PB_2DDrawing_AlphaBlend)
          RoundBox(\button[3]\x,\button[3]\y,\button[3]\width,\button[3]\height,\Radius,\Radius,\Color[3]\Frame&$FFFFFF|\Alpha<<24)
        EndIf
        
        If \button\len
          ; Draw buttons
          DrawingMode(#PB_2DDrawing_Gradient|#PB_2DDrawing_AlphaBlend)
          BoxGradient(\Vertical,\button[1]\x,\button[1]\y,\button[1]\width,\button[1]\height,\Color[1]\Fore,\Color[1]\Back, \Radius, \Alpha)
          BoxGradient(\Vertical,\button[2]\x,\button[2]\y,\button[2]\width,\button[2]\height,\Color[2]\Fore,\Color[2]\Back, \Radius, \Alpha)
          
          ; Draw buttons frame
          DrawingMode(#PB_2DDrawing_Outlined|#PB_2DDrawing_AlphaBlend)
          RoundBox(\button[1]\x,\button[1]\y,\button[1]\width,\button[1]\height,\Radius,\Radius,\Color[1]\Frame&$FFFFFF|\Alpha<<24)
          RoundBox(\button[2]\x,\button[2]\y,\button[2]\width,\button[2]\height,\Radius,\Radius,\Color[2]\Frame&$FFFFFF|\Alpha<<24)
          
          ; Draw arrows
          DrawingMode(#PB_2DDrawing_Default|#PB_2DDrawing_AlphaBlend)
          Arrow(\button[1]\x+(\button[1]\width-6)/2,\button[1]\y+(\button[1]\height-3)/2, 3, Bool(\Vertical), \Color[1]\Line&$FFFFFF|\Alpha<<24)
          Arrow(\button[2]\x+(\button[2]\width-6)/2,\button[2]\y+(\button[2]\height-3)/2, 3, Bool(\Vertical)+2, \Color[2]\Line&$FFFFFF|\Alpha<<24)
        EndIf
        
        ; Draw thumb lines
        DrawingMode(#PB_2DDrawing_Default|#PB_2DDrawing_AlphaBlend)
        If \Vertical
          Line(\button[3]\x+(\button[3]\width-8)/2,\button[3]\y+\button[3]\height/2-3,9,1,\Color[3]\Line&$FFFFFF|\Alpha<<24)
          Line(\button[3]\x+(\button[3]\width-8)/2,\button[3]\y+\button[3]\height/2,9,1,\Color[3]\Line&$FFFFFF|\Alpha<<24)
          Line(\button[3]\x+(\button[3]\width-8)/2,\button[3]\y+\button[3]\height/2+3,9,1,\Color[3]\Line&$FFFFFF|\Alpha<<24)
        Else
          Line(\button[3]\x+\button[3]\width/2-3,\button[3]\y+(\button[3]\height-8)/2,1,9,\Color[3]\Line&$FFFFFF|\Alpha<<24)
          Line(\button[3]\x+\button[3]\width/2,\button[3]\y+(\button[3]\height-8)/2,1,9,\Color[3]\Line&$FFFFFF|\Alpha<<24)
          Line(\button[3]\x+\button[3]\width/2+3,\button[3]\y+(\button[3]\height-8)/2,1,9,\Color[3]\Line&$FFFFFF|\Alpha<<24)
        EndIf
