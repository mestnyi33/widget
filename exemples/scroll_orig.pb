          ...
          Select from
            Case - 1
              If *Thisis = *This
                ...
                \from = 3
              EndIf
            Case 1 : Result = SetState(*This, (\page\pos - \scrollstep))
            Case 2 : Result = SetState(*This, (\page\pos + \scrollstep))
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  Procedure _CallBack()
    ...
    With *scroll
      ...
      If CallBack(\v, EventType(), MouseX, MouseY) : Repaint = #True : EndIf
      If CallBack(\h, EventType(), MouseX, MouseY) : Repaint = #True : EndIf
