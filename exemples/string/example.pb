...
;     OpenList(0,10)
    ...
    *S_3 = String(8,  85, 290, height, "LOWERCASE...", #PB_Flag_Double|#PB_Text_LowerCase)
    *S_4 = String(8, 110, 290, height, "uppercase...", #PB_Flag_Raised|#PB_Text_UpperCase)
    *S_5 = String(8, 135, 290, height, "Borderless & read-only StringGadget", #PB_String_BorderLess|#PB_Text_ReadOnly)
    *S_6 = String(8, 160, 290, height, "Password", #PB_Text_Password)
    *S_7 = String(8, 185, 290, height, "")
    
;     For i=0 To 30
;       String(8, 185-i*3, 290, height, "")
;     Next
