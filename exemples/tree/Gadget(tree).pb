...
;     BindGadgetEvent(g, @Events())
    ...
    g = 10
    Gadget(g, 10, 230, 210, 210, #PB_Tree_CheckBoxes|#PB_Flag_FullSelection)                                         
    *g = GetGadgetData(g)
...
;     Debug Str(ElapsedMilliseconds()-time) + " - add widget items time count - " + CountItems(*g)
    ...
    AddItem(*g, 3, "Tree_2_1", -1, 1) 
    AddItem(*g, 4, "Tree_2_2", -1, 2) 
    ...
    g = 11
    Gadget(g, 230, 230, 210, 210, #PB_Flag_FullSelection)                                         
    *g = GetGadgetData(g)
    ;  3_example
    ...
    g = 12
    Gadget(g, 450, 230, 210, 210, #PB_Flag_FullSelection|#PB_Flag_CheckBoxes |#PB_Flag_NoLines|#PB_Flag_NoButtons )    ;                                
    *g = GetGadgetData(g)
    ;   ;  2_example
    ;   AddItem (*g, 0, "Normal Item "+Str(a), -1, 0)                                    
    ...
    g = 13
    Gadget(g, 670, 230, 210, 210, #PB_Tree_NoLines)                                         
    *g = GetGadgetData(g)
    ;  4_example
    ...
    g = 14
    Gadget(g, 890, 230, 103, 210, #PB_Tree_NoButtons)                                         
    *g = GetGadgetData(g)
    ;  5_example
    AddItem(*g, 0, "Tree_0 (NoButtons)", -1 )
    AddItem(*g, 1, "Tree_1", -1, 1) 
    ...
    g = 15
    Gadget(g, 890+106, 230, 103, 210);, #PB_Flag_BorderLess)                                         
    *g = GetGadgetData(g)
    ;  6_example
