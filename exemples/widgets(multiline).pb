...
;
CompilerIf #PB_Compiler_OS = #PB_OS_MacOS 
  IncludePath "/Users/as/Documents/Widget"
...
CompilerIf Not Defined(structures, #PB_Module)
  DeclareModule structures
    ...
    Structure _s_widget 
      ...
      *gadget._s_widget ; this\canvas\gadget\gadget ; root\active\gadget
      *window._s_widget ; this\canvas\gadget\window ; root\active\window
...
Module Widget
      ...
      If ListSize(*this_item())
        ...
        If State >= 0 And SelectElement(*this_item(), State) 
          ...
          ElseIf *this\index[#__s_2] <> State : *this_item()\color\state = 2
            ...
            CallBack(*this, #__Event_Change, *this\root\mouse\x, *this\root\mouse\y)
          EndIf
  ...
  Procedure.i Draw_window(*this._s_widget)
    With *this 
      If \__height
        ...
        DrawingMode(#PB_2DDrawing_Default|#PB_2DDrawing_AlphaBlend)
        RoundBox(\caption\button[1]\x, \caption\button[1]\y, \caption\button[1]\width, \caption\button[1]\height, \caption\round, \caption\round, $FF0000FF&$FFFFFF|\color[1]\alpha<<24)
        RoundBox(\caption\button[2]\x, \caption\button[2]\y, \caption\button[2]\width, \caption\button[2]\height, \caption\round, \caption\round, $FFFF0000&$FFFFFF|\color[2]\alpha<<24)
        RoundBox(\caption\button[3]\x, \caption\button[3]\y, \caption\button[3]\width, \caption\button[3]\height, \caption\round, \caption\round, $FF00FF00&$FFFFFF|\color[3]\alpha<<24)
        
        ; Draw caption frame
        If \fs And \color\frame
          DrawingMode(#PB_2DDrawing_Outlined|#PB_2DDrawing_AlphaBlend)
          RoundBox(\caption\button[0]\x, \caption\button[0]\y, \caption\button[0]\width, \caption\button[0]\height, \round, \round, \color\frame&$FFFFFF|\color\alpha<<24)
        EndIf
      EndIf
    EndWith
  EndProcedure
  ...
  Procedure.i Draw(*this._s_widget, Childrens=0)
    ...
    With *this
      ...
      If \text And (\text\change Or (\resize And *this\text\multiline =- 1))
        *this\text\change = 1
          ...
          ForEach \childrens() 
            ...
            If \childrens()\root\event And 
               (\childrens()\root\event\type = #PB_All Or
                \childrens()\root\event\type = #__Event_repaint)
              
              SetOrigin(\childrens()\x,\childrens()\y)
              Post(#__Event_repaint, \childrens())
              SetOrigin(0,0)
            EndIf
          Next
        EndIf
      ...
      If \scroll
        DrawingMode(#PB_2DDrawing_Outlined|#PB_2DDrawing_AlphaBlend)
        ; Scroll area coordinate
        Box(\x[2]+*this\scroll\x, \y[2]+*this\scroll\y, \scroll\width, \scroll\height, $FF0000FF) ; + \text\y*2 - \flag\gridlines), $FF0000FF)
  ...
  Procedure.i SetActive(*this._s_widget)
    ...
    Macro _set_active_state_(_active_, _state_)
      ...
      If Not(_active_ = _active_\root And _active_\root\type =- 5)
        If (_state_)
          CallBack(_active_, #__Event_Focus, _active_\root\mouse\x, _active_\root\mouse\y)
        Else
      ...
      If _active_\gadget
        ...
        If (_state_)
          CallBack(_active_\gadget, #__Event_Focus, _active_\root\mouse\x, _active_\root\mouse\y)
        Else
          CallBack(_active_\gadget, #__Event_LostFocus, _active_\root\mouse\x, _active_\root\mouse\y)
        EndIf
      EndIf
    EndMacro
        ...
        If GetActive()\gadget <> *this
          ...
          Else
            If GetActive()\gadget
              ...
              CallBack(GetActive()\gadget, #__Event_LostFocus, GetActive()\root\mouse\x, GetActive()\root\mouse\y)
            EndIf
            
            GetActive()\gadget = *this
            GetActive()\gadget\color\state = #__s_2
            CallBack(GetActive()\gadget, #__Event_Focus, GetActive()\root\mouse\x, GetActive()\root\mouse\y)
          EndIf
  ...
  Procedure.i Resize(*this._s_widget, X.l,Y.l,Width.l,Height.l)
    ...
    If *this > 0
      With *this
        ; #__flag_autoSize
        If \parent And \parent\type <> #__Type_Splitter And \align And \align\autoSize And \align\left And \align\top And \align\right And \align\bottom
          X = 0; \align\width
          Y = 0; \align\height
        ...
        Select \type
          ...
          Case #__Type_Window
            ...
            \caption\y = \y+\bs
            \caption\width = \width[#__c_2]
            \caption\height = \__height-\fs
            
            ; caption frame
            \caption\button[0]\x = \caption\x-1
            \caption\button[0]\y = \caption\y-1
            \caption\button[0]\width = \caption\width+2
            \caption\button[0]\height = \caption\height+2
            
            ; caption close button
            \caption\button[1]\width = 12
            \caption\button[1]\height = 12
            \caption\button[1]\x = \x[#__c_2]+\width[#__c_2]-\caption\button[1]\width-5
            \caption\button[1]\y = \y+\bs+(\caption\height-\caption\button[1]\height)/2
            
            ; caption minimize button
            \caption\button[2]\width = \caption\button[1]\width
            \caption\button[2]\height = \caption\button[1]\height
            \caption\button[2]\x = \caption\button[1]\x-Bool(Not \caption\button[2]\hide) * \caption\button[2]\width-5
            \caption\button[2]\y = \caption\button[1]\y
            
            ; caption maximize button
            \caption\button[3]\width = \caption\button[1]\width
            \caption\button[3]\height = \caption\button[1]\height
            \caption\button[3]\x = \caption\button[2]\x-Bool(Not \caption\button[3]\hide) * \caption\button[3]\width-5
            \caption\button[3]\y = \caption\button[1]\y
        ...
        If Not _is_root_(*this) And \parent 
          ...
          If \parent\scroll 
            If \parent\scroll\v : clip_v = Bool(\parent\width=\parent\width[#__c_4] And Not \parent\scroll\v\hide And \parent\scroll\v\type = #__Type_ScrollBar)*\parent\scroll\v\width : EndIf
            If \parent\scroll\h : clip_h = Bool(\parent\height=\parent\height[#__c_4] And Not \parent\scroll\h\hide And \parent\scroll\h\type = #__Type_ScrollBar)*\parent\scroll\h\height : EndIf
          EndIf
  ...
  Procedure.i Splitter(X.l,Y.l,Width.l,Height.l, First.i, Second.i, Flag.i=0)
    ...
    *this = bar_create(0, 7, 0, Max, 0, Auto|Vertical|#__bar_buttonSize, 0)
    ...
    _set_last_parameters_(*this, #__Type_Splitter, Flag, Root()\opened) 
    
    With *this
      \container = #__Type_Splitter
      \bar\button\len = 7
      \bar\thumb\len = 7
  ...
  Procedure.i CloseList()
    ...
    If Root()\opened\parent And Root()\opened\root\canvas\gadget = Root()\canvas\gadget ;And Root()\opened\parent\parent <> Root()\parent
      ...
      Else
        Select eventtype
          ...
          Case #__Event_Focus,
            ...
            ;case #__Event_leftButtonUp : Repaint = 1 : delta = 0  : Repaint | w_Events(*this, EventType, at)
  ...
  Procedure g_callback()
    ...
    ElseIf EventType = #__Event_MouseMove
      ...
      If root()\mouse\buttons And Not root()\mouse\drag And
        ...
        root()\mouse\drag = 1
        repaint | CallBack(root()\entered, #__Event_DragStart, mouse_x, mouse_y)
      EndIf
      ...
      *this = From(root(), mouse_x, mouse_y)
      ...
      If root()\entered And root()\entered <> *this And root()\entered\state <> #__s_0 ; And Not (*this\parent And *this\parent\scroll)
        ...
        If Not root()\mouse\buttons
          Repaint | CallBack(root()\entered, #__Event_MouseLeave, mouse_x, mouse_y)
        EndIf
      EndIf
      ...
      If *this And *this\state <> #__s_1 ; And Not (*this\parent And *this\parent\scroll)
        *this\state = #__s_1
        ...
        Else
          Repaint | CallBack(root()\entered, #__Event_MouseEnter, mouse_x, mouse_y)
        EndIf
      EndIf
    EndIf
    ...
    If root()\mouse\buttons
      ...
      If Not root()\mouse\buttons
        ...
        If DD::EventDrop(Root()\entered, #__Event_LeftButtonUp)
          Debug 4444
          CallBack(Root()\entered, #__Event_drop, mouse_x, mouse_y)
        EndIf
        ...
        If GetActive() 
          If GetActive()\state
            If Not root()\mouse\drag
              Repaint | CallBack(GetActive(), #__Event_LeftClick, mouse_x, mouse_y)
            EndIf
          Else
            Repaint | CallBack(GetActive(), #__Event_MouseLeave, mouse_x, mouse_y)
            Repaint | CallBack(root()\entered, #__Event_MouseEnter, mouse_x, mouse_y)
          EndIf
          ...
          If GetActive()\gadget
            If GetActive()\gadget\state
              If Not root()\mouse\drag
                Repaint | CallBack(GetActive()\gadget, #__Event_LeftClick, mouse_x, mouse_y)
              EndIf
            Else
              Repaint | CallBack(GetActive()\gadget, #__Event_MouseLeave, mouse_x, mouse_y)
              Repaint | CallBack(root()\entered, #__Event_MouseEnter, mouse_x, mouse_y)
            EndIf
          EndIf
        EndIf
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If OpenWindow(0, 0, 0, 908, (height+5)*5+20+110, "Buttons on the canvas", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    *S_3 = (Gadget(3, 8+150,  10, 140, height, text_h,                  #__flag_gridlines|#__button_multiline|#__string_center|#__text_top|#__string_readonly))
    *S_4 = (Gadget(4, 8+150,  (height+5)*1+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__string_center))
    *S_5 = (Gadget(5, 8+150,  (height+5)*2+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__string_center|#__text_bottom))
    
    *S_6 = (Gadget(6, 8+300,  10, 140, height, text_h,                  #__flag_gridlines|#__button_multiline|#__string_right|#__text_top|#__string_readonly))
    *S_7 = (Gadget(7, 8+300,  (height+5)*1+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__string_right))
    *S_8 = (Gadget(8, 8+300,  (height+5)*2+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__string_right|#__text_bottom))
    
    
    *S_10 = (Gadget(10, 8+450,  10, 140, height, text_h,                   #__flag_gridlines|#__button_multiline|#__text_invert|#__text_left|#__text_top))
    *S_11 = (Gadget(11, 8+450,  (height+5)*1+10, 140, height, text_h,      #__flag_gridlines|#__button_multiline|#__text_invert|#__text_left))
    *S_12 = (Gadget(12, 8+450,  (height+5)*2+10, 140, height, text_h,      #__flag_gridlines|#__button_multiline|#__text_invert|#__text_left|#__text_bottom))
    
    *S_13 = (Gadget(13, 8+150+450,  10, 140, height, text_h,              #__flag_gridlines|#__button_multiline|#__text_invert|#__string_center|#__text_top|#__string_readonly))
    *S_14 = (Gadget(14, 8+150+450,  (height+5)*1+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__text_invert|#__string_center))
    *S_15 = (Gadget(15, 8+150+450,  (height+5)*2+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__text_invert|#__string_center|#__text_bottom))
    
    *S_16 = (Gadget(16, 8+300+450,  10, 140, height, text_h,              #__flag_gridlines|#__button_multiline|#__text_invert|#__string_right|#__text_top|#__string_readonly))
    *S_17 = (Gadget(17, 8+300+450,  (height+5)*1+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__text_invert|#__string_right))
    *S_18 = (Gadget(18, 8+300+450,  (height+5)*2+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__text_invert|#__string_right|#__text_bottom))
    
    
    
    *S_20 = (Gadget(20, 8,  (height+5)*3+10, 140, height, text_h,          #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_left|#__text_top))
    *S_21 = (Gadget(21, 8,  (height+5)*4+10, 140, height, text_h,          #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_left))
    *S_22 = (Gadget(22, 8,  (height+5)*5+10, 140, height, text_h,          #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_left|#__text_bottom))
    
    *S_23 = (Gadget(23, 8+150,  (height+5)*3+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_center|#__text_top|#__string_readonly))
    *S_24 = (Gadget(24, 8+150,  (height+5)*4+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_center))
    *S_25 = (Gadget(25, 8+150,  (height+5)*5+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_center|#__text_bottom))
    
    *S_26 = (Gadget(26, 8+300,  (height+5)*3+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_right|#__text_top|#__string_readonly))
    *S_27 = (Gadget(27, 8+300,  (height+5)*4+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_right))
    *S_28 = (Gadget(28, 8+300,  (height+5)*5+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_right|#__text_bottom))
    
    
    *S_30 = (Gadget(30, 8+450,  (height+5)*3+10, 140, height, text_h,      #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__text_left|#__text_top))
    *S_31 = (Gadget(31, 8+450,  (height+5)*4+10, 140, height, text_h,      #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__text_left))
    *S_32 = (Gadget(32, 8+450,  (height+5)*5+10, 140, height, text_h,      #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__text_left|#__text_bottom))
    
    *S_33 = (Gadget(33, 8+150+450,  (height+5)*3+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_center|#__text_top|#__string_readonly))
    *S_34 = (Gadget(34, 8+150+450,  (height+5)*4+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_center))
    *S_35 = (Gadget(35, 8+150+450,  (height+5)*5+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_center|#__text_bottom))
    
    *S_36 = (Gadget(36, 8+300+450,  (height+5)*3+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_right|#__text_top|#__string_readonly))
    *S_37 = (Gadget(37, 8+300+450,  (height+5)*4+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_right))
    *S_38 = (Gadget(38, 8+300+450,  (height+5)*5+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_right|#__text_bottom))
