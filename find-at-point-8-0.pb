...
Procedure ReDrawWidget( *this.widget )
  If *this\address
    ...
    ForEach *this\canvas\child( )
      DrawWidget( *this\canvas\child( ), 0,0 )
    Next
    StopDrawing( )
  EndIf
EndProcedure
...
Procedure AddWidget( *this.widget, x,y,width,height)
  LastElement( *this\canvas\child( ) )
  *this\canvas\child( )\address = AddElement( *this\canvas\child( ) )
  
  If *this\canvas\child( )\address
    SetParentWidget( *this\canvas\child( ), *this )
    ResizeWidget( *this\canvas\child( ), x,y,width,height )
  EndIf
EndProcedure
