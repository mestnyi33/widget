...
DeclareModule Gadget
   ...
   CompilerIf #PB_Compiler_OS = #PB_OS_Windows
      ...
      Macro ResizeGadget(_gadget_, _x_,_y_,_width_,_height_)
         ResizeGadget_(_gadget_, _x_,_y_,_width_,_height_)
      EndMacro
      ...
      ;   Declare ResizeGadget_(_x_,_y_,_width_,_height_)
   ...
   Module Gadget
      ...
      ;   ;  ProcedureReturn widget::AddColumn(widget::gadgets(), Position, Title$, Width)
      ;   EndProcedure
      ...
      Procedure SetGadgetItemAttribute_(Gadget, Item, Attribute, Value, Column=0) ; no
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ;         ProcedureReturn widget::SetItemAttribute(widget::gadgets(), Item, Attribute, Value, Column)
            Else
      ...
      Procedure SetGadgetItemColor_(Gadget, Item, ColorType, Color, Column=0)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::SetItemColor(widget::gadgets(), Item, ColorType, Color, Column)
            Else
      ...
      Procedure SetGadgetItemData_(Gadget, Item, Value) ; no
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ;         ProcedureReturn widget::SetItemData(widget::gadgets(), Item, Value)
            ElseIf Gadget
      ...
      Procedure SetGadgetItemFont_(Gadget, Item, FontID)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::SetItemFont(widget::gadgets(), Item, FontID)
            Else
      ...
      Procedure SetGadgetItemImage_(Gadget, Item, ImageID)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::SetItemImage(widget::gadgets(), Item, IDImage(ImageID))
            Else
      ...
      Procedure SetGadgetItemState_(Gadget, Position, State)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::SetItemState(widget::gadgets(), Position, State)
            Else
      ...
      Procedure SetGadgetItemText_(Gadget, Position, Text$, Column=0)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::SetItemText(widget::gadgets(), Position, Text$, Column)
            Else
      ...
      Procedure SetGadgetState_(Gadget, State)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::SetState(widget::gadgets(), State)
            Else
      ...
      Procedure SetGadgetText_(Gadget, Text$)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::SetText(widget::gadgets(), Text$)
            Else
      ...
      Procedure GetGadgetAttribute_(Gadget, Attribute)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::GetAttribute(widget::gadgets(), Attribute)
            Else
      ...
      Procedure GetGadgetColor_(Gadget, ColorType) ; no
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ;         ProcedureReturn widget::GetColor(widget::gadgets(), ColorType)
            Else
      ...
      Procedure GetGadgetData_(Gadget) ; no
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ;         ProcedureReturn widget::GetData(widget::gadgets())
            Else
               ProcedureReturn widget::gadgets()
            EndIf
         ElseIf Gadget
      ...
      Procedure GetGadgetFont_(Gadget)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::GetFont(widget::gadgets())
            Else
      ...
      Procedure GetGadgetItemAttribute_(Gadget, Item, Attribute, Column=0)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::GetItemAttribute(widget::gadgets(), Item, Attribute, Column)
            Else
      ...
      Procedure GetGadgetItemColor_(Gadget, Item, ColorType, Column=0)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::GetItemColor(widget::gadgets(), Item, ColorType, Column)
            Else
      ...
      Procedure GetGadgetItemData_(Gadget, Item) ; no
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ;         ProcedureReturn widget::GetItemData(widget::gadgets(), Item)
            Else
      ...
      Procedure GetGadgetItemImage_(Gadget, Item)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::GetItemImage(widget::gadgets(), Item)
            Else
      ...
      Procedure GetGadgetItemState_(Gadget, Position)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::GetItemState(widget::gadgets(), Position)
            Else
      ...
      Procedure.s GetGadgetItemText_(Gadget, Position, Column=0)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::GetItemText(widget::gadgets(), Position, Column)
            Else
      ...
      Procedure GetGadgetState_(Gadget)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::GetState(widget::gadgets())
            Else
      ...
      Procedure.s GetGadgetText_(Gadget)
         If PB(IsGadget)(Gadget)
            If widget::gadgets(Str(Gadget))
               ProcedureReturn widget::GetText(widget::gadgets())
            Else
