      ...
      With *this
        ...
        *this\color = _get_colors_( )
        ...
        If *this\type = #__type_Splitter
          ...
          *this\bar\button.allocate( BUTTONS, [#__split_1] )
          *this\bar\button.allocate( BUTTONS, [#__split_2] )
          *this\bar\button.allocate( BUTTONS, [#__split_3] )
...
;                 ChangeCurrentElement( enumWidget( ), EnteredWidget( )\address )
;                 Repeat                 
;                   If enumWidget( )\state\enter And 
;                      IsChild( EnteredWidget( ), enumWidget( ))
;                     DoEvents( enumWidget( ), #PB_EventType_MouseMove )
;                   EndIf
