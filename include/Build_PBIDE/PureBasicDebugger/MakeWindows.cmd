...
Echo.
Echo --------------------------------------------------------------------------------------
If Exist "%PUREBASIC_HOME%/Compilers/PBDebugger.exe" (
    Echo PBDebugger.exe Successfully Created in %PUREBASIC_HOME%/Compilers
) else (
    Echo PBDebugger.exe Compilation Failure! 
)
Echo --------------------------------------------------------------------------------------
