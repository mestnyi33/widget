...
Procedure W_IH_Open(ParentID.i=0, Flag.i=#PB_Window_TitleBar|#PB_Window_ScreenCentered)
  ...
  G_IH_View = Image(i, i, 271, 225, (0),#__flag_ImageCenter) 
  SetBackgroundColor( G_IH_View, $FFB3FDFF )
  ;CloseList( )
  G_IH_Open = Button(i+271+ii, i, 101, 25, "Open", #__flag_Imageleft )       : SetImage(G_IH_Open, (0))
  G_IH_Save = Button(i+271+ii, i+30, 101, 25, "Save", #__flag_Imageleft )      : SetImage(G_IH_Save, (1))
  G_IH_Copy = Button(i+271+ii, i+70, 101, 25, "Copy", #__flag_Imageleft )      : SetImage(G_IH_Copy, (2))
  G_IH_Cut = Button(i+271+ii, i+100, 101, 25, "Cut", #__flag_Imageleft )        : SetImage(G_IH_Cut, (3))
  G_IH_Paste = Button(i+271+ii, i+130, 101, 25, "Paste", #__flag_Imageleft )   : SetImage(G_IH_Paste, (4)) 
