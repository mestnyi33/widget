...
If OpenWindow(#Window, 0, 0, ww, hw, "TabBarGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
	...
	ButtonGadget (#btnCount, 10, 30, 300, 30, "Количество вкладок")
	ButtonGadget (#btnClear, 10, 70, 300, 30, "Удалить все вкладки")
	ButtonGadget (#btnFree, 10, 110, 300, 30, "Удалить гаджет")
	CloseGadgetList()
