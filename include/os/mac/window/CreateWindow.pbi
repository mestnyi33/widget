DeclareModule Window
   Declare OpenRoot( window, x, y, width, height, title.s, flags.q = 0, parentID = 0 )
   Declare Close( WindowID.i )
   Declare WaitCloseRoot( )
EndDeclareModule
...
Module Window
   ...
   Procedure OpenRoot( window, x, y, width, height, title.s, flags.q = 0, parentID = 0 )
...
CompilerIf #PB_Compiler_IsMainFile
   ...
   win1 = OpenRoot( 1, 0,0,400,100, "window1", #PB_Window_SystemMenu )
   ButtonGadget(1,0,0,400,100,"window1")
   
   win2 = OpenRoot( 2, 100,100,400,100, "window2", #PB_Window_ScreenCentered|#PB_Window_SizeGadget )
   ButtonGadget(2,0,0,400,100,"window2")
   
   win3 = OpenRoot( 3, 100,100,400,100, "window3", #PB_Window_WindowCentered|#PB_Window_SystemMenu, win2 )
