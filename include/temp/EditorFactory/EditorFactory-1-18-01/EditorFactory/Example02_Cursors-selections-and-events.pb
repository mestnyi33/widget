...
; Callback procedure to draw on the object. Runtime keyword is needed here!
...
SetCursorSelectionStyle(#Canvas, #SelectionStyle_Solid|#SelectionStyle_Partially, RGBA(0, 128, 255, 255), 1, RGBA(0, 128, 255, 50)) 
			...
			Case #Event_Object ; It is an object event
				...
				Select CanvasObjectsEventType(#Canvas) ; What type of events happened on the object?
					...
					Case #EventType_Created
						Debug "Object #" + EventObject(#Canvas) + " has been created."
					Case #EventType_Freed
						Debug "Object #" + EventObject(#Canvas) + " has been released."
				EndSelect
			...
			Case #Event_Handle ; It is a handle event
				...
				Select CanvasObjectsEventType(#Canvas) ; What type of events happened on the handle ?
					...
					Case #EventType_LeftMouseButtonHold
						Debug "The left mouse button is held on the Handle #" + EventHandle(#Canvas) + " on the Object #" + EventObject(#Canvas)
					Case #EventType_MiddleMouseBottonDown
					...
					Case #EventType_MiddleMouseButtonHold
						Debug "The middle mouse button is held on the Handle #" + EventHandle(#Canvas) + " on the Object #" + EventObject(#Canvas)
					Case #EventType_RightMouseBottonDown
					...
					Case #EventType_MiddleMouseButtonHold
						Debug "The right mouse button is held on the Handle #" + EventHandle(#Canvas) + " on the Object #" + EventObject(#Canvas)
					Case #EventType_MouseWheel
						If CanvasObjectsEventData(#Canvas) > 0
