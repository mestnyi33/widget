...
Procedure DrawAPanel(Object.i, Width.i, Height.i, iData.i)
	Protected FrameText.s = "Panel number "+Str(VisibleObjectFrame(Object))
...
SetObjectBoundaries(#Object_Default, 0, 32, #Boundary_ParentSize, #Boundary_ParentSize) ; Set the boundaries to the parent size for the next created objects.
...
CreateObject(#Canvas, #Object6, 150, 150, 140, 100, #Object4, 2) ; Attach object 6 directly to object 1 into the second frame
CreateObject(#Canvas, #Object7, 100, 100, 100, 150, #Object4, 3) ; Attach object 6 directly to object 1 into the third frame

SetObjectBoundaries(#Object_Default, #Boundary_None, #Boundary_None, #Boundary_None, #Boundary_None) ; Set the boundaries to the parent size for the next created objects.
...
SetObjectFrameClipping(#Object8, #True, 0, 0, 24, 24) ; Set the clipping of the drawing of child objects and clip 24 px more on the right and bottom side.
SetObjectFrameOffset(#Object8, 0, -100)  ; Set the clipping offset to (0, -100), so that at the beginning all childs are shifted 100px up.

SetObjectDrawingCallback(#Object_Default, @DrawAnObject(), RGB(64, 128, 0))

; Attach some objects to #Object8
CreateObject(#Canvas, #PB_Any, 50, 50, 100, 100, #Object8)
CreateObject(#Canvas, #PB_Any, 200, 50, 100, 100, #Object8) 
CreateObject(#Canvas, #PB_Any, 50, 300, 100, 100, #Object8)
CreateObject(#Canvas, #PB_Any, 200, 300, 100, 100, #Object8)
				...
				Select CanvasObjectsEventType(#Canvas) ; What type of Events happened on the Handle ?
					Case #EventType_LeftMouseClick
						If EventObject(#Canvas) = #Object4 ; Panel container
							...
							EndIf
						ElseIf EventObject(#Canvas) = #Object8 ; Scroll area
							; Here the currently shown clip is changed.
							If EventHandle(#Canvas) = #Handle_Custom1
								SetObjectFrameOffset(#Object8, 0, 25, #PB_Relative)
							EndIf
							If EventHandle(#Canvas) = #Handle_Custom2
								SetObjectFrameOffset(#Object8, 0, -25, #PB_Relative)
							EndIf
							If EventHandle(#Canvas) = #Handle_Custom3
								SetObjectFrameOffset(#Object8, 25, 0, #PB_Relative)
							EndIf
