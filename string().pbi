...
;                   EndIf
  ...
  Procedure.i Create(type.l, X.l, Y.l, Width.l, Height.l, Text.s, Flag.i=0, round.i=0)
    ...
    If *this
      ...
      \scroll\v = widget::Bar(#PB_GadgetType_ScrollBar, *this, 0,0,0,0, 0,0,0, 16, #PB_ScrollBar_Vertical, 7)
      \scroll\h = widget::Bar(#PB_GadgetType_ScrollBar, *this, 0,0,0,0, 0,0,0, 16, 0, 7)
