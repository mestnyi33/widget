...
;     Widgets("F_Button_0") = Button(10, 50, 100, 30, "Button_0", #PB_Flag_AnchorsGadget)
;     Widgets("Fo_Button_0") = Button(10, 10, 100, 30, "Button_0", #PB_Flag_AnchorsGadget)
;     Widgets("Fjo_Button_0") = Button(10, 10, 100, 30, "Button_0", #PB_Flag_AnchorsGadget)
;     Widgets("For_Button_0") = Button(10, 10, 100, 30, "Button_0", #PB_Flag_AnchorsGadget)
;     AddItem(Widgets("Panel_0"), -1, "Form")
;     Widgets("F_Biuiuutton_0") = Button(10, 50, 100, 30, "Button_0", #PB_Flag_AnchorsGadget)
;     Widgets("Fyooo_Button_0") = Button(10, 10, 100, 30, "Button_0", #PB_Flag_AnchorsGadget)
    AddItem(Widgets("Panel_0"), -1, "Form")
    ...
    Widgets("Container_0") = Container(60, 160, 210, 210, #PB_Flag_AnchorsGadget) : *Widget = Widgets("Container_0")  : SetImage(*Widget, 5)
...
;     While Enumerate(@*Parent, Widgets("Panel_0"), 2)
;       Debug *Parent\Type
;       
;       ;If *Parent\Container > 0
;         While Enumerate(@*Widget, *Parent)
;           Debug *Widget\Type;Text\String
;         Wend
;       ;EndIf
;       
;     Wend
    ...
    Widgets("Tree_1") = Tree(0, 0, 80, 30, #PB_Flag_NoButtons|#PB_Flag_NoLines)
    LoadControls(Widgets("Tree_1"))
    SetState(Widgets("Tree_1"), 1)
    Widgets("Text_0") = Text(0, 0, 80, 30, "Тут будет инфо о виджете")
    Widgets("Splitter_00") = Splitter(1,1,778, 548, Widgets("Tree_1"), Widgets("Text_0"), #PB_Flag_AutoSize)
    SetState(Widgets("Splitter_00"), 450)
