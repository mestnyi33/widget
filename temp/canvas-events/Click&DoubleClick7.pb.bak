        ...
        If Window
          ...
          If lastView <> View 
            If lastView And FindMapElement( IDGadget( ), Str(lastView) )
             ; PostEvent( #PB_Event_Gadget, EventWindow(), IDGadget( ), #PB_EventType_MouseLeave, IDGadget( ) )
              Debug ""+IDGadget( ) + " #PB_EventType_MouseLeave " 
            EndIf
            
            lastView = View 
            If FindMapElement( IDGadget( ), Str(View) )
              ;Debug "eventTapFunction - "+Window +" "+ contentView +" "+ IDGadget( ) +" "+ EventGadget()
              ; PostEvent( #PB_Event_Gadget, EventWindow(), EventGadget(), #PB_EventType_MouseEnter, IDGadget( ) )
...
;       Debug ""+EventGadget() + " #PB_EventType_MouseLeave " +EventData()
;     EndIf
  EndIf
