               ...
               If \Text[2]\Len
                  ...
                  CompilerIf #PB_Compiler_OS = #PB_OS_MacOS
                     ...
                     If \text\string.s
                       ...
                       ; DrawRotatedText( \Text\X, \Text\Y, \Text\string.s, rotate, $0B0B0B )
                     EndIf
                     ...
                     If ( \Text\CaretPos > \Text\CaretPos[1] )
                        ...
                        If \Text[2]\string.s
                           DrawRotatedText( \Text[2]\X, \Text\Y, \Text[2]\string.s, rotate, $FFFFFF )
                        EndIf
                        
                        ; to left select
                     Else
                        If \Text[2]\string.s
                           DrawRotatedText( \Text\X, \Text\Y, \Text[1]\string.s + \Text[2]\string.s, rotate, $FFFFFF )
                        EndIf
                        
                        If \Text[1]\string.s
                           DrawRotatedText( \Text\X, \Text\Y, \Text[1]\string.s, rotate, $0B0B0B )
                        EndIf
                     EndIf
