; Debug #PB_MessageRequester_YesNoCancel  ; 3
; Debug #PB_MessageRequester_YesNo        ; 4
; Debug #PB_MessageRequester_Yes          ; 6
; Debug #PB_MessageRequester_Error        ; 16
; Debug #PB_MessageRequester_Warning      ; 48
; Debug #PB_MessageRequester_Info         ; 64
; 
; Debug ""
; Debug #PB_MessageRequester_Ok           ; 0
; Debug #PB_MessageRequester_Cancel       ; 2
; Debug #PB_MessageRequester_No           ; 7
; 
; ;MessageRequester(
;-
...
Procedure Message( Title.s, Text.s, flag.q, *parent )
  ...
  If Flag & #PB_MessageRequester_Info
    img = ImageID(CatchImage( #PB_Any, ?img_info, ?end_img_info - ?img_info ))
  ...
  If Flag & #PB_MessageRequester_Error
    img = ImageID(CatchImage( #PB_Any, ?img_error, ?end_img_error - ?img_error ))
  ...
  If Flag & #PB_MessageRequester_Warning
    img = ImageID(CatchImage( #PB_Any, ?img_warning, ?end_img_warning - ?img_warning ))
