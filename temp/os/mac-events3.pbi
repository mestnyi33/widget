...
;       EndMacro
      ...
      Procedure Event_Gadget( )
        ...
        If EventType( ) = #PB_EventType_Focus
          ...
          If IsGadget( GetActiveGadget )  And GetActiveGadget( ) =  event_gadget
...
;               PostEvent( #PB_Event_Gadget , event_window, GetActiveGadget, #PB_EventType_LostFocus, NSEvent )
;               PostEvent( #PB_Event_Repaint , event_window, GetActiveGadget, EventType( ), NSEvent )
;             EndIf
;             
;             Debug 8888
