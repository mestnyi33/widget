DeclareModule Macros
  ...
  Macro Keyboard( ): canvasaddress: EndMacro
  Macro FocusedWidget( ): canvasaddress\activeWidget: EndMacro ; Returns keyboard focus widget
...
DeclareModule String
  ...
  Declare.i Events(*this, EventType.i, Canvas.i=-1, CanvasModifiers.i=-1)
  ...
  Procedure CallBacks()
    ...
    Select EventType
      ...
      Default
        ...
        Select EventType
          Case #PB_EventType_Input 
            Keyboard( )\input = GetGadgetAttribute(canvasaddress\Gadget, #PB_Canvas_Input)
            Keyboard( )\key[1] = GetGadgetAttribute(canvasaddress\Gadget, #PB_Canvas_Modifiers)
          Case #PB_EventType_KeyDown
            Keyboard( )\key = GetGadgetAttribute(canvasaddress\Gadget, #PB_Canvas_Key)
            Keyboard( )\key[1] = GetGadgetAttribute(canvasaddress\Gadget, #PB_Canvas_Modifiers)
          Case #PB_EventType_MouseEnter, #PB_EventType_MouseMove, #PB_EventType_MouseLeave
            mouse( )\X = GetGadgetAttribute(canvasaddress\Gadget, #PB_Canvas_MouseX)
            mouse( )\Y = GetGadgetAttribute(canvasaddress\Gadget, #PB_Canvas_MouseY)
          Case #PB_EventType_LeftButtonDown, #PB_EventType_LeftButtonUp, 
               #PB_EventType_MiddleButtonDown, #PB_EventType_MiddleButtonUp, 
               #PB_EventType_RightButtonDown, #PB_EventType_RightButtonUp
            
            mouse( )\Buttons = GetGadgetAttribute(canvasaddress\Gadget, #PB_Canvas_Buttons)
        EndSelect
          ...
          ForEach List()
            ...
            If mouse( )\From
              If EventType = #PB_EventType_LeftButtonDown
                ...
                EndIf
                FocusedWidget( ) = List()\Widget
                FocusedWidget( )\focus = 1
              EndIf
              
              If Events(List()\Widget, EventType) 
                Result = 1
              EndIf
            EndIf
          Next
