...
If OpenWindow(0, 0, 0, 460, 400, "CanvasGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
  CanvasGadget(#GADGET_Canvas, 10, 10, 380, 380, #PB_Canvas_ClipMouse|#PB_Canvas_Keyboard)
        ...
        Case #GADGET_Canvas
          ...
          Select EventType()
            ...
            Case #PB_EventType_KeyDown
              Debug "KeyDown "+GetGadgetAttribute( #GADGET_Canvas, #PB_Canvas_Key )
              
            Case #PB_EventType_KeyUp
              Debug "KeyUp "+GetGadgetAttribute( #GADGET_Canvas, #PB_Canvas_Key )
