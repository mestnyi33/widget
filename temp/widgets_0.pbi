...
Module Widget
  ...
  *Bar\Type =- 1
  ...
  Procedure.i Draw_Progress(*This.Bar_S)
    Protected Alpha.i
  ...
  Procedure.i Draw_Splitter(*This.Bar_S)
  ...
  Procedure.i Draw_Scroll(*This.Bar_S)
  ...
  Procedure.i Draw_Track(*This.Bar_S)
    With *This 
      Protected i, a = 3
      DrawingMode(#PB_2DDrawing_Default)
  ...
  Procedure.i Draw_ScrollArea(*This.Bar_S)
    Protected Alpha.i
  ...
  Procedure.i Draw_Button(*This.Bar_S)
    With *This
  ...
  Procedure.i Draw_Image(*This.Bar_S)
    With *This 
      \Image\y =- \s\v\Page\Pos+\y+2
      \Image\x =- \s\h\Page\Pos+\x+2
      ...
      If \Color\Frame<>-1
        DrawingMode(#PB_2DDrawing_Outlined)
        RoundBox( \X, \Y, \Width, \Height, \Radius, \Radius, \Color\Frame)
      EndIf
  ...
  Procedure.i ScrollArea(X.i,Y.i,Width.i,Height.i, ScrollAreaWidth.i, ScrollAreaHeight.i, ScrollStep.i=1, Flag.i=0)
    ...
    With *This
      ...
      \s\v = Scroll(#PB_Ignore,#PB_Ignore,Size,#PB_Ignore, 0,ScrollAreaHeight,Height, #PB_Bar_Vertical, 7)
      \s\h = Scroll(#PB_Ignore,#PB_Ignore,#PB_Ignore,Size, 0,ScrollAreaWidth,Width, 0, 7)
...
;     EndWith
  ...
  Procedure.i Image(X.i,Y.i,Width.i,Height.i, Image.i, Flag.i=0)
    Protected *This.Bar_S, Size = 16
    *This = AllocateStructure(Bar_S)
    ...
    With *This
      ...
      \s\v = Scroll(#PB_Ignore,#PB_Ignore,Size,#PB_Ignore, 0,\Image\height,Height, #PB_Bar_Vertical, 7)
      \s\h = Scroll(#PB_Ignore,#PB_Ignore,#PB_Ignore,Size, 0,\Image\width,Width, 0, 7)
      Resize(*This, X.i,Y.i,Width.i,Height)
    EndWith
