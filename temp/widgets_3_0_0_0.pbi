...
Module Widget
  ...
  *Value = AllocateStructure(Post_S)
  *Value\Type =- 1
        ...
        If ListSize(\items())
          ...
          ForEach \items()
            If Not \items()\hide
              ...
              Drawing = Bool( \Items()\change And \items()\y+\items()\height>\y+\bs And \items()\y<\y+\height-\bs*2)
              If Drawing
                ; Draw selections
  ...
  Procedure.i CallBack(*This.Widget_S, EventType.i, MouseScreenX.i=0, MouseScreenY.i=0)
    ...
    With *This
      If *This > 0 And \color\alpha And Not \hide ;: \Repaint = 1
