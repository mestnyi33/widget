...
Module Editor
  ...
  Procedure.s text_wrap_(*this._s_widget, text$, softWrapPosn.i, hardWrapPosn.i=-1, delimList$=" "+Chr(9), nl$=#LF$, liStart$="")
    ; ## Main function ##
  ...
  Procedure.i make_text_multiline(*this._s_widget)
    ...
    With *this
      ...
      If \text\multiline
        text = *this\text\string
        
        If *this\text\multiline =- 1
          text+#LF$
        EndIf
        
        text = make_text_wrap(*this, text, Width-\text\padding*2, \text\multiline)
      Else
