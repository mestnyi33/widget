...
;           RoundBox(\x[#__c_1]+\fs-1,
;                    \y[#__c_1]+\caption\height-1,
;                    \width[#__c_1]-\fs*2+2,
;                    \height[#__c_1]-\fs-\caption\height+2,
;                    \round,\round,\color\frame[\color\state])
          
                 RoundBox(\x[#__c_2]-1, \y[#__c_2]-1, \draw\width[#__c_2], \draw\height[#__c_2], \round,\round,\color\frame[\color\state])
        EndIf
      ...
      With *this
        ...
        If Width <> #PB_Ignore 
          ...
          If \width <> Width 
            ...
            \draw\width[#__c_2] = \width[#__c_2] + 2
            
            If \draw\width[#__c_2] < 0 
              \draw\width[#__c_2] = 0
            EndIf
        ...
        If Height <> #PB_Ignore 
          ...
          If \height <> Height 
            ...
            \draw\height[#__c_2] = \height[#__c_2] + 2
            
            If \draw\height[#__c_2] < 0 
              \draw\height[#__c_2] = 0
            EndIf
