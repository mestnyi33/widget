          ...
          Else
            For i=1 To \fs
              ...
              Else
                ...
                RoundBox(\x[#__c_1]+i-1, \y[#__c_1]+i-2, \width[#__c_1]-i*2+2, \height[#__c_1]-i*2+4, \round, \round, \caption\color\back[\color\state])
              EndIf
    ...
    With *this
      ...
      If \height > 0 And \width > 0 And Not \hide And Not (*this = \root And \width[#__c_4] > 0 And \height[#__c_4] > 0)
        ...
        If \color\back[\interact * \color\state]
          DrawingMode(#PB_2DDrawing_Default|#PB_2DDrawing_AlphaBlend)
          RoundBox(\x[#__c_2],\y[#__c_2],\width[#__c_2],\height[#__c_2],Bool(Not \fs)*\round,Bool(Not \fs)*\round,\color\back[\interact * \color\state])
        EndIf
...
;       Height + \__height + \fs*2
      ...
      If IsGadget(Root()\canvas)
        ...
        BindGadgetEvent(Root()\canvas, @CallBack())
      EndIf
    EndWith
