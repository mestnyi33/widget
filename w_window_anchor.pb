...
;       \flag\window\borderless = constants::_check_(flag, #__Window_BorderLess)
      ...
      *this\caption\button[2]\color\state = 1
      ...
      \fs = constants::_check_(flag, #__flag_borderless, #False) * 1;5
      \bs = \fs
        ...
        Case #__Event_LeftButtonDown,
          ...
          If eventtype = #__Event_LeftButtonDown
            Select \type
              ...
              Case #__Type_Window
                \frame[0]\interact = _from_point_(mouse_x, mouse_y, *this\caption, [2])
                ...
                ; maximize button
                If _from_point_(mouse_x, mouse_y, *this\caption\button[1])
                  If Not \resize & #__resize_maximize And
                     Not \resize & #__resize_minimize
                    If Not Post(#__Event_MaximizeWindow, *this)
                      ;If Not \resize & #__resize_minimize
                      ...
                      \resize | #__resize_maximize
                      
                      If _is_root_(*this)
                        PostEvent(#PB_Event_MaximizeWindow, \root\window, *this)
                      EndIf
                    EndIf
                  Else;If \resize & #__resize_maximize
                    If Not Post(#__Event_RestoreWindow, *this)
                      
                      If \resize & #__resize_minimize
                        \resize &~ #__resize_minimize
                        \caption\button[0]\hide = 0
                        \caption\button[2]\hide = 0
                      EndIf
                      \resize &~ #__resize_maximize
                      \resize | #__resize_restore
                      
                      Resize(*this, *this\root\x[#__c_3], *this\root\y[#__c_3], 
                             *this\root\width[#__c_3], *this\root\height[#__c_3])
                      
                      If _is_root_(*this)
                        PostEvent(#PB_Event_RestoreWindow, \root\window, *this)
                      EndIf
                    EndIf
                  EndIf
                EndIf
                  ...
                  If  Not \resize & #__resize_minimize
                    If Not Post(#__Event_MinimizeWindow, *this)
                      ...
                      *this\root\height[#__c_3] = *this\height
                      ...
                      \caption\button[0]\hide = 1
                      If \caption\button[1]\hide = 0
                        \caption\button[2]\hide = 1
                      EndIf
                    
                      Resize(*this, *this\root\x[#__c_3], *this\parent\height-*this\__height, 
                             *this\root\width[#__c_3], *this\__height)
                      
                      \resize | #__resize_minimize
                      
                      If _is_root_(*this)
                        PostEvent(#PB_Event_MinimizeWindow, \root\window, *this)
                      EndIf
                    EndIf
                  EndIf
                EndIf
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If Open(11, 0, 0, 720+60, 420+130, "Button on the canvas", #PB_Window_SystemMenu | #PB_Window_SizeGadget | #PB_Window_ScreenCentered|#__flag_anchorsgadget)
    c2 = GetGadget(Root())
    ...
    *f_11 = form(30, 130+10+130+130, 180,  120, "form_11", #PB_Window_MinimizeGadget|#PB_Window_MaximizeGadget)
