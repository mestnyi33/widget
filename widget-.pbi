...
Procedure DoWidgetEvents( *this.s_WIDGET, eventtype )
  ...
  If *this\count\items
    If Atbox( *this\draw\x+*this\fs, *this\draw\y+*this\fs, *this\draw\width-*this\fs*2, *this\draw\height-*this\fs*2, WidgetMouse( )\x, WidgetMouse( )\y )
      If eventtype = #PB_EventType_MouseMove
        If PressedItem( *this )
          If PressedItem( *this )\state & #__s_drag = 0
            PressedItem( *this )\state | #__s_drag
            PressedItem( *this )\state | #__s_repaint
      ...
      If eventtype = #PB_EventType_LeftButtonDown Or 
        ...
        If EnteredItem( *this )
          If FocusedItem( *this ) <> EnteredItem( *this )
            If FocusedItem( *this )
              FocusedItem( *this )\state &~ #__s_focus
              FocusedItem( *this )\state | #__s_repaint
          ...
          PressedItem( *this )\state | #__s_select
          PressedItem( *this )\state | #__s_repaint
          DoItemEvents( *this, PressedItem( *this ), eventtype )
        EndIf 
      EndIf
      ...
      If eventtype = #PB_EventType_LeftButtonUp Or 
        ...
        If PressedItem( *this )
          ...
          PressedItem( *this )\state | #__s_repaint
          DoItemEvents( *this, PressedItem( *this ), eventtype )
          If PressedItem( *this )\state & #__s_drag
            PressedItem( *this )\state &~ #__s_drag
            If EnteredItem( *this )
              EnteredItem( *this )\state | #__s_repaint
  ...
  If *this\state & #__s_enter
    If WidgetMouse( )\buttons
      If *this\state & #__s_drag
        *this\color\back = $000000
      Else
...
Procedure WidgetEvents( Canvas, eventtype )
  ...
  If eventtype = #PB_EventType_MouseMove Or
    ...
    If Root( )
      ...
      If eventtype = #PB_EventType_MouseMove
        If PressedWidget( )
          If PressedWidget( )\state & #__s_drag = 0
            PressedWidget( )\state | #__s_drag
        ...
        If EnteredWidget( )
          If FocusedWidget( ) <> EnteredWidget( )
            If FocusedWidget( )
              ...
              FocusedWidget( )\state | #__s_repaint
      ...
      If eventtype = #PB_EventType_LeftButtonUp Or 
        ...
        If PressedWidget( )
          ...
          Else
;             ; do enter events
;             Repaint | DoWidgetEvents( EnteredWidget( ), #PB_EventType_MouseEnter, WidgetMouse( )\x, WidgetMouse( )\y )
          EndIf
          
          If PressedWidget( )\state & #__s_drag
            PressedWidget( )\state &~ #__s_drag
            If EnteredWidget( )
              EnteredWidget( )\state | #__s_repaint
