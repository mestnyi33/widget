...
;-
Macro GetRootWidget( _canvas_gadget_address_ )
  *widget\root( Str( _canvas_gadget_address_ ) )
EndMacro
...
Procedure OpenWidget( window, gadget, x,y,width,height, flag = 0 )
  ...
  If Not FindMapElement( RootWidget( ), Str( GadgetID( gadget ) ) )
    ...
    RootWidget( ) = AllocateStructure( s_ROOT )
...
Procedure WidgetEvents( Canvas, eventtype )
  ...
  If eventtype = #PB_EventType_MouseEnter Or
    ...
    RootWidget( ) = GetRootWidget( GadgetID( Canvas ) ) 
  EndIf
  If eventtype = #PB_EventType_MouseEnter Or 
