    ...
    Procedure.b Events(*this._s_widget, EventType.l, mouse_x.l, mouse_y.l, Wheel_X.b=0, Wheel_Y.b=0)
      ...
      With *this
        ...
        If Not \hide And (_from_point_(mouse_x, mouse_y, *this) Or Down)
          If \bar\button 
            If \bar\button[#__b_3]\len And _from_point_(mouse_x, mouse_y-*this\y, \bar\button[#__b_3])
              from = #__b_3
            ElseIf \bar\button[#__b_2]\len And _from_point_(mouse_x, mouse_y-*this\y, \bar\button[#__b_2])
              from = #__b_2
            ElseIf \bar\button[#__b_1]\len And _from_point_(mouse_x, mouse_y-*this\y, \bar\button[#__b_1])
              from = #__b_1
            ElseIf _from_point_(mouse_x, mouse_y-*this\y, \bar\button[0])
              from = 0
            EndIf
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  Procedure OpenCanvasWindow(Window, X.i, Y.i, Width.i, Height.i, Title.s, Flag.i, ParentID.i)
    Protected w = OpenWindow(Window, X, Y, Width, Height, Title, Flag, ParentID) : If Window =- 1 : Window = w : EndIf
    Protected g_Canvas = CanvasGadget(#PB_Any, X.i, Y.i, Width.i, Height.i, #PB_Canvas_Container) ;: CloseGadgetList()
  ...
  Macro OpenWindow(Window, X, Y, Width, Height, Title, Flag=0, ParentID=0)
    OpenCanvasWindow(Window, X, Y, Width, Height, Title, Flag, ParentID)
  EndMacro
  
  If OpenWindow(0, 0, 0, 430+420, 450, "SplitterGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ;{
    ...
    ;{
    Button_0 = ButtonGadget(#PB_Any, 0, 0, 0, 0, "Button_0") ; as they will be sized automatically
    Button_1 = ButtonGadget(#PB_Any, 0, 0, 0, 0, "Button_1") ; as they will be sized automatically
    
    Button_2 = ButtonGadget(#PB_Any, 0, 0, 0, 0, "Button_2") ; No need to specify size or coordinates
    Button_3 = ButtonGadget(#PB_Any, 0, 0, 0, 0, "Button_3") ; as they will be sized automatically
    Button_4 = ButtonGadget(#PB_Any, 0, 0, 0, 0, "Button_4") ; No need to specify size or coordinates
    Button_5 = ButtonGadget(#PB_Any, 0, 0, 0, 0, "Button_5") ; as they will be sized automatically
    ...
    Button_0 = ButtonGadget(#PB_Any, 0, 0, 0, 0, "_Button 0") ; as they will be sized automatically
    Button_1 = ButtonGadget(#PB_Any, 0, 0, 0, 0, "_Button 1") ; as they will be sized automatically
    
    Button_2 = ButtonGadget(#PB_Any, 0, 0, 0, 0, "_Button 2") ; No need to specify size or coordinates
    Button_3 = ButtonGadget(#PB_Any, 0, 0, 0, 0, "_Button 3") ; as they will be sized automatically
    Button_4 = ButtonGadget(#PB_Any, 0, 0, 0, 0, "_Button 4") ; No need to specify size or coordinates
    Button_5 = ButtonGadget(#PB_Any, 0, 0, 0, 0, "_Button 5") ; as they will be sized automatically
                                                             ;CloseGadgetList()
