        ...
        If *this\type = #PB_GadgetType_TabBar 
          ...
          ;If *this\bar\thumb\len
            ...
            Else
              ...
              *this\bar\button[#__b_3]\width = *this\bar\max+*this\bar\area\len ; Round((*this\bar\area\len / (*this\bar\max-*this\bar\min)) * ((*this\bar\max-*this\bar\min) - *this\bar\page\len), #PB_Round_Nearest)
       ; *this\bar\max - *this\bar\area\len ; (*this\bar\button[#__b_1]\len+*this\bar\button[#__b_2]\len)                       
              *this\bar\button[#__b_3]\x = *this\bar\area\pos + _page_pos_(*this\bar, *this\bar\thumb\pos-*this\bar\area\len)
        ...
        If \bar\max >= \bar\page\len
          If #PB_GadgetType_TabBar = \type And \bar\thumb\pos = \bar\area\end And \bar\page\pos <> \bar\page\end And _in_stop_(\bar)
            ;    Debug " line-" + #PB_compiler_line +" "+  \bar\max 
            ;             If \bar\inverted
            ;              SetState(*this, _invert_(*this\bar, \bar\max, \bar\inverted))
            ;             Else
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If OpenWindow(0, 0, 0, 605+30, 140+200+140+140, "ScrollBarGadget", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    Button_1 = Bar::Tab(0, 0, 0, 0, 0, 100, 0); No need to specify size or coordinates
    ...
    Bar::SetAttribute(Button_1, #__bar_Maximum, 500)
...
; Folding = ---8---8-----08-0fv+0---r--u-8-v--f8-------u806----------------------
; EnableXP