    ...
    Procedure CallBack()
      ...
      If change
        ...
        If Root()\entered <> *this
          If Root()\entered And Not (#__from_mouse_state And _is_child(*this, Root()\entered))
