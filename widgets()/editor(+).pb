...
Module Editor
  ...
  Procedure _text_selected_(*this._struct_, _line_)
    Protected  _caret_last_len_
    
    If (*this\index[2] = *this\row\_s()\index Or _line_ = *this\row\_s()\index) Or    ; линия
       (*this\index[2] > *this\row\_s()\index And _line_ < *this\row\_s()\index) Or   ; верх
       (*this\index[2] < *this\row\_s()\index And _line_ > *this\row\_s()\index)      ; вниз
      
      _caret_last_len_ = Bool(*this\row\_s()\index < _line_ Or 
      ...
      If *this\index[1] = *this\index[2] 
        If *this\row\caret\stop > *this\row\caret\start
          ...
          *this\row\_s()\text[2]\len = *this\row\caret\stop - *this\row\_s()\text[1]\len
        Else
          *this\row\_s()\text[1]\len = *this\row\caret\stop 
          *this\row\_s()\text[2]\len = *this\row\caret\start - *this\row\_s()\text[1]\len
        EndIf
  ...
  Procedure _text_sel_set_(*this._struct_, _line_, _caret_) ; Ok
    ...
    If Repaint
      ...
      ForEach *this\row\_s()
        ...
        If _text_selected_(*this, _line_)
          If Repaint > 0
  ...
  Procedure _text_sel_update_(*this._struct_)
    ...
    If *this\index[2] = *this\row\_s()\index 
      *this\row\selected = *this\row\_s()
      ...
      ;       ;                     _text_sel_set_(*this, \row\_s()\index, \row\caret\start)
    ...
    _text_selected_(*this, *this\index[1])
