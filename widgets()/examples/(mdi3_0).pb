...
;   
  ...
  If ScrollWidth<*scroll\h\bar\page\Pos+iWidth
   ; ScrollWidth=*scroll\h\bar\page\Pos+iWidth
  EndIf
  
  If *scroll\h\bar\page\Pos > (*scroll\x-x)
  ;  ScrollWidth - (*scroll\x-x)
  EndIf
...
;   EndIf
 ...
 If *scroll\x< x
    Bar::SetState(*scroll\h, *scroll\h\bar\max-hMax)
  EndIf
  If *scroll\y < y 
