...
Module Widget
  ...
  Macro _line_resize_X_(_this_)
    If _this_\vertical
      If _this_\text\rotate = 90
        _this_\row\_s()\text\x = _x_ + _y2_
        
      ElseIf _this_\text\rotate = 270
        _this_\row\_s()\text\x = _x_ + (_width_ - _y2_)
      EndIf
      
    Else
      If _this_\text\rotate = 0
        If _this_\text\align\right
          _this_\row\_s()\text\x = _x_ + (_width_ - _this_\text\align\width - _this_\row\_s()\text\width - _this_\text\padding) 
        ElseIf _this_\text\align\horizontal
          _this_\row\_s()\text\x = _x_ + (_width_ - _this_\text\align\width - _this_\row\_s()\text\width)/2
        Else
  ...
  Macro _line_resize_Y_(_this_)
    If _this_\vertical
      If _this_\text\rotate = 90
        ...
        ElseIf _this_\text\align\vertical
          _this_\row\_s()\text\y = _y_ + (_height_ + _this_\text\align\height + _this_\row\_s()\text\width)/2
        Else
          _this_\row\_s()\text\y = _y_ + _this_\text\align\height + _this_\row\_s()\text\width + _this_\text\padding
        EndIf
    ...
    Else
      If _this_\text\rotate = 0
        _this_\row\_s()\text\y = _y_ + _y2_ 
        
      ElseIf _this_\text\rotate = 180
        _this_\row\_s()\text\y = _y_ + (_height_ - _y2_)
...
Macro _make_scroll_x_(_this_)
  ...
  Macro _make_scroll_y_(_this_)
    If _this_\text\align\bottom
      _this_\scroll\y = ((_this_\height - _this_\bs*2 - _this_\text\y*2 - _this_\flag\gridlines*2 - _this_\text\padding) - _this_\scroll\height) 
    ElseIf _this_\text\align\vertical
      _this_\scroll\y = (((_this_\height - _this_\bs*2 -_this_\text\y*2) - _this_\scroll\height)/2)
    Else
  ...
  ;   Macro _make_scroll_x_(_this_)
;     If (_this_\text\align\right) ;And Not (_this_\text\rotate = 90 Or _this_\text\rotate = 180)) Or (Not _this_\text\align\right And Not _this_\text\align\horizontal And (_this_\text\rotate = 90 Or _this_\text\rotate = 180))
;       If _this_\vertical
;         _this_\scroll\y = ((_this_\height - _this_\bs*2 - _this_\text\padding) - _this_\scroll\height)
;       Else
;         _this_\scroll\x = ((_this_\width - _this_\bs*2 - _this_\text\padding) - _this_\scroll\width)
;       EndIf
;       
;     ElseIf _this_\text\align\horizontal
;       If _this_\vertical
;         _this_\scroll\y = ((_this_\height - _this_\bs*2 + _this_\row\margin\width) - _this_\scroll\height - Bool(_this_\scroll\height % 2))/2 
;       Else
;         _this_\scroll\x = ((_this_\width - _this_\bs*2 + _this_\row\margin\width) - _this_\scroll\width - Bool(_this_\scroll\width % 2))/2 
;       EndIf
;       
;     Else
;       If _this_\vertical
;         _this_\scroll\y = _this_\row\margin\width + _this_\text\padding
;       Else
;         _this_\scroll\x = _this_\row\margin\width + _this_\text\padding
;       EndIf
;     EndIf
...
;   
;   Macro _make_scroll_y_(_this_)
;     If (_this_\text\align\bottom) ; And Not (_this_\text\rotate = 90 Or _this_\text\rotate = 180)) Or (Not _this_\text\align\bottom And Not _this_\text\align\vertical And (_this_\text\rotate = 90 Or _this_\text\rotate = 180))
;       ;If _this_\text\align\bottom ;And (_this_\text\rotate = 0 Or _this_\text\rotate = 180)
;       If _this_\vertical
;         _this_\scroll\x = ((_this_\width - _this_\bs*2 - _this_\text\y*2 - _this_\flag\gridlines*2 - _this_\text\padding) - (_this_\text\height*_this_\count\items)) 
;       Else
;         _this_\scroll\y = ((_this_\height - _this_\bs*2 - _this_\text\y*2 - _this_\flag\gridlines*2 - _this_\text\padding) - (_this_\text\height*_this_\count\items)) 
;       EndIf
;     ElseIf _this_\text\align\vertical
;       If _this_\vertical
;         _this_\scroll\x = (((_this_\width - _this_\bs*2 -_this_\text\y*2) - (_this_\text\height*_this_\count\items))/2)
;       Else
;         _this_\scroll\y = (((_this_\height - _this_\bs*2 -_this_\text\y*2) - (_this_\text\height*_this_\count\items))/2)
;       EndIf
;       
;     Else
;       If _this_\vertical
;         _this_\scroll\x = _this_\text\padding
;       Else
;         _this_\scroll\y = _this_\text\padding
;       EndIf
;     EndIf
        ...
        While *End\c 
          ...
          If *End\c = #LF And *str <> *End And AddElement(\row\_s())
            ...
            Protected _x_=*this\x[2] + *this\text\x, 
                      ...
                      _height_=*this\height[2]-*this\text\y*2, _y2_=Text_Y
            ...
            ;;;_text_change_(\row\_s(), *this\x, *this\y, *this\width, *this\height);, Text_Y)
            : Text_Y + \Text\Height
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If Open(0, 0, 0, 908, (height+5)*5+20+110, "Buttons on the canvas", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    *S_0 = (Gadget(-1, 8+150,  10, 140, height, text_h,                  #__flag_gridlines|#__button_multiline|#__string_center|#__text_top|#__string_readonly))
    *S_1 = (Gadget(-1, 8+150,  (height+5)*1+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__string_center))
    *S_2 = (Gadget(-1, 8+150,  (height+5)*2+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__string_center|#__text_bottom))
    
    *S_0 = (Gadget(-1, 8+300,  10, 140, height, text_h,                  #__flag_gridlines|#__button_multiline|#__string_right|#__text_top|#__string_readonly))
    *S_1 = (Gadget(-1, 8+300,  (height+5)*1+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__string_right))
    *S_2 = (Gadget(-1, 8+300,  (height+5)*2+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__string_right|#__text_bottom))
    
    
    *S_0 = (Gadget(0, 8+450,  10, 140, height, text_h,                   #__flag_gridlines|#__button_multiline|#__text_invert|#__text_top))
    *S_1 = (Gadget(1, 8+450,  (height+5)*1+10, 140, height, text_h,      #__flag_gridlines|#__button_multiline|#__text_invert))
    *S_2 = (Gadget(2, 8+450,  (height+5)*2+10, 140, height, text_h,      #__flag_gridlines|#__button_multiline|#__text_invert|#__text_bottom))
    
    *S_0 = (Gadget(-1, 8+150+450,  10, 140, height, text_h,              #__flag_gridlines|#__button_multiline|#__text_invert|#__string_center|#__text_top|#__string_readonly))
    *S_1 = (Gadget(-1, 8+150+450,  (height+5)*1+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__text_invert|#__string_center))
    *S_2 = (Gadget(-1, 8+150+450,  (height+5)*2+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__text_invert|#__string_center|#__text_bottom))
    
    *S_0 = (Gadget(-1, 8+300+450,  10, 140, height, text_h,              #__flag_gridlines|#__button_multiline|#__text_invert|#__string_right|#__text_top|#__string_readonly))
    *S_1 = (Gadget(-1, 8+300+450,  (height+5)*1+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__text_invert|#__string_right))
    *S_2 = (Gadget(-1, 8+300+450,  (height+5)*2+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__text_invert|#__string_right|#__text_bottom))
    
    

    *S_0 = (Gadget(0, 8,  (height+5)*3+10, 140, height, text_h,          #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_top))
    *S_1 = (Gadget(1, 8,  (height+5)*4+10, 140, height, text_h,          #__flag_gridlines|#__button_multiline|#__flag_vertical))
    *S_2 = (Gadget(2, 8,  (height+5)*5+10, 140, height, text_h,          #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_bottom))
    
    *S_0 = (Gadget(-1, 8+150,  (height+5)*3+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_center|#__text_top|#__string_readonly))
    *S_1 = (Gadget(-1, 8+150,  (height+5)*4+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_center))
    *S_2 = (Gadget(-1, 8+150,  (height+5)*5+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_center|#__text_bottom))
    
    *S_0 = (Gadget(-1, 8+300,  (height+5)*3+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_right|#__text_top|#__string_readonly))
    *S_1 = (Gadget(-1, 8+300,  (height+5)*4+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_right))
    *S_2 = (Gadget(-1, 8+300,  (height+5)*5+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_right|#__text_bottom))
    
    
    *S_0 = (Gadget(0, 8+450,  (height+5)*3+10, 140, height, text_h,      #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__text_top))
    *S_1 = (Gadget(1, 8+450,  (height+5)*4+10, 140, height, text_h,      #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert))
    *S_2 = (Gadget(2, 8+450,  (height+5)*5+10, 140, height, text_h,      #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__text_bottom))
    
    *S_0 = (Gadget(-1, 8+150+450,  (height+5)*3+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_center|#__text_top|#__string_readonly))
    *S_1 = (Gadget(-1, 8+150+450,  (height+5)*4+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_center))
    *S_2 = (Gadget(-1, 8+150+450,  (height+5)*5+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_center|#__text_bottom))
    
    *S_0 = (Gadget(-1, 8+300+450,  (height+5)*3+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_right|#__text_top|#__string_readonly))
    *S_1 = (Gadget(-1, 8+300+450,  (height+5)*4+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_right))
    *S_2 = (Gadget(-1, 8+300+450,  (height+5)*5+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_right|#__text_bottom))
