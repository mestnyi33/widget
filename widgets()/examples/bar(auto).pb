...
;   Protected WheelDelta = GetGadgetAttribute(EventGadget(), #PB_Canvas_WheelDelta)
  ...
  If Not Repaint And Bar::Callback()
...
; *scroll\v = Bar::scroll(0, y, 20, 0, 0, 0, Width-20, #__bar_Vertical|#__bar_inverted, 11)
; *scroll\h = Bar::scroll(x, 0, 0,  20, 0, 0, Height-20, #__bar_inverted, 11)
