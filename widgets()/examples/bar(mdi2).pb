...
Global x=150,y=150, Width=420, Height=420 , focus
...
Procedure ____Updates(*scroll._s_scroll, x.l, y.l, width.l, height.l)
...
Procedure ___Updates(*scroll._s_scroll, x.l, y.l, width.l, height.l)
  Protected r_width
  Protected r_height
...
Procedure _Updates(*scroll._s_scroll, x.l, y.l, width.l, height.l)
  ...
  Else
    *scroll\h\hide = #False
    *scroll\v\bar\page\len = height - *scroll\h\height
   ; *scroll\height = *scroll\v\bar\page\len
  EndIf
  
  If *scroll\height =< *scroll\v\bar\page\len - (*scroll\y-y)
    *scroll\v\hide = #True
    ;*scroll\h\bar\page\len = width
    *scroll\v\bar\max = *scroll\height
    *scroll\height = *scroll\v\bar\page\len - (*scroll\y-y)
  Else
    *scroll\v\hide = #False
    *scroll\h\bar\page\len = width - *scroll\v\width
   ; *scroll\width = *scroll\h\bar\page\len
  EndIf
  ...
  If *scroll\h\bar\page\len < width
  ; ; *scroll\v\bar\page\len = height - Bool(Not *scroll\h\hide) * *scroll\h\height
  ;  *scroll\v\hide = 0
  EndIf
  
  If *scroll\v\bar\page\len < height
   ; ; *scroll\h\bar\page\len = width - Bool(Not *scroll\v\hide) * *scroll\v\width
   ; *scroll\h\hide = 0
  EndIf
