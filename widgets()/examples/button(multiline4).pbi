...
;\row\_s()\y = Text_Y 
            ...
            \row\_s()\text\align = \text\align
            \row\_s()\text\rotate = \text\rotate
            \row\_s()\text\padding = \text\padding
...
;                 _line_resize_Y_(*this)
            ...
            ;If _this_\text\vertical
            If \row\_s()\text\rotate = 90
              ;                   If _y2_ < 0
              ;                     \row\_s()\text\x = _x_ + (_width_-\row\_s()\text\height)/2
              ;                   Else
              \row\_s()\text\x = _x_ + _y2_
              ;                   EndIf
              
              If \row\_s()\text\align\right
                \row\_s()\text\y = _y_ + \row\_s()\text\align\height+\row\_s()\text\width + \row\_s()\text\padding
              ElseIf \row\_s()\text\align\horizontal
                \row\_s()\text\y = _y_ + (_height_+\row\_s()\text\align\height+\row\_s()\text\width)/2
              Else
                \row\_s()\text\y = _y_ + _height_-\row\_s()\text\padding
              EndIf
              
            ElseIf \row\_s()\text\rotate = 270
              \row\_s()\text\x = _x_ + (_width_-_y2_)
              
              If \row\_s()\text\align\right
                \row\_s()\text\y = _y_ + (_height_-\row\_s()\text\width-\row\_s()\text\padding) 
              ElseIf \row\_s()\text\align\horizontal
                \row\_s()\text\y = _y_ + (_height_-\row\_s()\text\width)/2 
              Else
                \row\_s()\text\y = _y_ + \row\_s()\text\padding 
              EndIf
            ...
            ;Else
            If \text\rotate = 0
              \row\_s()\text\y = _y_ + _y2_ 
              
              If \text\align\right
                \row\_s()\text\x = _x_ + (_width_-\row\_s()\text\align\width-\row\_s()\text\width - \row\_s()\text\padding) 
              ElseIf \text\align\horizontal
                \row\_s()\text\x = _x_ + (_width_-\row\_s()\text\align\width-\row\_s()\text\width)/2
              Else
                \row\_s()\text\x = _x_ + \row\_s()\text\padding
              EndIf
              
            ElseIf \text\rotate = 180
              \row\_s()\text\y = _y_ + (_height_-_y2_)
              
              If \text\align\right
                \row\_s()\text\x = _x_ + \row\_s()\text\width + \row\_s()\text\padding 
              ElseIf \text\align\horizontal
                \row\_s()\text\x = _x_ + (_width_+\row\_s()\text\width)/2 
              Else
                \row\_s()\text\x = _x_ + _width_-\row\_s()\text\padding 
              EndIf
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If Open(0, 0, 0, 222+222+210, 205+70+222, "Buttons on the canvas", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    Button(230+210, 10, 200, 20, "Standard Button", #__flag_inverted, -1,8)
    Button(230+210, 40, 200, 20, "Left Button", #__flag_inverted|#__text_left)
    Button(230+210, 70, 200, 20, "Right Button", #__flag_inverted|#__text_right)
    Button(230+210,100, 200, 60, "multiline Button  (longer text gets automatically wrapped)", #__flag_inverted|#__text_wordwrap|#__button_Default, -1, 4)
    Button(230+210,170, 200, 60, "multiline Button  (longer text gets automatically multiline)", #__flag_inverted|#__text_multiline, -1, 4)
    Button(230+210,170+70, 200, 25, "Toggle Button", #__flag_inverted|#__button_toggle)
    
    
    
    
    Button(10, 230+45, 20, 200, "Standard Button", #__flag_vertical, -1,8)
    Button(40, 230+45, 20, 200, "Left Button", #__flag_vertical|#__text_left)
    Button(70, 230+45, 20, 200, "Right Button", #__flag_vertical|#__text_right)
    Button(100, 230+45,60, 200, "multiline Button  (longer text gets automatically wrapped)", #__flag_vertical|#__text_wordwrap|#__button_Default, -1, 4)
    Button(170, 230+45,60, 200, "multiline Button  (longer text gets automatically multiline)", #__flag_vertical|#__text_multiline, -1, 4)
    Button(170+70, 230+45,25, 200, "Toggle Button", #__flag_vertical|#__button_toggle)
    
    Button(10+265, 230+45, 20, 200, "Standard Button", #__flag_inverted|#__flag_vertical, -1,8)
    Button(40+265, 230+45, 20, 200, "Left Button", #__flag_inverted|#__flag_vertical|#__text_left)
    Button(70+265, 230+45, 20, 200, "Right Button", #__flag_inverted|#__flag_vertical|#__text_right)
    Button(100+265, 230+45,60, 200, "multiline Button  (longer text gets automatically wrapped)", #__flag_inverted|#__flag_vertical|#__text_wordwrap|#__button_Default, -1, 4)
    Button(170+265, 230+45,60, 200, "multiline Button  (longer text gets automatically multiline)", #__flag_inverted|#__flag_vertical|#__text_multiline, -1, 4)
    Button(170+70+265, 230+45,25, 200, "Toggle Button", #__flag_inverted|#__flag_vertical|#__button_toggle)
