...
Else
  If \text\rotate = 0
    If \text\align\right
      \row\_s()\text\x = _x_ + (_width_-\text\align\width-\row\_s()\text\width - \row\_s()\text\padding) 
    ElseIf \text\align\horizontal
      \row\_s()\text\x = _x_ + (_width_-\text\align\width-\row\_s()\text\width)/2
    Else
...
; ;     EndIf
    ...
    If \vertical
      If \text\rotate = 90
        If \text\align\right
          \row\_s()\text\y = _y_ + \text\align\height+\row\_s()\text\width + \row\_s()\text\padding
        ElseIf \text\align\horizontal
          \row\_s()\text\y = _y_ + (_height_+\text\align\height+\row\_s()\text\width)/2
        Else
