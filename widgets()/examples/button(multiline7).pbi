...
Module Widget
  ...
  Macro _line_resize_X_(_this_)
    If _this_\vertical
      If _this_\text\rotate = 90
        If _this_\text\align\right
          _this_\row\_s()\text\x = _x_ + (_width_ - _this_\scroll\width) ;  - _this_\row\_s()\height
        ElseIf _this_\text\align\horizontal
         _this_\row\_s()\text\x = _x_ + _this_\row\_s()\height + (_width_ + _this_\row\_s()\height)/2 - _this_\scroll\width
        Else
          _this_\row\_s()\text\x = _x_ + (_this_\scroll\width  - _this_\row\_s()\height)
        EndIf
        
      ElseIf _this_\text\rotate = 270
        If _this_\text\align\right
         _this_\row\_s()\text\x = _x_ + (_width_  + _this_\row\_s()\height - _this_\scroll\width)
        ElseIf _this_\text\align\horizontal
         _this_\row\_s()\text\x = _x_ + _this_\row\_s()\height + ((_width_ + _this_\row\_s()\height)/2 - (_this_\scroll\width - _this_\row\_s()\height)) ; (_width_-_y2_)
        Else
          _this_\row\_s()\text\x = _x_ + (_this_\scroll\width) + _this_\text\padding
        EndIf
      EndIf
  ...
  Macro _line_resize_Y_(_this_)
    ...
    Else
      ...
      ElseIf _this_\text\rotate = 180
        _this_\row\_s()\text\y = _y_ + (_y2_) + _this_\text\height 
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If Open(0, 0, 0, 615, (height+5)*8+20+110, "Buttons on the canvas", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    *S_0 = (Gadget(-1, 8+150,  10, 140, height, text_h,              #__flag_gridlines|#__button_multiline|#__string_right|#__text_top|#__string_readonly))
    *S_1 = (Gadget(-1, 8+150,  (height+5)*1+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__string_right))
    *S_2 = (Gadget(-1, 8+150,  (height+5)*2+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__string_right|#__text_bottom))
    
    
    *S_3 = (Gadget(3, 8,  (height+5)*3+10, 140, height, text_h,      #__flag_gridlines|#__button_multiline|#__string_center|#__string_uppercase))
    *S_3 = (Gadget(-1, 8+150,  (height+5)*3+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__string_center|#__text_invert|#__string_uppercase))
    
    
    *S_4 = (Gadget(4, 8, (height+5)*4+10, 140, height, text_v,       #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_top|#__string_lowercase))
    *S_5 = (Gadget(5, 8, (height+5)*5+10, 140, height, text_v,       #__flag_gridlines|#__button_multiline|#__flag_vertical|#__flag_borderless))
    *S_6 = (Gadget(6, 8, (height+5)*6+10, 140, height, text_v,       #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_bottom))
    
    *S_4 = (Gadget(-1, 8+150, (height+5)*4+10, 140, height, text_v,  #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_right|#__text_top|#__string_lowercase))
    *S_5 = (Gadget(-1, 8+150, (height+5)*5+10, 140, height, text_v,  #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_right|#__flag_borderless))
    *S_6 = (Gadget(-1, 8+150, (height+5)*6+10, 140, height, text_v,  #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_right|#__text_bottom))
  
    
    
    
    
    *S_10 = (Gadget(10, 305+8,  10, 140, height, text_h,                  #__flag_gridlines|#__button_multiline|#__string_readonly|#__text_top|#__text_invert))
    *S_11 = (Gadget(11, 305+8,  (height+5)*1+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__text_invert))
    *S_12 = (Gadget(12, 305+8,  (height+5)*2+10, 140, height, text_h,     #__flag_gridlines|#__button_multiline|#__text_bottom|#__text_invert))
    
    *S_10 = (Gadget(-1, 305+8+150,  10, 140, height, text_h,              #__flag_gridlines|#__button_multiline|#__string_readonly|#__text_top|#__string_right|#__text_invert))
    *S_11 = (Gadget(-1, 305+8+150,  (height+5)*1+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__string_right|#__text_invert))
    *S_12 = (Gadget(-1, 305+8+150,  (height+5)*2+10, 140, height, text_h, #__flag_gridlines|#__button_multiline|#__string_right|#__text_bottom|#__text_invert))
    
    
    *S_13 = (Gadget(13, 305+8,  (height+5)*3+10, 140, height, text_v,     #__flag_gridlines|#__button_multiline|#__flag_vertical|#__string_center|#__string_lowercase))
    *S_13 = (Gadget(13, 305+8+150,  (height+5)*3+10, 140, height, text_v, #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_center|#__string_lowercase))
    
    
    *S_14 = (Gadget(14, 305+8, (height+5)*4+10, 140, height, text_v,      #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__text_top))
    *S_15 = (Gadget(15, 305+8, (height+5)*5+10, 140, height, text_v,      #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__flag_borderless))
    *S_16 = (Gadget(16, 305+8, (height+5)*6+10, 140, height, text_v,      #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__text_bottom))
     
    *S_14 = (Gadget(-1, 305+8+150, (height+5)*4+10, 140, height, text_v,  #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_right|#__text_top))
    *S_15 = (Gadget(-1, 305+8+150, (height+5)*5+10, 140, height, text_v,  #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_right|#__flag_borderless))
    *S_16 = (Gadget(-1, 305+8+150, (height+5)*6+10, 140, height, text_v,  #__flag_gridlines|#__button_multiline|#__flag_vertical|#__text_invert|#__string_right|#__text_bottom))
