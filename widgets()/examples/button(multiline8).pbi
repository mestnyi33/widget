  ...
  Macro _line_resize_X_(_this_)
    If _this_\vertical
      If _this_\text\rotate = 90
        ...
        ElseIf _this_\text\align\horizontal
         _this_\row\_s()\text\x = _x_ + (_width_ + _this_\row\_s()\height)/2 - _this_\scroll\width
        Else
      ...
      ElseIf _this_\text\rotate = 270
        If _this_\text\align\right
         _this_\row\_s()\text\x = _x_ + (_width_ - _this_\scroll\width)
        ElseIf _this_\text\align\horizontal
         _this_\row\_s()\text\x = _x_ + ((_width_ + _this_\row\_s()\height)/2 - (_this_\scroll\width - _this_\row\_s()\height)) ; (_width_-_y2_)
        Else
          _this_\row\_s()\text\x = _x_ + (_this_\scroll\width + _this_\row\_s()\height) + _this_\text\padding
        EndIf
      EndIf
