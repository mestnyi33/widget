...
;     EndIf
  ...
  Macro _line_resize_X_(_this_)
    ...
    _this_\row\_s()\text\x = _this_\row\_s()\x        + Bool(_this_\text\Rotate = 180) * _this_\row\_s()\text\width ; + _this_\row\margin\width
  EndMacro
  ...
  Macro _line_resize_Y_(_this_)
    ...
    _this_\row\_s()\text\y = _this_\row\_s()\y + (_this_\row\_s()\height-_this_\row\_s()\text\height)/2   + Bool(_this_\text\Rotate = 180) * _this_\row\_s()\text\height
  EndMacro
