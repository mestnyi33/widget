...
CompilerIf #PB_Compiler_IsMainFile
  ...
  If OpenWindow(0, 0, 0, 615, (height+5)*8+20+90+150, "String on the canvas", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    *S_0 = GetGadgetData(Gadget(10, 305+8,  10, 290, height, "Read-only StringGadget...", #__string_readonly|#__text_top|#__text_invert))
    *S_1 = GetGadgetData(Gadget(11, 305+8,  (height+5)*1+10, 290, height, "123-only-4567", #__string_numeric|#__string_center|#__text_invert))
    *S_2 = GetGadgetData(Gadget(12, 305+8,  (height+5)*2+10, 290, height, "Right-text StringGadget", #__string_right|#__text_bottom|#__text_invert))
    *S_3 = GetGadgetData(Gadget(13, 305+8,  (height+5)*3+10, 290, height, "LOWERCASE...", #__string_lowercase|#__text_invert))
    *S_4 = GetGadgetData(Gadget(14, 305+8, (height+5)*4+10, 290, height, "uppercase...", #__string_uppercase|#__text_invert))
    *S_5 = GetGadgetData(Gadget(15, 305+8, (height+5)*5+10, 290, height, Text1, #__flag_borderless|#__text_invert))
    *S_6 = GetGadgetData(Gadget(16, 305+8, (height+5)*6+10, 290, height, "Password", #__string_password|#__text_invert))
   ...
   ; *S_8 = GetGadgetData(Gadget(18, 305+8, (height+5)*8+10, 290, 90+150, Text, #__flag_gridlines|#__flag_numeric|#__text_multiline))
     *S_8 = GetGadgetData(Gadget(18, 305+8, (height+5)*8+10, 290, 90+30, Text, #__flag_gridlines|#__flag_numeric|#__text_multiline|#__text_invert))
     *S_9 = GetGadgetData(Gadget(19, 305+8, (height+5)*9+10+60, 290, 90+30, Text, #__flag_gridlines|#__flag_numeric|#__text_wordwrap|#__text_invert))
