  ...
  Macro _make_line_x_(_this_)
    ...
    Else
      If _this_\text\rotate = 0
        ...
        ElseIf _this_\text\align\horizontal
          _this_\row\_s()\text\x = _x_ + (_width_ + _this_\row\margin\width - _this_\row\_s()\text\width)/2
        Else
          _this_\row\_s()\text\x = _x_ + _this_\row\margin\width + _this_\text\x + _this_\text\padding
        EndIf
              ...
              If AddElement(\row\_s())
               ...
               ; _set_content_X_(*this)
                ...
                Protected _x_=*this\x[2] + *this\text\x, 
                          ...
                          _height_=*this\height[2]-*this\text\y*2, _y2_ = (*this\scroll\height  - *this\text\y) ;Text_Y
