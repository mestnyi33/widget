          ...
          If \text\change And \index[#Selected] >= 0 And \index[#Selected] < ListSize(\items())
            ...
            CompilerIf Defined(Bar, #PB_Module)
              ...
              If \root\canvas\keyboard\input And \items()\text\x+\items()\text\width > \items()\x+\items()\width
                ...
                Else
                  SetState(\scroll\h, \scroll\h\page\pos + TextWidth(Chr(\root\canvas\keyboard\input)))
                EndIf
              EndIf
...
;             GradientColor(0.0, \color\back[State_3]&$FFFFFF)
        ...
        Protected button_size = (\tab\box[1]\len/2+5)
        Protected fabe_out = Size - button_size
        
        If Not _scroll_in_start_(\tab\bar) ; \color[1]\state ;
          fabe_x = \x[2]+size
        ...
        If Not _scroll_in_stop_(\tab\bar) ; \color[2]\state ; 
      ...
      ; 
      If Not _scroll_in_start_(\tab\bar) And ((\color[1]\state And \tab\box[0]\x = \tab\box[1]\x-12) Or \color[2]\state)
        \tab\box[0]\x = \tab\box[1]\x-12
      Else
        If (\color[1]\state And \tab\box[0]\x = \tab\box[1]\x-12)
          \color[1]\state = 0
        EndIf
        \tab\box[0]\x = \x[2]+1
      EndIf
      ...
      If \tab\box[0]\len ;And \color[1]\state 
        _button_draw_(0,\tab\box[0]\x, \tab\box[0]\y+h, \tab\box[0]\width, \tab\box[0]\height-h*2, 
                      \tab\box[0]\arrow_type, \tab\box[0]\arrow_size, 0,
                      \tab\box[0]\color\fore[\color[1]\state], \tab\box[0]\color\back[\color[1]\state],
                      \tab\box[0]\color\frame[\color[1]\state], \tab\box[0]\color\front[\color[1]\state],\tab\box[0]\color\alpha,\tab\box[0]\round)
      EndIf
      
      ; Draw arrow right button
      If \tab\box[1]\len ;And \color[2]\state 
        _button_draw_(0,\tab\box[1]\x, \tab\box[1]\y+h, \tab\box[1]\width, \tab\box[1]\height-h*2, 
                      \tab\box[1]\arrow_type, \tab\box[1]\arrow_size, 2,
                      \tab\box[1]\color\fore[\color[2]\state], \tab\box[1]\color\back[\color[2]\state], 
                      \tab\box[1]\color\frame[\color[2]\state], \tab\box[1]\color\front[\color[2]\state],\tab\box[1]\color\alpha,\tab\box[1]\round)
      EndIf
  ...
  Procedure.i Draw_Window(*this._S_widget)
    With *this 
      ...
      ; Draw caption frame
      If \caption\box\color\back[State_3]<>-1
        If \caption\box\color\fore[\focus*2]
          DrawingMode(#PB_2DDrawing_Gradient|#PB_2DDrawing_AlphaBlend)
        Else
          DrawingMode(#PB_2DDrawing_Default|#PB_2DDrawing_AlphaBlend)
        EndIf
        _box_gradient_( \Vertical, \caption\box\x, \caption\box\y, \caption\box\width, \caption\box\height, \caption\box\color\fore[\focus*2], \caption\box\color\back[\focus*2], \radius, \caption\box\color\alpha)
      EndIf
      ...
      DrawingMode(#PB_2DDrawing_Default|#PB_2DDrawing_AlphaBlend)
      RoundBox( \caption\box[#_b_1]\x, \caption\box[#_b_1]\y, \caption\box[#_b_1]\width, \caption\box[#_b_1]\height, Radius, Radius, $FF0000FF&$FFFFFF|\color[1]\alpha<<24)
      RoundBox( \caption\box[#_b_2]\x, \caption\box[#_b_2]\y, \caption\box[#_b_2]\width, \caption\box[#_b_2]\height, Radius, Radius, $FFFF0000&$FFFFFF|\color[2]\alpha<<24)
      RoundBox( \caption\box[#_b_3]\x, \caption\box[#_b_3]\y, \caption\box[#_b_3]\width, \caption\box[#_b_3]\height, Radius, Radius, $FF00FF00&$FFFFFF|\color[3]\alpha<<24)
      ...
      With *this
        ...
        Select \type
          ...
          Case #PB_GadgetType_Window
            \caption\box\x = \x[2]
            \caption\box\y = \y+\bs
            \caption\box\width = \width[2]
            \caption\box\height = \__height
            
            \caption\box[#_b_1]\width = \caption\box\len
            \caption\box[#_b_2]\width = \caption\box\len
            \caption\box[#_b_3]\width = \caption\box\len
            
            \caption\box[#_b_1]\height = \caption\box\len
            \caption\box[#_b_2]\height = \caption\box\len
            \caption\box[#_b_3]\height = \caption\box\len
            
            \caption\box[#_b_1]\x = \x[2]+\width[2]-\caption\box[#_b_1]\width-5
            \caption\box[#_b_2]\x = \caption\box[#_b_1]\x-Bool(Not \caption\box[#_b_2]\hide) * \caption\box[#_b_2]\width-5
            \caption\box[#_b_3]\x = \caption\box[#_b_2]\x-Bool(Not \caption\box[#_b_3]\hide) * \caption\box[#_b_3]\width-5
            
            \caption\box[#_b_1]\y = \y+\bs+(\__height-\caption\box\len)/2
            \caption\box[#_b_2]\y = \caption\box[#_b_1]\y
            \caption\box[#_b_3]\y = \caption\box[#_b_1]\y
  ...
  Procedure.i Form(X.l,Y.l,Width.l,Height.l, Text.s, Flag.i=0, *parent._S_widget=0)
    ...
    With *this
      ...
      \caption\box\len = 12
      \caption\box\color = def_colors
      \caption\box\color\alpha = 255
  ...
  Macro _from_point_tab_(_this_, _mouse_x_, _mouse_y_, _tab_)
    If _tab_\count
      If _from_point_(_mouse_x_, _mouse_y_, _tab_\box[1])
        _this_\from = 2
      ElseIf _from_point_(_mouse_x_, _mouse_y_, _tab_\box[0])
        _this_\from = 1
      Else
        _this_\from =- 1
      EndIf
      ...
      If _this_\from =- 1
        ForEach _tab_\tabs()
          If _tab_\tabs()\drawing
            If _from_point_(mouse_x, mouse_y, _tab_\tabs())
              _tab_\index[#Entered] = _tab_\tabs()\index
              Break
            Else
              _tab_\index[#Entered] =- 1
            EndIf
          EndIf
        Next
      EndIf
  ...
  Procedure.i From(*this._S_widget, mouse_x.i, mouse_y.i)
    ...
    If *this\root\canvas\mouse\change 
      With *this
    ...
    If *enter And *enter\root\canvas\mouse\change
      *enter\root\canvas\mouse\change = 0
...
If OpenWindow(3, 0, 0, 555, 305, "hide/show widgets", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    If Open(3, 0, 0, 555, 605, "", #PB_Flag_AnchorsGadget)
      Define *w,*w1,*w2
