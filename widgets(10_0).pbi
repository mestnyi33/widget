...
DeclareModule Widget
  ...
  Structure _S_widget ; Extends _S_bar
    ...
    *lastdraw._S_widget ; adress parent
  ...
  Procedure.i Resize(*this._S_widget, X.l,Y.l,Width.l,Height.l)
    ...
    If *this > 0
      With *this
        ...
        If \lastdraw
          If \lastdraw\y[#c_4]+\lastdraw\height[#c_4] > \y[#c_4]+\height[#c_4] ;And \lastdraw\x[#c_4]+\lastdraw\width[#c_4] > \x[#c_4]+\width[#c_4] ;And \lastdraw\parent = \parent
            If \lastdraw\y[#c_4]-\y[#c_4] > 0
              \lastdraw\height[#c_4] = \lastdraw\y[#c_4]-\y[#c_4]
            EndIf
            Debug ""+\index +" "+\lastdraw\index +" "+ Str(\lastdraw\y[#c_4]-\y[#c_4])
          EndIf
        EndIf
