...
Module Widget
  ...
  Procedure.i Popup(*Widget._S_widget, X.l,Y.l,Width.l,Height.l, Flag.i=0)
    ...
    ;         
    ;         BindEvent(#PB_Event_ActivateWindow, @CallBack_Popup(), \root\window);, \_gadget )
      ...
      Select EventType 
        ...
        Case #PB_EventType_LeftButtonUp, 
          ...
          If Root()\active\_gadget And
            ...
            If _from_point_(mouse_x, mouse_y, Root()\active\_gadget, [#c_4])
            ...
            Root()\active\_gadget\root\mouse\buttons = 0   
            If Root()\active\_gadget\root\mouse\delta
              FreeStructure(Root()\active\_gadget\root\mouse\delta)
              Root()\active\_gadget\root\mouse\delta = 0
