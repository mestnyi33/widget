  ...
  Procedure.s make_multiline(*this._S_widget, String.s)
    ...
    With *This
      ...
      If \count\items
        ...
        If \Vertical
         \scroll\width = (\Text\Height*\count\items)
         \scroll\height = 0
        Else
         \scroll\width = 0
         \scroll\height = (\Text\Height*\count\items)
        EndIf
...
;         \scroll\y = \y[#__c_2]+Text_y
;         ;\scroll\width = 20
;         \scroll\height = \Height[#__c_2]-Text_y*2
...
; ; ;         Wend
        ...
        If \image
          \image\x = \x[#__c_2]+ (\width[#__c_2] - \max_width - \image\width)/2
