...
CompilerIf Not Defined(widget, #PB_Module)
  ...
  Module widget
    ...
    Procedure   _SetItemState(*this._s_widget, Item.l, State.i)
      Protected Result
      Protected i.l, len.l
    ...
    Procedure   _GetItemState(*this._s_widget, item.l)
      If item =- 1
    ...
    Procedure   _ClearItems(*this._s_widget)
      *this\count\items = 0
      *this\text\change = 1 
    ...
    Procedure.i _RemoveItem(*this._s_widget, Item.l)
      *this\count\items - 1
      *this\text\change = 1
    ...
    Procedure.l _GetItemColor(*this._s_widget, Item.l, ColorType.l, Column.l=0)
      Protected Result
    ...
    ;-
    Procedure   events_editor(*this._s_widget, eventtype.l)
      ...
      With *this
        ...
        CompilerIf Defined(widget::events, #PB_Procedure)
          If \scroll\v
            Repaint | widget::events(\scroll\v, EventType, \root\mouse\x, \root\mouse\y)
            scroll | Bool(*this\scroll\v\from <>- 1)
          EndIf       
          If \scroll\h
            Repaint | widget::events(\scroll\h, EventType, \root\mouse\x, \root\mouse\y)
     ...
     ; _set_repaint_(*this)
      ...
      With *this
        If *this\type = #__Type_Panel
          ...
          If State > *this\count\items - 1 : State = *this\count\items - 1 :  EndIf
            ...
            ForEach GetChildrens(*this)
              If Child( GetChildrens(*this), *this)  
                ...
                GetChildrens(*this)\hide = Bool(GetChildrens(*this)\hide[1] Or
                                                ...
                                                GetChildrens(*this)\bar\index <> GetChildrens(*this)\parent\index[#__s_2])
                
; ;                 Protected *parent._s_widget = GetChildrens(*this)
; ;                 ; 
; ;                 
; ;                 While *parent <> *this
...
; ;                     GetChildrens(*this)\hide = Bool(GetChildrens(*this)\hide[1] Or
; ;                                                     GetChildrens(*this)\parent\hide Or
; ;                                                     *parent\bar\index <> *this\index[#__s_2] Or 
; ;                                                     GetChildrens(*this)\bar\index <> GetChildrens(*this)\parent\index[#__s_2])
; ;                     Break
; ;                   EndIf
; ;                   
...
; ; ;               If GetChildrens(*this)\parent = *this ; Child( GetChildrens(*this), *this)
; ; ;                 Debug *this\index[#__s_2]; GetChildrens(*this)\bar\index
; ; ;                 ;GetChildrens(*this)\hide = Bool(GetChildrens(*this)\bar\index <> *this\index[#__s_2])
; ; ;                 
; ; ;                 Hide_(GetChildrens(*this), Bool(GetChildrens(*this)\bar\index <> *this\index[#__s_2]))
; ; ;               EndIf
            Next
      ...
      ProcedureReturn Result
    EndProcedure
    Procedure.b Hide_(*this._s_widget, State.b)
      *this\hide = Bool(State Or *this\hide[1] Or *this\parent\hide Or *this\bar\index <> *this\parent\index[#__s_2])
      
      If *this\scroll And *this\scroll\v And *this\scroll\h
        *this\scroll\v\hide = *this\scroll\v\bar\hide
        *this\scroll\h\hide = *this\scroll\h\bar\hide 
      EndIf
    ...
    Procedure.b Child_(*this._s_widget, *parent._s_widget)
      While *this <> *parent
    ...
    With *this
      ...
      If *this\count\childrens
          ForEach GetChildrens(*this)
            set_hide_state(GetChildrens(*this), State)
          Next
        EndIf
    EndWith
  EndProcedure
      ...
      With *this
        If \width[#__c_4] > 0 And \height[#__c_4] > 0
          ...
          Select \type
            ...
            Case #__Type_MDI                : Draw_ScrollArea(*this)
...
;                 ; content area coordinate
;                 DrawingMode(#PB_2DDrawing_Outlined|#PB_2DDrawing_AlphaBlend)
;                 Box(*this\x[2]+*this\scroll\x, *this\y[2]+*this\scroll\y, *this\scroll\width, *this\scroll\height, $FFFF0000)
;               EndIf
    ...
    Procedure   SetState_Editor(*this._s_widget, State.l) ; Ok
      Protected i.l, len.l
    ...
    Procedure.b SetState(*this._s_widget, state.f)
      ...
      ElseIf *this\type = #__Type_Editor
        result = SetState_Editor(*this, state)
  ...
  Procedure   AddItem_Editor(*this._s_widget, Item.l,Text.s,Image.i=-1,Flag.i=0)
      Static len.l
      Protected l.l, i.l
    ...
    Procedure   AddItem(*this._s_widget, Item.i, Text.s, Image.i=-1, sublevel.i=0)
      With *this
        If *this\type = #PB_GadgetType_MDI
          ...
          OpenList(*this)
          *this\count\items + 1
          Form(pos_x+x, pos_y+y, Width, Height, Text, #__window_systemmenu|#__window_sizegadget|#__window_maximizegadget|#__window_minimizegadget, *this) : CloseList()
        ...
        ElseIf *this\type = #PB_GadgetType_Editor
          ProcedureReturn AddItem_Editor(*this, Item,Text,Image,sublevel)
        ElseIf *this\type = #PB_GadgetType_Panel
          ProcedureReturn AddItem_panel(*this, Item,Text,Image,sublevel)
        Else
          If (Item =- 1 Or Item > ListSize(\tab\_s()) - 1)
            LastElement(\tab\_s())
            AddElement(\tab\_s()) 
    ...
    ;-
    Procedure events_panel_(*this._s_widget, _event_type_, _mouse_x_, _mouse_y_)
      Protected Repaint
        ...
        If *this\index[#__s_1] =- 1
          Select #__s_1
            Case *this\tab\bar\button[#__b_1]\color\state
              If Bar_Change(*this\tab\bar, (*this\tab\bar\page\pos - *this\tab\bar\scroll_step))   
          ...
          If Not _from_point_(_mouse_x_, _mouse_y_, *this\tab\bar\button[#__b_1])
            ...
            ElseIf *this\tab\bar\button[#__b_1]\x < *this\tab\bar\button[#__b_2]\x-*this\tab\bar\button[#__b_1]\width
              If Not _bar_in_start_(*this\tab\bar) 
                _resize_panel_(*this, *this\tab\bar\button[#__b_1], *this\tab\bar\button[#__b_2]\x-*this\tab\bar\button[#__b_1]\width)
              EndIf
            EndIf
          EndIf
          ...
          If Not _from_point_(_mouse_x_, _mouse_y_, *this\tab\bar\button[#__b_2])
            If *this\tab\bar\button[#__b_1]\color\state = #__s_3 Or
              ...
              If *this\tab\bar\button[#__b_2]\x < *this\tab\bar\button[#__b_1]\x+*this\tab\bar\button[#__b_1]\width
                If Not _from_point_(_mouse_x_, _mouse_y_, *this\tab\bar\button[#__b_1]) 
                  _resize_panel_(*this, *this\tab\bar\button[#__b_2], *this\x[#__c_2]+*this\width[#__c_2]-*this\tab\bar\button[#__b_2]\width)
                EndIf
              EndIf
            ...
            ElseIf *this\tab\bar\button[#__b_2]\x > *this\tab\bar\button[#__b_1]\x+*this\tab\bar\button[#__b_1]\width
              If Not _bar_in_stop_(*this\tab\bar) 
                _resize_panel_(*this, *this\tab\bar\button[#__b_2], *this\tab\bar\button[#__b_1]\x+*this\tab\bar\button[#__b_1]\width)
              EndIf
            EndIf
          EndIf
      ...
      If _event_type_ = #__Event_MouseMove Or
        ...
        Else
          ...
          If *this\count\items
            ForEach *this\tab\_s()
              If *this\tab\_s()\draw
                If _from_point_(_mouse_x_, _mouse_y_, *this\tab\_s()) ;And _from_point_(_mouse_x_, _mouse_y_, *this\bar\button[#__b_3])
