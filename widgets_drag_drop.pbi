...
Module DD
  ...
  Procedure.i Cur()
    ...
    Protected x,y, Image = CreateImage(#PB_Any, 32,32, 32, #PB_Image_Transparent)
            
            If StartDrawing(ImageOutput(Image))
              ;If *Drag\Type
                DrawingMode(#PB_2DDrawing_AlphaBlend)
                LineXY(8+1, 8-1, 15+7+1, 15+7-1, $FF000000)
                ;LineXY(8, 8, 15+7, 15+7, $FF000000)
                LineXY(8-1, 8+1, 15+7-1, 15+7+1, $FF000000)
                ;LineXY(2-1, 2+1, 12-1, 12+1, $FF000000)
                
                DrawingMode(#PB_2DDrawing_Outlined|#PB_2DDrawing_AlphaBlend)
                Circle(15,15, 15, $FF000000)
                Circle(15,15, 12, $FF000000)
              ;EndIf
              StopDrawing()
            EndIf  
