...
Module DD
  ...
  Procedure Set()
    ...
    *Drag\img = CreateImage(#PB_Any, 16,16, 32, #PB_Image_Transparent)
    ...
    SetCursor(EventGadget(), ImageID(*Drag\img), x,y)
        ...
        Case #PB_EventType_MouseEnter
          ...
          If DropAction(*this)
            *Drag\widget = *this
            ...
            ResizeImage(img, *Drag\Width-4, *Drag\Height-4)
            SetCursor(EventGadget(), ImageID(img), (*Drag\Width-4)/2, (*Drag\Height-4)/2)
            
          Else
            Debug "set denied cursor"
            ; SetGadgetAttribute(EventGadget(), #PB_Canvas_Cursor, #PB_Cursor_Default)
            SetCursor(EventGadget(), ImageID(*Drag\img), *Drag\Width/2, *Drag\Height/2)
            *Drag\widget = 0
          EndIf
