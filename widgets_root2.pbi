...
;       Protected g = CanvasGadget(Gadget, X, Y, Width, Height, Flag|#PB_Canvas_Keyboard) : If Gadget=-1 : Gadget=g : EndIf
;       
;       Root() = AllocateStructure(_s_root)
;       Root()\class = "Root"
;       ; Root()\adress = Root()
