   ...
   EndProcedure
    ...
    Procedure Events(*this._s_widget, event_type.l, mouse_x.l, mouse_y.l, _wheel_x_.b=0, _wheel_y_.b=0)
      ...
      If *this\type = #PB_GadgetType_Button
        Select event_type
         ...
         Case #PB_EventType_MouseEnter : *this\color\state = #__s_1+Bool(*this\state&#__s_Selected) : Repaint = 1
    ...
    Procedure CallBack()
      ...
      If change
        ...
        If Root()\entered <> *this
          If Root()\entered And Root()\entered\state & #__s_Entered And 
             Not (#__from_mouse_state And Child(*this, Root()\entered))
            Root()\entered\state &~ #__s_Entered
            ...
            If #__from_mouse_state
              ...
              Repeat                 
                If Root()\_childrens()\draw And Child(Root()\entered, Root()\_childrens())
                  If Root()\_childrens()\state & #__s_Entered
                    Root()\_childrens()\state &~ #__s_Entered
          ...
          If *this And Not *this\state & #__s_Entered
            *this\state | #__s_Entered
            Root()\entered = *this
            ...
            If #__from_mouse_state
              ForEach Root()\_childrens()
                ...
                If Root()\_childrens()\draw And Child(Root()\entered, Root()\_childrens())
                  If Not Root()\_childrens()\state & #__s_Entered
                    Root()\_childrens()\state | #__s_Entered
      ...
      If (eventtype = #__Event_LeftButtonDown Or
        ...
        Root()\entered\state | #__s_Selected
      ...
      If Root()\mouse\buttons
        ...
        If Not Root()\mouse\buttons
           Root()\selected\state &~ #__s_Selected
         ...
         If GetActive() 
            If GetActive()\state & #__s_Entered
            ...
            If _is_widget_(GetActive()\gadget)
              If GetActive()\gadget\state & #__s_Entered
                If Not Root()\mouse\drag
...
Procedure events_gadgets()
  Select EventType()
    Case #PB_EventType_LeftClick
      Debug "click gadget - " + EventGadget()
  EndSelect
EndProcedure
