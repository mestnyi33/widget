...
Procedure DoFunction( *this._s_WIDGET, *function, *param1 = 0, *param2 = 0, *param3 = 0 )
  CallCFunctionFast( *function, *this, *param1, *param2, *param3 )
  
  If *this\count\childrens
    ForEach *this\child( )
      PushListPosition( *this\child( ) )
      DoFunction( *this\child( ), *function, *param1, *param2, *param3 )
      PopListPosition( *this\child( ) )
    Next
  EndIf
EndProcedure
...
Procedure WidgetsEvents( eventtype )
  If RootWidget( )
    ...
    If eventtype = #PB_EventType_Repaint
      ...
      DoFunction( RootWidget( ), @DoWidgetEvents( ), eventtype )
    EndIf
