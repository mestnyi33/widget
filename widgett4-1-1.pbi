...
Structure _s_ROOT Extends _s_WIDGET
  canvas._s_CANVAS
 ;List *_address._s_WIDGET( ) ; Widget( )\ - current element
  EndStructure
;--     STRUCT
Structure _s_STRUCT
  Map *canvas._s_ROOT( )   ;
...
;-
Macro Widget( ) 
  RootWidget( )\child( ) ;RootWidget( )\canvas\last
...
Procedure DrawWidget( *this._s_WIDGET, x, y )
  If *this\address ;And *this\parent = *this
    If *this\visible 
      ;
      DrawFirst( *this, x, y )
      ...
      If *this\count\childrens
        ForEach *this\child( )
          If *this\child( )\visible And *this\child( )\parent = *this
...
Procedure ReDrawWidget( *this._s_WIDGET )
  ...
  If *this\address
    ...
    If StartDrawing( CanvasOutput( *this\root\canvas\gadget ) )
      ...
      ;FirstElement( *this\root\child( ) ) ; \root\child( )
      DrawWidget( *this, x,y )
      StopDrawing( )
    EndIf
  EndIf
...
Procedure AddWidget( *this._s_WIDGET )
  If *this\root
    Debug ListSize(*this\root\child( ))
    ;PushListPosition( *this\root\child( ) )
    ;LastElement( *this\root\child( ) )
    AddElement( *this\root\child( ) )
   ; *this\root\child( ) = AllocateStructure( _s_WIDGET )
   ; CopyList( *this\parent\child( ), *this\root\child( ) )
    *this\root\child( ) = *this
    ;*this\root\child( )\address = *this\address
    ;PopListPosition( *this\root\child( ) )
  EndIf
EndProcedure
