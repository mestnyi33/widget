  ...
  If *this\address
    If *this\visible 
      ...
      If *this\count\childrens
        ForEach *this\child( )
          If *this\child( ) And *this\child( )\visible And *this\child( )\parent = *this 
...
Procedure AddWidget( *this._s_WIDGET )
  If *this\root
    LastElement( *this\root\list( ) )
    AddElement( *this\root\list( ) ) 
    *this\index = ListIndex( *this\root\list( )) 
...
Procedure AddObject( *this._s_WIDGET, type, x,y,width,height, frameSize = 1)
  ...
  If *this
    ...
    If AddElement( *this\child( ) )
      ...
      *this\child( )\last\row = *this\last\row
      If *this\child( )\last\row
        *this\child( )\last\row\last\widget = *this\child( )
      EndIf
...
Procedure GetAtPointWidget( List *child._s_WIDGET( ), mouse_x, mouse_y )
  ...
  LastElement( *child( ) )
  Repeat 
    If *child( ) And *child( )\visible And ;*child( )\child( )\parent = *child( ) And 
       Atbox( *child( )\draw\x, *child( )\draw\y, *child( )\draw\width, *child( )\draw\height, mouse_x-*child( )\parent\x, mouse_y-*child( )\parent\y )
...
Procedure GetAtPointItem( List *object._s_OBJECT( ), mouse_x, mouse_y )
  ...
  LastElement( *object( ) )
  Repeat 
    If *object( )\visible And ;*object( )\items( )\parent = *object( ) And 
...
Define *p._s_WIDGET = Container( 80,80, 150,150 )
Container( 50,130, 50,50, #__Flag_NoGadgets )
Define *c._s_WIDGET = Container( 40,-30, 50,50, #__Flag_NoGadgets )
Container( -30,40, 50,50, #__Flag_NoGadgets )
Container( 130,50, 50,50, #__Flag_NoGadgets )
Define *p2._s_WIDGET = Container( 40,40, 70,70, #__Flag_NoGadgets )
CloseList( )
CloseList( )
