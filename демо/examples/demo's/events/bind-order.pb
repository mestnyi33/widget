...
CompilerIf #PB_Compiler_IsMainFile
   ...
   If Open(0, 0, 0, 480, 180, "ƒемонстраци€ очередь прив€зки событий", #PB_Window_SystemMenu | #PB_Window_ScreenCentered | #PB_Window_SizeGadget)
      
      *butt = Button(50, 50, 380, 70, "Ќаведите курсор мыши, чтобы увидеть") 
