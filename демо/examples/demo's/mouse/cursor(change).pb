...
; ;bug когда переходишь с €корь€ который находитс€ под об№ектом не убираютс€ €корь€
...
CompilerIf #PB_Compiler_IsMainFile
   ...
   If Open(0, 0, 0, 600, 600, "Demo bounds", #PB_Window_SystemMenu | #PB_Window_ScreenCentered | #PB_Window_SizeGadget)
      ...
      ;// ќшибка когда вход в скроллбар и выход в скроллареа 
      ; стрел€ет два событи€ вход и выход скроллареа
