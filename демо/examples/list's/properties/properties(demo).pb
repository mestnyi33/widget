...
;                   EndIf
                  ...
                  AddItem(*this, -1, "StrikeOut")   ; Ўрифт будет зачеркнут (только дл€ Windows)
                  AddItem(*this, -1, "HighQuality") ; Ўрифт будет в высококачественном режиме (медленнее) (только дл€ Windows)
